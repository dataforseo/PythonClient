...
class GoogleShoppingSerpElementItem(BaseMerchantGoogleShoppingProductsElementItem):
    ...
    domain: Optional[StrictStr] = Field(default=None, description=r"domain of the URL. domain of the URL where a special offer is posted")
    ...
    url: Optional[StrictStr] = Field(default=None, description=r"URL pointing at special offer page. URL where a special offer is posted")
    ...
    price_multiplier: Optional[StrictInt] = Field(default=None, description=r"price multiplier for instalment plan. indicates the number of months covered by the monthly payment for the product")
    old_price: Optional[StrictFloat] = Field(default=None, description=r"product old price. displayed if the product price has been changed. example:. 499")
    ...
    reviews_count: Optional[StrictInt] = Field(default=None, description=r"number of product reviews. indicates the number of reviews left by users on Google Shopping. if there are no values, you will get null")
    is_best_match: Optional[StrictBool] = Field(default=None, description=r"“best match” label. if the value is true, the product is marked with the “best match” label. if there are no values, you will get null")
