...
class AppendixDataInfo(BaseModel):
    ...
    appendix: Optional[AppendixAppendixDataInfo] = Field(default=None, description=r"")
    total_appendix: Optional[StrictFloat] = Field(default=None, description=r"")
    dataforseo_labs: Optional[AppendixDataforseoLabsLimitsRatesDataInfo] = Field(default=None, description=r"")
    total_dataforseo_labs: Optional[StrictFloat] = Field(default=None, description=r"")
    domain_analytics: Optional[AppendixDomainAnalyticsLimitsRatesDataInfo] = Field(default=None, description=r"")
    total_domain_analytics: Optional[StrictFloat] = Field(default=None, description=r"")
    merchant: Optional[AppendixMerchantLimitsRatesDataInfo] = Field(default=None, description=r"")
    total_merchant: Optional[StrictFloat] = Field(default=None, description=r"")
    on_page: Optional[AppendixOnPageLimitsRatesDataInfo] = Field(default=None, description=r"")
    total_on_page: Optional[StrictFloat] = Field(default=None, description=r"")
    business_data: Optional[AppendixBusinessDataLimitsRatesDataInfo] = Field(default=None, description=r"")
    total_business_data: Optional[StrictFloat] = Field(default=None, description=r"")
    backlinks: Optional[AppendixBacklinksLimitsRatesDataInfo] = Field(default=None, description=r"")
    total_backlinks: Optional[StrictFloat] = Field(default=None, description=r"")
    app_data: Optional[AppendixAppDataLimitsRatesDataInfo] = Field(default=None, description=r"")
    ...
    total_traffic_analytics: Optional[StrictFloat] = Field(default=None, description=r"")
    traffic_analytics: Optional[AppendixSerpDaysRatesDataInfo] = Field(default=None, description=r"")
    total_reviews: Optional[StrictFloat] = Field(default=None, description=r"")
    reviews: Optional[AppendixSerpDaysRatesDataInfo] = Field(default=None, description=r"")
    total_social: Optional[StrictFloat] = Field(default=None, description=r"")
    social: Optional[AppendixSerpDaysRatesDataInfo] = Field(default=None, description=r"")
