...
class KeywordsDataGoogleAdsAdTrafficByKeywordsTaskGetResultInfo(BaseModel):
    ...
    ctr: Optional[StrictFloat] = Field(default=None, description=r"projected clickthrough rate (CTR) of the advertisement. number of clicks an ad is projected to receive divided by the number of ad impressions; the CTR is projected for the specified time period. if there is no data, then the value is null")
