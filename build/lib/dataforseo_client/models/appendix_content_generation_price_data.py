...
class AppendixContentGenerationPriceData(BaseModel):
    ...
    """ # noqa: E501
    check_grammar: Optional[AppendixContentGenerationPriceDataInfo] = Field(default=None, description=r"")
    generate: Optional[AppendixBingKeywordsDataPriceDataInfo] = Field(default=None, description=r"")
    generate_meta_tags: Optional[AppendixBingKeywordsDataPriceDataInfo] = Field(default=None, description=r"")
    generate_sub_topics: Optional[AppendixBingKeywordsDataPriceDataInfo] = Field(default=None, description=r"")
    generate_text: Optional[AppendixBingKeywordsDataPriceDataInfo] = Field(default=None, description=r"")
    paraphrase: Optional[AppendixBingKeywordsDataPriceDataInfo] = Field(default=None, description=r"")
    text_summary: Optional[AppendixContentGenerationPriceDataInfo] = Field(default=None, description=r"")
