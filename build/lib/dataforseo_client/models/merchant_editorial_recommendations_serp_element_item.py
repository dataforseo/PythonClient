...
class MerchantEditorialRecommendationsSerpElementItem(BaseMerchantAmazonElementItem):
    """
    ...
    items: Optional[List[Optional[AmazonSerpElement]]] = Field(default=None, description=r"Amazon product items")
