...
class GoogleJobsItem(BaseModel):
    ...
    job_id: Optional[StrictStr] = Field(default=None, description=r"ID of the job on Google Jobs")
    title: Optional[StrictStr] = Field(default=None, description=r"title of the element")
    employer_name: Optional[StrictStr] = Field(default=None, description=r"name of the employer")
    employer_url: Optional[StrictStr] = Field(default=None, description=r"URL to the employer’s website")
    employer_image_url: Optional[StrictStr] = Field(default=None, description=r"URL to the image used in the job posting")
    location: Optional[StrictStr] = Field(default=None, description=r"location for which the job vacancy is posted")
    source_name: Optional[StrictStr] = Field(default=None, description=r"original source of the job vacancy")
    source_url: Optional[StrictStr] = Field(default=None, description=r"URL to the original source of the job vacancy")
    salary: Optional[StrictStr] = Field(default=None, description=r"the salary indicated in the job vacancy. if the salary isn’t indicated, this field will equal null")
    contract_type: Optional[StrictStr] = Field(default=None, description=r"employment contract type")
    ...
    time_ago: Optional[StrictStr] = Field(default=None, description=r"indicates how long ago the job vacancy was posted")
    rectangle: Optional[AiModeRectangleInfo] = Field(default=None, description=r"rectangle parameters. contains cartesian coordinates and pixel dimensions of the result’s snippet in SERP;. in this case, will equal null")
