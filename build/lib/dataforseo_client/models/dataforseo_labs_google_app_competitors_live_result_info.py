...
from dataforseo_client.models.dataforseo_labsle_app_competitors_live_item import DataforseoLabsleAppCompetitorsLiveItem
...
class DataforseoLabsGoogleAppCompetitorsLiveResultInfo(BaseModel):
    ...
    items: Optional[List[Optional[DataforseoLabsleAppCompetitorsLiveItem]]] = Field(default=None, description=r"contains data related to the app_id and competitor applications")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [DataforseoLabsleAppCompetitorsLiveItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
        })
