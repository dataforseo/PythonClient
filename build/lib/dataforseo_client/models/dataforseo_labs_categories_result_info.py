...
class DataforseoLabsCategoriesResultInfo(BaseModel):
    ...
    category_code_parent: Optional[StrictInt] = Field(default=None, description=r"the code of the superordinate category. example:. 'category_code': 10178,. 'category_name': 'Apparel Accessories',. 'category_code_parent': 10021. where category_code_parent. corresponds to:. 'category_code': 10021,. 'category_name': 'Apparel'. 'category_code_parent': null")
