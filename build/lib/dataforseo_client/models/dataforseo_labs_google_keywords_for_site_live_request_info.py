...
class DataforseoLabsGoogleKeywordsForSiteLiveRequestInfo(BaseModel):
    ...
    """ # noqa: E501
    target: Optional[StrictStr] = Field(default=None, description=r"target domain. required field. the domain name of the target website. the domain should be specified without https://")
    ...
    include_subdomains: Optional[StrictBool] = Field(default=None, description=r"indicates if the subdomains will be included in the search. optional field. if set to false, the subdomains will be ignored. default value: true")
