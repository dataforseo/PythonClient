...
class BacklinksHistoryLiveRequestInfo(BaseModel):
    ...
    """ # noqa: E501
    target: Optional[StrictStr] = Field(default=None, description=r"domain. required field. a domain should be specified without https:// and www.")
    date_from: Optional[StrictStr] = Field(default=None, description=r"starting date of the time range. optional field. minimum value 2019-01-01. if you don’t specify this field, the minimum value will be used by default. date format: 'yyyy-mm-dd'. example:. '2019-01-15'")
