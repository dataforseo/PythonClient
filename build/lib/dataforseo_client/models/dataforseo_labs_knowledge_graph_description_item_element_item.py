...
class DataforseoLabsKnowledgeGraphDescriptionItemElementItem(BaseDataforseoLabsKnowledgeGraphElementItem):
    ...
    text: Optional[StrictStr] = Field(default=None, description=r"description content")
    links: Optional[List[Optional[KnowledgeGraphLinkElementInfo]]] = Field(default=None, description=r"sitelinks. the links shown below some of Google’s search results. if there are none, equals null")
