...
class AppendixGoogleMerchantPriceData(BaseModel):
    ...
    """ # noqa: E501
    product_info: Optional[AppendixPriceDataInfo] = Field(default=None, description=r"")
    product_spec: Optional[AppendixProductGoogleMerchantPriceDataInfo] = Field(default=None, description=r"")
    products: Optional[AppendixProductGoogleMerchantPriceDataInfo] = Field(default=None, description=r"")
    sellers: Optional[AppendixSellersGoogleMerchantPriceData] = Field(default=None, description=r"")
