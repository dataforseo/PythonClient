...
class SerpYoutubeVideoSubtitlesLiveAdvancedResultInfo(BaseModel):
    ...
    item_types: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"types of search results in SERP. contains types of search results (items) found in SERP.. possible item:. youtube_subtitles")
    ...
    items: Optional[List[Optional[YoutubeSubtitles]]] = Field(default=None, description=r"elements of search results found in SERP")
