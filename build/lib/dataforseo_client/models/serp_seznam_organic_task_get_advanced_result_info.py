...
class SerpSeznamOrganicTaskGetAdvancedResultInfo(BaseModel):
    ...
    item_types: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"types of search results in SERP. contains types of search results (items) found in SERP.. possible item types:. images, local_pack, organic, related_searches, top_stories, featured_snippet, video")
