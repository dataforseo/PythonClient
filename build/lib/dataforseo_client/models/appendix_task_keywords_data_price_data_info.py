...
class AppendixTaskKeywordsDataPriceDataInfo(BaseModel):
    ...
    """ # noqa: E501
    priority_low: Optional[List[Optional[AppendixPriorityTasksReadyKeywordsDataPriceDataInfo]]] = Field(default=None, description=r"")
    priority_normal: Optional[List[Optional[AppendixPriorityTasksReadyKeywordsDataPriceDataInfo]]] = Field(default=None, description=r"")
    priority_high: Optional[List[Optional[AppendixPriorityTasksReadyKeywordsDataPriceDataInfo]]] = Field(default=None, description=r"")
