...
class BacklinksReferringNetworksLiveRequestInfo(BaseModel):
    ...
    """ # noqa: E501
    target: Optional[StrictStr] = Field(default=None, description=r"domain, subdomain or webpage to get referring networks for. required field. a domain or a subdomain should be specified without https:// and www.. a page should be specified with absolute URL (including http:// or https://)")
    network_address_type: Optional[StrictStr] = Field(default=None, description=r"indicates the type of network to get data for. optional field. possible values: ip, subnet. default value: ip")
    limit: Optional[StrictInt] = Field(default=None, description=r"the maximum number of returned networks. optional field. default value: 100. maximum value: 1000")
    offset: Optional[StrictInt] = Field(default=None, description=r"offset in the results array of returned networks. optional field. default value: 0. if you specify the 10 value, the first ten domains in the results array will be omitted and the data will be provided for the successive pages")
    ...
    order_by: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"results sorting rules. optional field. you can use the same values as in the filters array to sort the results. possible sorting types:. asc – results will be sorted in the ascending order. desc – results will be sorted in the descending order. you should use a comma to set up a sorting type. example:. ['backlinks,desc']. note that you can set no more than three sorting rules in a single request. you should use a comma to separate several sorting rules. example:. ['backlinks,desc','rank,asc']")
    backlinks_filters: Optional[List[Optional[Any]]] = Field(default=None, description=r"filter the backlinks of your target. optional field. you can use this field to filter the initial backlinks that will be included in the dataset for aggregated metrics for your target. you can filter the backlinks by all fields available in the response of this endpoint. using this parameter, you can include only dofollow backlinks in the response and create a flexible backlinks dataset to calculate the metrics for. example:. 'backlinks_filters': [['dofollow', '=', true]]")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        _dict['network_address_type'] = self.network_address_type
