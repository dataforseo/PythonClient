...
class AppendixContentAnalysisLimitsRatesDataInfo(BaseModel):
    ...
    sentiment_analysis: Optional[AppendixInfo] = Field(default=None, description=r"")
    rating_distribution: Optional[AppendixInfo] = Field(default=None, description=r"")
    phrase_trends: Optional[AppendixInfo] = Field(default=None, description=r"")
    category_trends: Optional[AppendixInfo] = Field(default=None, description=r"")
