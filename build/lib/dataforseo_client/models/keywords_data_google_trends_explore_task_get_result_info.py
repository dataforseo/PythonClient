...
class KeywordsDataGoogleTrendsExploreTaskGetResultInfo(BaseModel):
    ...
    check_url: Optional[StrictStr] = Field(default=None, description=r"direct URL to the Google Trends results. you can use it to make sure that we provided accurate results")
    ...
    items: Optional[List[Optional[BaseKeywordDataGoogleTrendsItem]]] = Field(default=None, description=r"items on the Google Trends page")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [BaseKeywordDataGoogleTrendsItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
        })
