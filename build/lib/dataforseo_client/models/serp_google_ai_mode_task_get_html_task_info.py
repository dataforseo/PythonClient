...
from dataforseo_client.models.serp_google_ai_mode_task_get_html_result_info import SerpGoogleAiModeTaskGetHtmlResultInfo
from dataforseo_client.models.base_response_task_info import BaseResponseTaskInfo



class SerpGoogleAiModeTaskGetHtmlTaskInfo(BaseModel):
    """
    ...
    result: Optional[List[Optional[SerpGoogleAiModeTaskGetHtmlResultInfo]]] = Field(default=None, description=r"array of results")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "path": obj.get("path"),
            "data": obj.get("data"),
            "result": [SerpGoogleAiModeTaskGetHtmlResultInfo.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None,
        })
