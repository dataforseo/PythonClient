...
class GoogleBusinessInfo(BaseModel):
    """
    GoogleBusinessInfo
    """ # noqa: E501
    ...
    position: Optional[StrictStr] = Field(default=None, description=r"the alignment in SERP")
    ...
    original_title: Optional[StrictStr] = Field(default=None, description=r"original title of the element. original title not translated by Google")
    description: Optional[StrictStr] = Field(default=None, description=r"description of the element in SERP. the description of the business entity for which the results are collected")
    ...
    category_ids: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"global category IDs. universal category IDs that do not change based on the selected country")
    additional_categories: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"additional business categories. additional Google My Business categories that describe the services provided by the business entity in more detail")
    cid: Optional[StrictStr] = Field(default=None, description=r"google-defined client id. unique id of a local establishment;. can be used with Google Reviews API to get a full list of reviews. learn more about the identifier in this help center article")
    ...
    address_info: Optional[AddressInfo] = Field(default=None, description=r"object containing address components of the business entity")
    place_id: Optional[StrictStr] = Field(default=None, description=r"unique place identifier. place id of the local establishment featured in the element. learn more about the identifier in this help center article")
    phone: Optional[StrictStr] = Field(default=None, description=r"phone number of the business entity")
    url: Optional[StrictStr] = Field(default=None, description=r"absolute url of the business entity")
    contact_url: Optional[StrictStr] = Field(default=None, description=r"URL of the preferred contact page")
    contributor_url: Optional[StrictStr] = Field(default=None, description=r"URL of the user’s or entity’s Local Guides profile, if available")
    book_online_url: Optional[StrictStr] = Field(default=None, description=r"URL in the ‘book online’ button of the element. URL directing users to the online booking or order page of the business entity")
    domain: Optional[StrictStr] = Field(default=None, description=r"domain of the business entity")
    logo: Optional[StrictStr] = Field(default=None, description=r"URL of the logo featured in Google My Business profile")
    main_image: Optional[StrictStr] = Field(default=None, description=r"URL of the main image featured in Google My Business profile")
    total_photos: Optional[StrictInt] = Field(default=None, description=r"total count of images featured in Google My Business profile")
    snippet: Optional[StrictStr] = Field(default=None, description=r"additional information on the business entity")
    latitude: Optional[StrictFloat] = Field(default=None, description=r"latitude coordinate of the local establishments in google maps. example:. 'latitude': 51.584091")
    longitude: Optional[StrictFloat] = Field(default=None, description=r"longitude coordinate of the local establishment in google maps. example:. 'longitude': -0.31365919999999997")
    ...
    questions_and_answers_count: Optional[StrictInt] = Field(default=None, description=r"")
    ...
    hotel_rating: Optional[StrictFloat] = Field(default=None, description=r"hotel class rating. class ratings range between 1-5 stars, learn more. if there is no hotel class rating information, the value will be null")
    ...
    people_also_search: Optional[List[Optional[PeopleAlsoSearch]]] = Field(default=None, description=r"related business entities")
    work_time: Optional[BusinessWorkHoursInfo] = Field(default=None, description=r"work time details. information related to operational hours of the business entity")
    popular_times: Optional[PopularTimes] = Field(default=None, description=r"popular times. information related to busy hours of the business entity")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        _dict['questions_and_answers_count'] = self.questions_and_answers_count
        ...
        _dict['directory'] = self.directory.to_dict() if self.directory else None
        return _dict
