...
class GoogleFinanceMetricsBundleInfo(BaseModel):
    ...
    revenue: Optional[StrictFloat] = Field(default=None, description=r"revenue value")
    revenue_delta: Optional[StrictFloat] = Field(default=None, description=r"change in revenue")
    operating_expense: Optional[StrictFloat] = Field(default=None, description=r"operating expense value")
    operating_expense_delta: Optional[StrictFloat] = Field(default=None, description=r"change in operating expense")
    net_income: Optional[StrictFloat] = Field(default=None, description=r"net income value")
    net_income_delta: Optional[StrictFloat] = Field(default=None, description=r"change in net income")
    net_profit_margin: Optional[StrictFloat] = Field(default=None, description=r"net profit margin value")
    net_profit_margin_delta: Optional[StrictFloat] = Field(default=None, description=r"change in net profit margin")
    earnings_per_share: Optional[StrictFloat] = Field(default=None, description=r"earnings per share value")
    earnings_per_share_delta: Optional[StrictFloat] = Field(default=None, description=r"change in earnings per share")
    ebitda: Optional[StrictFloat] = Field(default=None, description=r"earnings before interest, taxes, deprecation, amortisation")
    ebitda_delta: Optional[StrictFloat] = Field(default=None, description=r"change in ebitda")
    effective_tax_rate: Optional[StrictFloat] = Field(default=None, description=r"effective tax rate value")
    cash_and_short_term_investments: Optional[StrictFloat] = Field(default=None, description=r"cash and short-term investments value")
    cash_and_short_term_investments_delta: Optional[StrictFloat] = Field(default=None, description=r"change in cash and short-term investments")
    total_assets: Optional[StrictFloat] = Field(default=None, description=r"total assets value")
    total_assets_delta: Optional[StrictFloat] = Field(default=None, description=r"change in total assets")
    total_liabilities: Optional[StrictFloat] = Field(default=None, description=r"total liabilities value")
    total_liabilities_delta: Optional[StrictFloat] = Field(default=None, description=r"change in total liabilities")
    total_equity: Optional[StrictFloat] = Field(default=None, description=r"total equity value")
    shares_outstanding: Optional[StrictFloat] = Field(default=None, description=r"outstanding shares value")
    price_to_book: Optional[StrictFloat] = Field(default=None, description=r"price to book")
    return_on_assets: Optional[StrictFloat] = Field(default=None, description=r"return on assets")
    return_on_capital: Optional[StrictFloat] = Field(default=None, description=r"return on capital")
    cash_from_operations: Optional[StrictFloat] = Field(default=None, description=r"cash from operations")
    ...
    free_cash_flow: Optional[StrictFloat] = Field(default=None, description=r"free cash flow value")
    free_cash_flow_delta: Optional[StrictFloat] = Field(default=None, description=r"change in free cash flow")
