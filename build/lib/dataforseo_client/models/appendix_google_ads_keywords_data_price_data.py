...
class AppendixGoogleAdsKeywordsDataPriceData(BaseModel):
    ...
    """ # noqa: E501
    ad_traffic_by_keywords: Optional[AppendixBingKeywordsDataPriceDataInfo] = Field(default=None, description=r"")
    ...
    status: Optional[AppendixTaskKeywordsDataPriceDataInfo] = Field(default=None, description=r"")
