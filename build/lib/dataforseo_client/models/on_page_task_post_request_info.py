...
class OnPageTaskPostRequestInfo(BaseModel):
    ...
    store_raw_html: Optional[StrictBool] = Field(default=None, description=r"store HTML of crawled pages. optional field. set to true if you want to get the HTML of the page using the OnPage Raw HTML endpoint. default value: false")
    enable_content_parsing: Optional[StrictBool] = Field(default=None, description=r"parse content on crawled pages. optional field. set to true to use the OnPage Content Parsing endpoint. default value: false")
    ...
    enable_browser_rendering: Optional[StrictBool] = Field(default=None, description=r"emulate browser rendering to measure Core Web Vitals. optional field. by using this parameter you will be able to emulate a browser when loading a web page;. enable_browser_rendering loads styles, images, fonts, animations, videos, and other resources on a page;. default value: false. set to true to obtain Core Web Vitals (FID, CLS, LCP) metrics in the response;. if you use this field, enable_javascript, and load_resources parameters must be set to true. Note: if you use this parameter, additional charges will apply; learn more about the cost of tasks with this parameter in our help article; the cost can be calculated on the Pricing Page")
    ...
    validate_micromarkup: Optional[StrictBool] = Field(default=None, description=r"enable microdata validation. optional field. set to true if you want to use the OnPage API Microdata endpoint. default value: false")
    ...
    check_spell: Optional[StrictBool] = Field(default=None, description=r"check spelling. optional field. set to true to check spelling on a website using Hunspell library. default value: false")
    ...
    disable_page_checks: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"prevent certain page checks from running. optional field. specify certain checks to prevent them from running and impacting the onpage_scoreexample:. 'disable_page_checks': ['is_5xx_code', 'is_4xx_code']")
