...
class BusinessDataTrustpilotReviewsTaskPostRequestInfo(BaseModel):
    ...
    """ # noqa: E501
    domain: Optional[StrictStr] = Field(default=None, description=r"domain of the local establishment. required field. domain of the local establishment on Trustpilot;. you can find the domain in the URL of every business listed on Trustpilot. example:. www.thepearlsource.com. https://www.trustpilot.com/review/www.thepearlsource.com")
    sort_by: Optional[StrictStr] = Field(default=None, description=r"results sorting parameter. optional field. you can use this field to sort the results;. possible sorting parameters:. recency — most recent reviews first;. relevance — most relevant reviews first;. default value: relevance")
    priority: Optional[StrictInt] = Field(default=None, description=r"task priority. optional field. can take the following values:. 1 – normal execution priority (set by default). 2 – high execution priority. You will be additionally charged for the tasks with high execution priority.. The cost can be calculated on the Pricing page.")
    depth: Optional[StrictInt] = Field(default=None, description=r"parsing depth. optional field. number of reviews to be returned from the API response. we strongly recommend setting the parsing depth in the multiples of twenty, because our system processes twenty reviews in a row. default value: 20. maximum value: 25000. Your account will be billed per each SERP containing up to 20 results;. Setting depth above 20 may result in additional charges if the search engine returns more than 20 results;. The cost can be calculated on the Pricing page.")
