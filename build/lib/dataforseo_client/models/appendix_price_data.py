...
class AppendixPriceData(BaseModel):
    ...
    AppendixPriceData
    """ # noqa: E501
    keywords_data: Optional[AppendixKeywordsDataPriceData] = Field(default=None, description=r"")
    merchant: Optional[AppendixMerchantPriceData] = Field(default=None, description=r"")
    serp: Optional[AppendixSerpPriceData] = Field(default=None, description=r"")
    appendix: Optional[AppendixAppendixPriceData] = Field(default=None, description=r"")
    app_data: Optional[AppendixAppDataPriceData] = Field(default=None, description=r"")
    backlinks: Optional[AppendixBacklinksPriceData] = Field(default=None, description=r"")
    business_data: Optional[AppendixBusinessDataPriceData] = Field(default=None, description=r"")
    content_analysis: Optional[AppendixContentAnalysisPriceData] = Field(default=None, description=r"")
    content_generation: Optional[AppendixContentGenerationPriceData] = Field(default=None, description=r"")
    dataforseo_labs: Optional[AppendixDataforseoLabsPriceData] = Field(default=None, description=r"")
    domain_analytics: Optional[AppendixDomainAnalyticsPriceData] = Field(default=None, description=r"")
    on_page: Optional[AppendixOnPagePriceData] = Field(default=None, description=r"")
