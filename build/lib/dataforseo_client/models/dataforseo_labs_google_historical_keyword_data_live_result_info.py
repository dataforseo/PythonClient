...
class DataforseoLabsGoogleHistoricalKeywordDataLiveResultInfo(BaseModel):
    """
    ...
    items: Optional[List[Optional[DataforseoLabsGoogleHistoricalKeywordDataLiveItem]]] = Field(default=None, description=r"contains keywords and related data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [DataforseoLabsGoogleHistoricalKeywordDataLiveItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
        })
