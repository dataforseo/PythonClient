...
class DataforseoLabsAppleKeywordsForAppLiveItem(BaseModel):
    ...
    ranked_serp_element: Optional[AppleRankedSerpElementInfo] = Field(default=None, description=r"contains data on the domain’s SERP element found for the returned keyword")
