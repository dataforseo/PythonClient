...
class DataforseoLabsGoogleBulkAppMetricsLiveResultInfo(BaseModel):
    ...
    items: Optional[List[Optional[DataforseoLabsleBulkAppMetricsLiveItem]]] = Field(default=None, description=r"contains data related to the ranking app metrics of the specified application")
