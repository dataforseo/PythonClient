...
class SerpApiGoogleFinanceHeroGroupsElementItem(BaseSerpApiGoogleFinanceElementItem):
    """
    ...
    markets: Optional[List[Optional[Markets]]] = Field(default=None, description=r"financial markets data. array of items containing market indexes and other financial information related to these indexes")
