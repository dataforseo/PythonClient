...
class ContentGenerationCheckGrammarLiveResultInfo(BaseModel):
    ...
    """ # noqa: E501
    input_tokens: Optional[StrictInt] = Field(default=None, description=r"number of input tokens in the POST request")
    output_tokens: Optional[StrictInt] = Field(default=None, description=r"number of output tokens in the response")
    new_tokens: Optional[StrictInt] = Field(default=None, description=r"number of new tokens in the response")
    initial_text: Optional[StrictStr] = Field(default=None, description=r"initial text in the POST request")
    language_code: Optional[StrictStr] = Field(default=None, description=r"language code in the POST request")
    items_count: Optional[StrictInt] = Field(default=None, description=r"the number of results returned in the items array")
    items: Optional[List[Optional[ContentGenerationCheckGrammarLiveItem]]] = Field(default=None, description=r"contains grammar or spelling errors and related data")
