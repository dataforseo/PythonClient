...
class KeywordInfoNormalizedWithInfo(BaseModel):
    ...
    is_normalized: Optional[StrictBool] = Field(default=None, description=r"keyword info is normalized. if true, values are normalized with Bing data")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        _dict['is_normalized'] = self.is_normalized
