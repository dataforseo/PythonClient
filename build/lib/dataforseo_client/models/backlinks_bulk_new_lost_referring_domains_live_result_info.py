...
class BacklinksBulkNewLostReferringDomainsLiveResultInfo(BaseModel):
    ...
    items: Optional[List[Optional[BacklinksBulkNewLostReferringDomainsLiveItem]]] = Field(default=None, description=r"contains relevant backlinks and referring domains data")
