...
class DataforseoLabsBingSerpCompetitorsLiveResultInfo(BaseModel):
    ...
    items: Optional[List[Optional[DataforseoLabsSerpCompetitorsLiveItem]]] = Field(default=None, description=r"contains detected SERP competitors and related data")
