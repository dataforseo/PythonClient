...
class PopularWorkTimeInfo(BaseModel):
    ...
    PopularWorkTimeInfo
    """ # noqa: E501
    time: Optional[TimeInfo] = Field(default=None, description=r"hours in the 24-hour format")
    popular_index: Optional[StrictInt] = Field(default=None, description=r"popularity index. relative time-bound popularity index measured from 0 to 100;. higher value corresponds to a busier time of a day")
