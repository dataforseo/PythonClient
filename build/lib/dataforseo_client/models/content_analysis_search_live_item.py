...
class ContentAnalysisSearchLiveItem(BaseModel):
    ...
    url: Optional[StrictStr] = Field(default=None, description=r"URL where the citation was found")
    domain: Optional[StrictStr] = Field(default=None, description=r"domain name")
    main_domain: Optional[StrictStr] = Field(default=None, description=r"main domain")
    ...
    spam_score: Optional[StrictInt] = Field(default=None, description=r"backlink spam score of the url. this value is based on backlink data for the given URL from DataForSEO Backlink Index;. learn more about how the metric is calculated on this help center page")
    ...
    fetch_time: Optional[StrictStr] = Field(default=None, description=r"date and time when our crawler visited the page. in the UTC format: “yyyy-mm-dd hh-mm-ss +00:00”. example:. 2017-01-24 13:20:59 +00:00")
    country: Optional[StrictStr] = Field(default=None, description=r"country code of the domain registration. to obtain a full list of available countries, refer to the Locations endpoint")
    ...
    page_category: Optional[List[Optional[StrictInt]]] = Field(default=None, description=r"contains all relevant page categories. product and service categories relevant for the page. to obtain a full list of available categories, refer to the Categories endpoint")
