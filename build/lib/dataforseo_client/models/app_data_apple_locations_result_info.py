...
class AppDataAppleLocationsResultInfo(BaseModel):
    ...
    location_name_parent: Optional[StrictStr] = Field(default=None, description=r"the name of the superordinate location. example:. 'location_code': 1006473,. 'location_name': 'Altrincham,England,United Kingdom',. 'location_name_parent': 'England,United Kingdom', where location_name_parent corresponds to:. 'location_code': 20339,. 'location_name': 'England,United Kingdom'. note: Apple App Data API currently supports countries only, that is why this value will always be null")
