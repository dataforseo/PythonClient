...
from dataforseo_client.models.ai_optimization_chat_gpt_llm_responses_task_get_result_info import AiOptimizationChatGptLlmResponsesTaskGetResultInfo
from dataforseo_client.models.base_response_task_info import BaseResponseTaskInfo



class AiOptimizationChatGptLlmResponsesTaskGetTaskInfo(BaseModel):
    """
    ...
    result: Optional[List[Optional[AiOptimizationChatGptLlmResponsesTaskGetResultInfo]]] = Field(default=None, description=r"array of results")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "path": obj.get("path"),
            "data": obj.get("data"),
            "result": [AiOptimizationChatGptLlmResponsesTaskGetResultInfo.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None,
        })
