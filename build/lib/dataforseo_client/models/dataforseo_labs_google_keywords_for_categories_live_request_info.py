...
class DataforseoLabsGoogleKeywordsForCategoriesLiveRequestInfo(BaseModel):
    ...
    """ # noqa: E501
    category_codes: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"product and service categories. required field. The maximum number of categories you can specify: 20. you can download the full list of possible categories")
    ...
    category_intersection: Optional[StrictBool] = Field(default=None, description=r"category intersections. optional field. if set to true, you will get keywords featured in all specified categories;. if set to false, you will keywords that are specified in any of the specified categories;. default value: true")
    ...
    limit: Optional[StrictInt] = Field(default=None, description=r"the maximum number of keywords in the results array. optional field. default value: 100. maximum value: 1000")
    ...
    order_by: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"results sorting rules. optional field. you can use the same values as in the filters array to sort the results. possible sorting types:. asc – results will be sorted in the ascending order. desc – results will be sorted in the descending order. you should use a comma to set up a sorting type. example:. ['keyword_info.competition,desc']. default rule:. ['keyword_info.search_volume,desc']. note that you can set no more than three sorting rules in a single request. you should use a comma to separate several sorting rules. example:. ['keyword_info.search_volume,desc','keyword_info.competition,asc']")
