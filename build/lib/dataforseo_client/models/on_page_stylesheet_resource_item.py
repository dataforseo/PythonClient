...
class OnPageStylesheetResourceItem(BaseOnPageResourceItem):
    """
    ...
    meta: Optional[ResourceMetaInfo] = Field(default=None, description=r"page properties. the value depends on the resource_type")
