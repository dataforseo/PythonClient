...
class HotelInfoPriceOffer(BaseModel):
    ...
    free_cancellation_until: Optional[StrictStr] = Field(default=None, description=r"date until free cancellation is available. in the UTC format: “yyyy-mm-dd hh-mm-ss +00:00”. equals null if free cancellation is not available for the selected dates")
