...
class SerpGoogleFinanceExploreTasksReadyTaskInfo(BaseModel):
    """
    ...
    result: Optional[List[Optional[SerpGoogleFinanceExploreTasksReadyResultInfo]]] = Field(default=None, description=r"array of results")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "path": obj.get("path"),
            "data": obj.get("data"),
            "result": [SerpGoogleFinanceExploreTasksReadyResultInfo.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None,
        })
