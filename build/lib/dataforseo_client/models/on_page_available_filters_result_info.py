...
class OnPageAvailableFiltersResultInfo(BaseModel):
    ...
    """ # noqa: E501
    resources: Optional[Dict[str, Optional[StrictStr]]] = Field(default=None, description=r"")
    pages: Optional[Dict[str, Optional[StrictStr]]] = Field(default=None, description=r"")
    non_indexable: Optional[Dict[str, Optional[StrictStr]]] = Field(default=None, description=r"")
    links: Optional[Dict[str, Optional[StrictStr]]] = Field(default=None, description=r"")
