...
class AppendixAppDataLimitsRatesDataInfo(BaseModel):
    ...
    """ # noqa: E501
    app_info: Optional[AppendixSerpDaysRatesDataInfo] = Field(default=None, description=r"")
    app_list: Optional[AppendixSerpDaysRatesDataInfo] = Field(default=None, description=r"")
    app_reviews: Optional[AppendixSerpDaysRatesDataInfo] = Field(default=None, description=r"")
    app_searches: Optional[AppendixSerpDaysRatesDataInfo] = Field(default=None, description=r"")
