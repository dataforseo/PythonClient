...
class AppendixTechnologiesDomainAnalyticsLimitsRatesDataInfo(BaseModel):
    ...
    """ # noqa: E501
    domain_technologies: Optional[AppendixInfo] = Field(default=None, description=r"")
    domains_by_technology: Optional[AppendixInfo] = Field(default=None, description=r"")
    ...
    technologies: Optional[StrictFloat] = Field(default=None, description=r"")
    aggregation_technologies: Optional[AppendixInfo] = Field(default=None, description=r"")
    technologies_summary: Optional[AppendixInfo] = Field(default=None, description=r"")
    domains_by_html_terms: Optional[AppendixInfo] = Field(default=None, description=r"")
    technology_stats: Optional[AppendixInfo] = Field(default=None, description=r"")
