...
class AppendixMerchantAmazonInfo(BaseModel):
    ...
    """ # noqa: E501
    asin: Optional[AppendixSerpDaysRatesDataInfo] = Field(default=None, description=r"")
    products: Optional[AppendixSerpDaysRatesDataInfo] = Field(default=None, description=r"")
    sellers: Optional[AppendixSerpDaysRatesDataInfo] = Field(default=None, description=r"")
