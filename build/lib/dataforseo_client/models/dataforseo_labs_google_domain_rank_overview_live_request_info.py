...
class DataforseoLabsGoogleDomainRankOverviewLiveRequestInfo(BaseModel):
    ...
    ignore_synonyms: Optional[StrictBool] = Field(default=None, description=r"ignore highly similar keywords. optional field. if set to true, all highly similar keywords will be excluded from the ranking and traffic calculations, the results will be based on data for main keywords from groups of synonyms. default value: false")
