...
class SerpGoogleAdsSearchTaskPostRequestInfo(BaseModel):
    ...
    advertiser_ids: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"advertiser identifiers. required field if target is not specified. you can specify the maximum of 25 values in this array;. advertiser_ids values for this parameter can be found in the Google Ads Advertisers endpoint;")
