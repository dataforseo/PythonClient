...
class SerpGoogleMapsLiveAdvancedRequestInfo(BaseModel):
    ...
    search_this_area: Optional[StrictBool] = Field(default=None, description=r"search this area. optional field. can take the values:true, false. default value: true. if set to false, the search_this_area mode will be turned off. Note: if the search_this_area mode is turned off, Google Maps listings might contain results beyond the displayed area")
