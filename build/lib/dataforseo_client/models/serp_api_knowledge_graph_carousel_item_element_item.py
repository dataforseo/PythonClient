...
class SerpApiKnowledgeGraphCarouselItemElementItem(BaseSerpApiKnowledgeGraphElementItem):
    """
    ...
    items: Optional[List[Optional[KnowledgeGraphListElement]]] = Field(default=None, description=r"elements of search results found in SERP")
