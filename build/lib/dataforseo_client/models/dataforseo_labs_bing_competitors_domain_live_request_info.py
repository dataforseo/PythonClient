...
class DataforseoLabsBingCompetitorsDomainLiveRequestInfo(BaseModel):
    ...
    max_rank_group: Optional[StrictInt] = Field(default=None, description=r"maximum rank up to which competitors will be considered. optional field. default value: 100. if you specify 10 here, we will extract competitors from the top 10 Bing search results only")
