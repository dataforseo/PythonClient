...
class SerpApiGoogleImagesRelatedSearchesElementItem(BaseSerpApiGoogleImagesElementItem):
    """
    ...
    items: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"items of the element")
