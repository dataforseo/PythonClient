...
class ContentRatingInfo(BaseModel):
    ...
    rating_value: Optional[StrictStr] = Field(default=None, description=r"the value of the rating")
    rating_count: Optional[StrictStr] = Field(default=None, description=r"number of votes")
    max_rating_value: Optional[StrictStr] = Field(default=None, description=r"maximum value for the rating name")
    relative_rating: Optional[StrictStr] = Field(default=None, description=r"relative rating")
