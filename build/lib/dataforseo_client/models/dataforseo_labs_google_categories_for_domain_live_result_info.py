...
class DataforseoLabsGoogleCategoriesForDomainLiveResultInfo(BaseModel):
    ...
    target: Optional[StrictStr] = Field(default=None, description=r"target domain or subdomain in a POST array")
    ...
    items: Optional[List[Optional[DataforseoLabsGoogleCategoriesForDomainLiveItem]]] = Field(default=None, description=r"contains relevant categories and related ranking data")
