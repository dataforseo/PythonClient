...
class DataforseoLabsAmazonRelatedKeywordsLiveRequestInfo(BaseModel):
    ...
    """ # noqa: E501
    keyword: Optional[StrictStr] = Field(default=None, description=r"keyword. required field. UTF-8 encoding. the keywords should be specified in the lowercase format. learn more about rules and limitations of keyword and keywords fields in DataForSEO APIs in this Help Center article")
