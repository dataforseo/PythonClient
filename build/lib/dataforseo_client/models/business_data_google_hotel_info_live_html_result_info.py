...
class BusinessDataGoogleHotelInfoLiveHtmlResultInfo(BaseModel):
    ...
    """ # noqa: E501
    keyword: Optional[StrictStr] = Field(default=None, description=r"unique hotel identifier specified as 'hotel_id:$'")
    ...
    items: Optional[List[Optional[HtmlItemInfo]]] = Field(default=None, description=r"HTML pages")
