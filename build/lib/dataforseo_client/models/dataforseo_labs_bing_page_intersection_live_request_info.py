...
class DataforseoLabsBingPageIntersectionLiveRequestInfo(BaseModel):
    ...
    item_types: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"search results type. indicates type of search results included in the response. optional field. possible values:. ['organic', 'paid', 'featured_snippet', 'local_pack']. default value:. ['organic', 'paid', 'featured_snippet', 'local_pack']")
