...
class GoogleTrendsGoogleTrendsMapElementItem(BaseKeywordDataGoogleTrendsItem):
    """
    ...
    data: Optional[List[Optional[TrendsMapDataInfo]]] = Field(default=None, description=r"Google Trends data from the corresponding item")
