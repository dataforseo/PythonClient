...
class SerpGoogleNewsTaskGetAdvancedResultInfo(BaseModel):
    ...
    includes_non_news_search_results: Optional[StrictBool] = Field(default=None, description=r"indicates whether the response contains non-news search results in addition to news content")
    item_types: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"types of search results in SERP. contains types of search results (items) found in SERP.. possible item types:. top_stories, news_search")
    ...
    items: Optional[List[Optional[BaseSerpApiGoogleNewsElementItem]]] = Field(default=None, description=r"elements of search results found in SERP")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        _dict['includes_non_news_search_results'] = self.includes_non_news_search_results
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [BaseSerpApiGoogleNewsElementItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
        })
