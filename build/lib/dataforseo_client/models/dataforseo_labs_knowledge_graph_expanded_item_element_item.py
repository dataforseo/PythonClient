...
class DataforseoLabsKnowledgeGraphExpandedItemElementItem(BaseDataforseoLabsKnowledgeGraphElementItem):
    """
    ...
    expanded_element: Optional[StrictStr] = Field(default=None, description=r"expanded element")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        _dict['expanded_element'] = self.expanded_element
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "expanded_element": obj.get("expanded_element"),
        })
