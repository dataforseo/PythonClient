...
class AmazonKeywordData(BaseModel):
    ...
    keyword: Optional[StrictStr] = Field(default=None, description=r"related keyword")
    ...
    keyword_info: Optional[AmazonKeywordInfo] = Field(default=None, description=r"keyword info for the returned keyword")
