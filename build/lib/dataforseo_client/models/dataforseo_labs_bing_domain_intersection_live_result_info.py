...
class DataforseoLabsBingDomainIntersectionLiveResultInfo(BaseModel):
    ...
    """ # noqa: E501
    se_type: Optional[StrictStr] = Field(default=None, description=r"search engine type. search engine type specified in a POST request;. for this endpoint, the field equals bing")
    target_1: Optional[StrictStr] = Field(default=None, description=r"target specified in a POST array")
    target_2: Optional[StrictStr] = Field(default=None, description=r"target specified in a POST array")
    ...
    items: Optional[List[Optional[DataforseoLabsDomainIntersectionLiveItem]]] = Field(default=None, description=r"contains keywords, relevant SERP elements and related data")
