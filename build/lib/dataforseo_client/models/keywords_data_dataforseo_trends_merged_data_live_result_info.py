...
class KeywordsDataDataforseoTrendsMergedDataLiveResultInfo(BaseModel):
    ...
    items: Optional[List[Optional[BaseKeywordDataDataforseoTrendsItem]]] = Field(default=None, description=r"keyword popularity values per location. values in this array represent percentages relative to the maximum value within each region")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [BaseKeywordDataDataforseoTrendsItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
        })
