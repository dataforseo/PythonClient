...
class ContentAnalysisLanguagesResultInfo(BaseModel):
    ...
    location_code_parent: Optional[StrictInt] = Field(default=None, description=r"")
    country_iso_code: Optional[StrictStr] = Field(default=None, description=r"")
    location_type: Optional[StrictStr] = Field(default=None, description=r"")
