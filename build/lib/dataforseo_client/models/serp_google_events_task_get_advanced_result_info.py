...
from dataforseo_client.models.event_item import EventItem
...
class SerpGoogleEventsTaskGetAdvancedResultInfo(BaseModel):
    ...
    items: Optional[List[Optional[EventItem]]] = Field(default=None, description=r"items of the element")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [EventItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
        })
