...
class DomainAnalyticsTechnologiesAvailableFiltersResultInfo(BaseModel):
    ...
    """ # noqa: E501
    domains_by_technology: Optional[Dict[str, Optional[StrictStr]]] = Field(default=None, description=r"")
    aggregation_technologies: Optional[Dict[str, Optional[StrictStr]]] = Field(default=None, description=r"")
    technologies_summary: Optional[Dict[str, Optional[StrictStr]]] = Field(default=None, description=r"")
    domains_by_html_terms: Optional[Dict[str, Optional[StrictStr]]] = Field(default=None, description=r"")
