...
class AmazonKeywordInfo(BaseModel):
    ...
    search_volume: Optional[StrictInt] = Field(default=None, description=r"average monthly search volume rate. represents the (approximate) number of searches for the provided keyword idea on Amazon")
