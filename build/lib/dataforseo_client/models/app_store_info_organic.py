...
class AppStoreInfoOrganic(BaseModel):
    ...
    categories: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"all relevant categories/genres of the app")
    languages: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"languages supported in the app")
