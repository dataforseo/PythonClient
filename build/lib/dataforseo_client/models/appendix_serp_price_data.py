...
class AppendixSerpPriceData(BaseModel):
    ...
    screenshot: Optional[AppendixTaskKeywordsDataPriceDataInfo] = Field(default=None, description=r"")
    task_get: Optional[AppendixSerpPriceDataInfo] = Field(default=None, description=r"")
