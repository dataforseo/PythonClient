...
class AppDataGoogleAppSearchesTasksReadyResultInfo(BaseModel):
    ...
    endpoint_advanced: Optional[StrictStr] = Field(default=None, description=r"URL for collecting the results of the Google App Searches task")
    endpoint_html: Optional[StrictStr] = Field(default=None, description=r"URL for collecting the results of the Google App Searches HTML task. if HTML tasks are not supported in the specified endpoint, the value will be null")
