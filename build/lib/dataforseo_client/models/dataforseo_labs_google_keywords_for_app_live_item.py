...
from dataforseo_client.models.google_play_ranked_serp_element_info import GooglePlayRankedSerpElementInfo
...
class DataforseoLabsGoogleKeywordsForAppLiveItem(BaseModel):
    ...
    ranked_serp_element: Optional[GooglePlayRankedSerpElementInfo] = Field(default=None, description=r"contains data on the domain’s SERP element found for the returned keyword")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ranked_serp_element": GooglePlayRankedSerpElementInfo.from_dict(obj["ranked_serp_element"]) if obj.get("ranked_serp_element") is not None else None,
        })
