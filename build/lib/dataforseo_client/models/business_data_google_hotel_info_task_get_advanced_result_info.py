...
class BusinessDataGoogleHotelInfoTaskGetAdvancedResultInfo(BaseModel):
    ...
    """ # noqa: E501
    hotel_identifier: Optional[StrictStr] = Field(default=None, description=r"unique hotel identifier. this field will contain the hotel_identifier parameter;. example:. CgoI-KWyzenM_MV3EAE")
