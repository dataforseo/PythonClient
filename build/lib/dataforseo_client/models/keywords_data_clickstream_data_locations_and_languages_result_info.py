...
class KeywordsDataClickstreamDataLocationsAndLanguagesResultInfo(BaseModel):
    ...
    location_code_parent: Optional[StrictStr] = Field(default=None, description=r"the code of the superordinate location. the value will be null as Country is the only supported location_type for this API")
