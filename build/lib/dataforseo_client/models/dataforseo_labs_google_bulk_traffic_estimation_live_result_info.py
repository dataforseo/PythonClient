...
from dataforseo_client.models.dataforseo_labs_google_bulk_traffic_estimation_live_item import DataforseoLabsGoogleBulkTrafficEstimationLiveItem
...
class DataforseoLabsGoogleBulkTrafficEstimationLiveResultInfo(BaseModel):
    ...
    items: Optional[List[Optional[DataforseoLabsGoogleBulkTrafficEstimationLiveItem]]] = Field(default=None, description=r"array of items with relevant traffic estimation data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [DataforseoLabsGoogleBulkTrafficEstimationLiveItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
        })
