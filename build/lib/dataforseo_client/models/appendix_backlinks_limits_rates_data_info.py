...
class AppendixBacklinksLimitsRatesDataInfo(BaseModel):
    ...
    """ # noqa: E501
    summary: Optional[AppendixInfo] = Field(default=None, description=r"")
    history: Optional[AppendixInfo] = Field(default=None, description=r"")
    content_duplicates: Optional[AppendixInfo] = Field(default=None, description=r"")
    ...
    bulk_new_lost_backlinks: Optional[AppendixInfo] = Field(default=None, description=r"")
    bulk_new_lost_referring_domains: Optional[AppendixInfo] = Field(default=None, description=r"")
    bulk_referring_domains: Optional[AppendixInfo] = Field(default=None, description=r"")
    errors: Optional[StrictFloat] = Field(default=None, description=r"")
    domain_pages_summary: Optional[AppendixInfo] = Field(default=None, description=r"")
    timeseries_summary: Optional[AppendixInfo] = Field(default=None, description=r"")
