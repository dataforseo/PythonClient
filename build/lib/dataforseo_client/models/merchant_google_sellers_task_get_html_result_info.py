...
class MerchantGoogleSellersTaskGetHtmlResultInfo(BaseModel):
    ...
    """ # noqa: E501
    product_id: Optional[StrictStr] = Field(default=None, description=r"product_id received in a POST array")
    ...
    items: Optional[List[Optional[HtmlItemInfo]]] = Field(default=None, description=r"elements of search results found on Google Shopping")
