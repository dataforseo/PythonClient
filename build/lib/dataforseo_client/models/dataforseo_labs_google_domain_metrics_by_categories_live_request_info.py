...
class DataforseoLabsGoogleDomainMetricsByCategoriesLiveRequestInfo(BaseModel):
    ...
    """ # noqa: E501
    category_codes: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"product and service categories. required field. The maximum number of categories you can specify: 5. you can download the full list of possible categories")
    first_date: Optional[StrictStr] = Field(default=None, description=r"first date of comparison period. required field. first date for which domain metrics will be provided;. date format: 'yyyy-mm-dd';. example: '2021-06-01';. the list available dates is available through the available history endpoint;. Note: first_date cannot be greater than today’s date;. Also note: the dates specified in first_date and second_date cannot point to the same month of the same year;. you can specify the dates in any order: first_date can be greater than second_date and vice versa;. minimum date: '2020-10-01'")
    second_date: Optional[StrictStr] = Field(default=None, description=r"second date of comparison period. required field. second date for which domain metrics will be provided;. date format: 'yyyy-mm-dd';. example: '2021-10-01';. the list available dates is available through the available history endpoint;. Note: second_date cannot be greater than today’s date;. Also note: the dates specified in first_date and second_date cannot point to the same month of the same year;. you can specify the dates in any order: second_date can be greater than first_date and vice versa;. minimum date: '2020-10-01'")
