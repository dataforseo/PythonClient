...
class AppendixContentGenerationLimitsRatesDataInfo(BaseModel):
    ...
    """ # noqa: E501
    generate: Optional[AppendixInfo] = Field(default=None, description=r"")
    generate_meta_tags: Optional[AppendixInfo] = Field(default=None, description=r"")
    generate_text: Optional[AppendixInfo] = Field(default=None, description=r"")
    paraphrase: Optional[AppendixInfo] = Field(default=None, description=r"")
    check_grammar: Optional[AppendixContentGenerationDayLimitsRatesDataInfo] = Field(default=None, description=r"")
    text_summary: Optional[AppendixContentGenerationDayLimitsRatesDataInfo] = Field(default=None, description=r"")
    generate_sub_topics: Optional[AppendixInfo] = Field(default=None, description=r"")
