...
class AnalysisContentInfo(BaseModel):
    ...
    language: Optional[StrictStr] = Field(default=None, description=r"content language. to obtain a full list of available languages, refer to the Languages endpoint")
