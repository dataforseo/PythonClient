...
class AppendixSerpDaysRatesDataInfo(BaseModel):
    """
    AppendixSerpDaysRatesDataInfo
    """ # noqa: E501
    task_post: Optional[StrictFloat] = Field(default=None, description=r"")
    task_get: Optional[AppendixFunctionTypeInfo] = Field(default=None, description=r"")
    ...
    live: Optional[AppendixFunctionTypeInfo] = Field(default=None, description=r"")
