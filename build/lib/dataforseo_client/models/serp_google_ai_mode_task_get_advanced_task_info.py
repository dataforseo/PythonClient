...
from dataforseo_client.models.serp_google_ai_mode_task_get_advanced_result_info import SerpGoogleAiModeTaskGetAdvancedResultInfo
from dataforseo_client.models.base_response_task_info import BaseResponseTaskInfo



class SerpGoogleAiModeTaskGetAdvancedTaskInfo(BaseModel):
    """
    ...
    result: Optional[List[Optional[SerpGoogleAiModeTaskGetAdvancedResultInfo]]] = Field(default=None, description=r"array of results")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "path": obj.get("path"),
            "data": obj.get("data"),
            "result": [SerpGoogleAiModeTaskGetAdvancedResultInfo.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None,
        })
