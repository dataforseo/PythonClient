...
class OnPageMicrodataRequestInfo(BaseModel):
    ...
    url: Optional[StrictStr] = Field(default=None, description=r"resource URL. required field. you can get this URL in the response of the Pages endpoint. example:. https://dataforseo.com/apis")
