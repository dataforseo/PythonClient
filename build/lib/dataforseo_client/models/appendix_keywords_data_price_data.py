...
class AppendixKeywordsDataPriceData(BaseModel):
    ...
    ad_traffic_by_keywords: Optional[AppendixAKeywordsDataPriceDataInfo] = Field(default=None, description=r"")
    audience_estimation: Optional[AppendixAKeywordsDataPriceDataInfo] = Field(default=None, description=r"")
    bing: Optional[AppendixBingKeywordsDataPriceData] = Field(default=None, description=r"")
    ...
    keyword_suggestions_for_url: Optional[AppendixAKeywordsDataPriceDataInfo] = Field(default=None, description=r"")
    ...
    search_volume: Optional[AppendixAKeywordsDataPriceDataInfo] = Field(default=None, description=r"")
    dataforseo_trends: Optional[AppendixDataforseoTrendsKeywordsDataPriceData] = Field(default=None, description=r"")
    explore: Optional[AppendixExploreKeywordsDataPriceData] = Field(default=None, description=r"")
