...
class AppendixOnPagePriceData(BaseModel):
    ...
    duplicate_tags: Optional[AppendixTaskKeywordsDataPriceDataInfo] = Field(default=None, description=r"")
    instant_pages: Optional[AppendixTaskKeywordsDataPriceDataInfo] = Field(default=None, description=r"")
    keyword_density: Optional[AppendixTaskKeywordsDataPriceDataInfo] = Field(default=None, description=r"")
    links: Optional[AppendixTaskKeywordsDataPriceDataInfo] = Field(default=None, description=r"")
    non_indexable: Optional[AppendixTaskKeywordsDataPriceDataInfo] = Field(default=None, description=r"")
    pages: Optional[AppendixTaskKeywordsDataPriceDataInfo] = Field(default=None, description=r"")
    pages_by_resource: Optional[AppendixTaskKeywordsDataPriceDataInfo] = Field(default=None, description=r"")
    page_screenshot: Optional[AppendixTaskKeywordsDataPriceDataInfo] = Field(default=None, description=r"")
    raw_html: Optional[AppendixTaskKeywordsDataPriceDataInfo] = Field(default=None, description=r"")
    redirect_chains: Optional[AppendixTaskKeywordsDataPriceDataInfo] = Field(default=None, description=r"")
    resources: Optional[AppendixTaskKeywordsDataPriceDataInfo] = Field(default=None, description=r"")
