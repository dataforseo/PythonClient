...
class DataforseoLabsGoogleRankedKeywordsLiveRequestInfo(BaseModel):
    ...
    """ # noqa: E501
    target: Optional[StrictStr] = Field(default=None, description=r"domain name or page url. required field. the domain name of the target website or URL of the target webpage;. the domain name must be specified without https:// or www.;. the webpage URL must be specified with https:// or www.. Note: if you specify the webpage URL without https:// or www., the result will be returned for the entire domain rather than the specific page")
