...
class KeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo(BaseModel):
    ...
    bid: Optional[StrictFloat] = Field(default=None, description=r"the maximum custom bid. required field. the collected data will be based on this value. it stands for the price you are willing to pay for an ad; the higher value you specify here, the higher values you will get in the returned metrics. learn more in this help center article")
    ...
    date_from: Optional[StrictStr] = Field(default=None, description=r"starting date of the forecasting time range. required field if you specify date_to. if you indicate date_from and date_to, you don’t need to specify date_interval. minimum value is tomorrow’s date. the value you specify in date_from shouldn’t be further than date_to. date format: 'yyyy-mm-dd'. example:. '2021-10-30'if Status endpoint returns false in the actual_data field, date_from can be set to the month before last and prior;. if Status endpoint returns true in the actual_data field, date_from can be set to the last month and prior")
    date_to: Optional[StrictStr] = Field(default=None, description=r"ending date of the forecasting time range. required field if you specify date_from. if you indicate date_from and date_to, you don’t need to specify date_interval. minimum value is date_from +1 day. maximum value is current day and month of the next year. date format: 'yyyy-mm-dd'. example:. '2022-10-30'")
    date_interval: Optional[StrictStr] = Field(default=None, description=r"forecasting date interval. optional field. if you specify date_interval, you don’t need to indicate date_from and date_to. possible values: next_week, next_month, next_quarter. default value: next_month")
    sort_by: Optional[StrictStr] = Field(default=None, description=r"results sorting parameters. optional field. Use these parameters to sort the results by relevance, impressions, ctr, average_cpc, cost, or clicks in the descending order. default value: relevance")
