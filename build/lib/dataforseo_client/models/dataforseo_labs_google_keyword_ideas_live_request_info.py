...
class DataforseoLabsGoogleKeywordIdeasLiveRequestInfo(BaseModel):
    ...
    closely_variants: Optional[StrictBool] = Field(default=None, description=r"search mode. optional field. if set to true the results will be based on the phrase-match search algorithm. if set to false the results will be based on the broad-match search algorithm. default value: false")
