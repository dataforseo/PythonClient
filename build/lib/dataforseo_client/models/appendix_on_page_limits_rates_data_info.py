...
class AppendixOnPageLimitsRatesDataInfo(BaseModel):
    ...
    """ # noqa: E501
    task_post: Optional[StrictFloat] = Field(default=None, description=r"")
    tasks_ready: Optional[StrictFloat] = Field(default=None, description=r"")
    summary: Optional[StrictFloat] = Field(default=None, description=r"")
    resources: Optional[StrictFloat] = Field(default=None, description=r"")
    pages: Optional[StrictFloat] = Field(default=None, description=r"")
    non_indexable: Optional[StrictFloat] = Field(default=None, description=r"")
    duplicate_tags: Optional[StrictFloat] = Field(default=None, description=r"")
    links: Optional[StrictFloat] = Field(default=None, description=r"")
    waterfall: Optional[StrictFloat] = Field(default=None, description=r"")
    errors: Optional[StrictFloat] = Field(default=None, description=r"")
    pages_by_resource: Optional[StrictFloat] = Field(default=None, description=r"")
    duplicate_content: Optional[StrictFloat] = Field(default=None, description=r"")
    raw_html: Optional[StrictFloat] = Field(default=None, description=r"")
