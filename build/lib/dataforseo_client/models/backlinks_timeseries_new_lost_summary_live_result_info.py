...
class BacklinksTimeseriesNewLostSummaryLiveResultInfo(BaseModel):
    ...
    group_range: Optional[StrictStr] = Field(default=None, description=r"group_range from the POST array")
    items_count: Optional[StrictInt] = Field(default=None, description=r"the number of results returned in the items array")
    items: Optional[List[Optional[BacklinksTimeseriesNewLostSummaryLiveItem]]] = Field(default=None, description=r"contains relevant backlinks and referring domains data")
