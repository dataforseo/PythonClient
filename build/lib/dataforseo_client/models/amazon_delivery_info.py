...
class AmazonDeliveryInfo(BaseModel):
    ...
    AmazonDeliveryInfo
    """ # noqa: E501
    delivery_message: Optional[StrictStr] = Field(default=None, description=r"message accompanying the delivery information as posted by the seller")
    delivery_date_from: Optional[StrictStr] = Field(default=None, description=r"the earliest date when the product can be shipped")
    delivery_date_to: Optional[StrictStr] = Field(default=None, description=r"the latest date when the product can be delivered")
    fastest_delivery_date_from: Optional[StrictStr] = Field(default=None, description=r"the earliest date when the product can be delivered with a fast delivery option")
    fastest_delivery_date_to: Optional[StrictStr] = Field(default=None, description=r"the latest date when the product can be delivered with a fast delivery option")
