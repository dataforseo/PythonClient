...
class DataforseoLabsGoogleHistoricalRankOverviewLiveResultInfo(BaseModel):
    ...
    items: Optional[List[Optional[DataforseoLabsGoogleHistoricalRankOverviewLiveItem]]] = Field(default=None, description=r"contains historical ranking and traffic data")
