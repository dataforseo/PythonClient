...
from dataforseo_client.models.youtube_video_info import YoutubeVideoInfo
...
class SerpYoutubeVideoInfoTaskGetAdvancedResultInfo(BaseModel):
    ...
    item_types: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"types of search results in SERP. contains types of search results (items) found in SERP.. possible item:. youtube_video_info")
    items_count: Optional[StrictInt] = Field(default=None, description=r"the number of results returned in the items array")
    items: Optional[List[Optional[YoutubeVideoInfo]]] = Field(default=None, description=r"elements of search results found in SERP")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [YoutubeVideoInfo.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
        })
