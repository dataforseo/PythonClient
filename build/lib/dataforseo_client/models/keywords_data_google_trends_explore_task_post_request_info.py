...
class KeywordsDataGoogleTrendsExploreTaskPostRequestInfo(BaseModel):
    ...
    date_to: Optional[StrictStr] = Field(default=None, description=r"ending date of the time range. optional field. if you don’t specify this field, the today’s date will be used by default. date format: 'yyyy-mm-dd'. example:. '2019-01-15'")
    time_range: Optional[StrictStr] = Field(default=None, description=r"preset time ranges. optional field. if you specify date_from or date_to parameters, this field will be ignored when setting a task. possible values for all type parameters:. past_hour, past_4_hours, past_day, past_7_days, past_30_days, past_90_days, past_12_months, past_5_years. possible values for web only:. 2004_present. possible values for news, youtube, images, froogle:. 2008_present")
    item_types: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"types of items returned. optional field. to speed up the execution of the request, specify one item at a time;. possible values:. 'google_trends_graph', 'google_trends_map', 'google_trends_topics_list','google_trends_queries_list'. default value:. 'google_trends_graph'. Note: to obtain google_trends_topics_list and google_trends_queries_list items, specify no more than 1 keyword in the keywords field")
