...
class MerchantAmazonLocationsResultInfo(BaseModel):
    ...
    location_name_parent: Optional[StrictStr] = Field(default=None, description=r"the name of the superordinate location. example:. 'location_code': 9041134,. 'location_name': '90290,California,United States',. 'location_name_parent': 'California,United States'")
