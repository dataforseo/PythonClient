...
class OnPageInstantPagesRequestInfo(BaseModel):
    ...
    store_raw_html: Optional[StrictBool] = Field(default=None, description=r"store HTML of a crawled page. optional field. set to true if you want get the HTML of the page using the OnPage Raw HTML endpoint. default value: false")
    ...
    enable_browser_rendering: Optional[StrictBool] = Field(default=None, description=r"emulate browser rendering to measure Core Web Vitals. optional field. by using this parameter you will be able to emulate a browser when loading a web page;. enable_browser_rendering loads styles, images, fonts, animations, videos, and other resources on a page;. default value: false. set to true to obtain Core Web Vitals (FID, CLS, LCP) metrics in the response;. if you use this field, parameters enable_javascript, and load_resources are enabled automatically;. Note: if you use this parameter, additional charges will apply; learn more about the cost of tasks with this parameter in our help article; the cost can be calculated on the Pricing Page")
    ...
    enable_xhr: Optional[StrictBool] = Field(default=None, description=r"enable XMLHttpRequest on a page. optional field. set to true if you want our crawler to request data from a web server using the XMLHttpRequest object. default value:. falseif you use this field, enable_javascript must be set to true;")
    ...
    validate_micromarkup: Optional[StrictBool] = Field(default=None, description=r"enable microdata validation. optional field. if set to true, you can use the OnPage API Microdata endpoint with the id of the task;. default value: false")
