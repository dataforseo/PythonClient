...
class KeywordsDataDataforseoTrendsExploreLiveResultInfo(BaseModel):
    ...
    items: Optional[List[Optional[DataforseoTrendsDataforseoTrendsGraphElementItem]]] = Field(default=None, description=r"contains keyword popularity and related data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [DataforseoTrendsDataforseoTrendsGraphElementItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
        })
