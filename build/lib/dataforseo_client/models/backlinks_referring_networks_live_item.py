...
class BacklinksReferringNetworksLiveItem(BaseModel):
    ...
    network_address: Optional[StrictStr] = Field(default=None, description=r"address of the referring subnetwork or IP")
    rank: Optional[StrictInt] = Field(default=None, description=r"network rank. rank volume that a referring network passes to the target. rank is calculated based on the method for node ranking in a linked database – a principle used in the original Google PageRank algorithm. learn more about the metric and how it is calculated in this help center article")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        _dict['network_address'] = self.network_address
