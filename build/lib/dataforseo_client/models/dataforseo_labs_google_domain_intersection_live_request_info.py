...
class DataforseoLabsGoogleDomainIntersectionLiveRequestInfo(BaseModel):
    ...
    """ # noqa: E501
    target_1: Optional[StrictStr] = Field(default=None, description=r"domain. required field. the domain name of the first target website. the domain should be specified without https:// and www.")
    target_2: Optional[StrictStr] = Field(default=None, description=r"domain. required field. the domain name of the second target website. the domain should be specified without https:// and www.")
    ...
    offset: Optional[StrictInt] = Field(default=None, description=r"offset in the items array of returned keywords. optional field. default value: 0. if you specify the 10 value, the first ten keywords in the results array will be omitted and the data will be provided for the successive keywords")
