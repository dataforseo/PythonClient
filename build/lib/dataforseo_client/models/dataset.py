...
class Dataset(BaseModel):
    ...
    dataset_id: Optional[StrictStr] = Field(default=None, description=r"ID of the dataset")
    ...
    scholarly_citations_count: Optional[StrictInt] = Field(default=None, description=r"count of articles that refer to the dataset")
    scholarly_articles_url: Optional[StrictStr] = Field(default=None, description=r"url of scholarly articles. link to the list of scholarly articles on Google Scholar. example: https://scholar.google.com/scholar?q=%2210.6084%20m9%20figshare%207427933%20v1%22")
    ...
    dataset_description: Optional[DatasetDescription] = Field(default=None, description=r"description of the dataset")
