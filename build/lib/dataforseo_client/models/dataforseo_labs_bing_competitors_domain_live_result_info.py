...
class DataforseoLabsBingCompetitorsDomainLiveResultInfo(BaseModel):
    ...
    items: Optional[List[Optional[DataforseoLabsCompetitorsDomainLiveItem]]] = Field(default=None, description=r"contains data related to the target and competitor domains")
