...
class DataforseoLabsBingBulkTrafficEstimationLiveResultInfo(BaseModel):
    ...
    items: Optional[List[Optional[DataforseoLabsBingBulkTrafficEstimationLiveItem]]] = Field(default=None, description=r"array of items with relevant traffic estimation data")
