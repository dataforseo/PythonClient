...
class AppendixSocialMediaBusinessDataLimitsRatesDataInfo(BaseModel):
    ...
    """ # noqa: E501
    facebook: Optional[AppendixInfo] = Field(default=None, description=r"")
    pinterest: Optional[AppendixInfo] = Field(default=None, description=r"")
    reddit: Optional[AppendixInfo] = Field(default=None, description=r"")
