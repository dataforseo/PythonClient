...
class SerpGoogleFinanceMarketsTaskGetAdvancedResponseInfo(BaseModel):
    """
    ...
    tasks: Optional[List[Optional[SerpGoogleFinanceMarketsTaskGetAdvancedTaskInfo]]] = Field(default=None, description=r"array of tasks")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tasks": [SerpGoogleFinanceMarketsTaskGetAdvancedTaskInfo.from_dict(_item) for _item in obj["tasks"]] if obj.get("tasks") is not None else None,
        })
