...
class BusinessDataTripadvisorReviewsTaskPostRequestInfo(BaseModel):
    ...
    language_name: Optional[StrictStr] = Field(default=None, description=r"full name of search engine language. optional field. if you use this field, your account will be charged for one extra request. you can receive the list of available languages with language_name by making a separate request to the https://api.dataforseo.com/v3/business_data/tripadvisor/languages. example:. English. You will be additionally charged for setting a language parameter in this endpoint.. The cost can be calculated on the Pricing page.")
    language_code: Optional[StrictStr] = Field(default=None, description=r"search engine language code. optional field. if you use this field, your account will be charged for one extra request. you can receive the list of available languages with language_code by making a separate request to the https://api.dataforseo.com/v3/business_data/tripadvisor/languages. example:. en. You will be additionally charged for setting a language parameter in this endpoint.. The cost can be calculated on the Pricing page.")
    depth: Optional[StrictInt] = Field(default=None, description=r"parsing depth. optional field. number of reviews in SERP;. we strongly recommend setting the parsing depth in the multiples of ten, because our systems processes ten reviews in a row;. default value: 10;. max value: 4490. Your account will be billed per each SERP containing up to 10 results;. Setting depth above 10 may result in additional charges if the search engine returns more than 10 results;. The cost can be calculated on the Pricing page.")
    ratings: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"Tripadvisor traveler rating for a place of interest. optional field. rating based on the written reviews by a traveler after they visited a place.. possible values: excellent, very_good, average, poor, terrible. you can specify several values at once")
    visit_type: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"filter by type of travelers who left a review. optional field. possible values: families, couples, solo, business, friends. you can specify several values at once")
    months: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"filter by months when a traveler made a visit. optional field. possible values: january, february, march, april, may, april, june, july, august, september, october, november, december. you can specify several values at once")
    search_reviews_keyword: Optional[StrictStr] = Field(default=None, description=r"search reviews containing a specified keyword. example:. dessert")
    sort_by: Optional[StrictStr] = Field(default=None, description=r"results sorting parameters. optional field. you can use this field to sort the results;. possible types of sorting:. most_recent. detailed_reviews")
    translate_reviews: Optional[StrictBool] = Field(default=None, description=r"translate reviews according to the URL path. optional field. if set to true, returned reviews will be translated to the language matching the specified url_path;. for example, if url_path contains tripadvisor.it and translate_reviews is true, reviews will be translated to the Italian language;. default value: true. you can learn more about how reviews are translated in this Help Center article")
