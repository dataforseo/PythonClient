...
from dataforseo_client.models.serp_google_ai_mode_live_html_result_info import SerpGoogleAiModeLiveHtmlResultInfo
from dataforseo_client.models.base_response_task_info import BaseResponseTaskInfo



class SerpGoogleAiModeLiveHtmlTaskInfo(BaseModel):
    """
    ...
    result: Optional[List[Optional[SerpGoogleAiModeLiveHtmlResultInfo]]] = Field(default=None, description=r"array of results")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "path": obj.get("path"),
            "data": obj.get("data"),
            "result": [SerpGoogleAiModeLiveHtmlResultInfo.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None,
        })
