...
class SerpGoogleFinanceQuoteLiveHtmlRequestInfo(BaseModel):
    ...
    window: Optional[StrictStr] = Field(default=None, description=r"time window for google_finance_quote graph. optional field. possible values: 1D, 5D, 1M, 6M, YTD, 1Y, 5Y, MAX. default value: 1D")
