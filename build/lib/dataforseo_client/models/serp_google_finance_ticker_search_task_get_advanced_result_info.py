...
class SerpGoogleFinanceTickerSearchTaskGetAdvancedResultInfo(BaseModel):
    """
    ...
    item_types: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"types of search results in SERP. contains types of search results (items) found in SERP;. possible item types: google_finance_market_index, google_finance_asset_pair, google_finance_market_instrument")
    ...
    items: Optional[List[Optional[BaseSerpApiGoogleFinanceTickerSearchElementItem]]] = Field(default=None, description=r"items of search results found in SERP. array of items containing market indexes data;. possible type of items: google_finance_market_index, google_finance_asset_pair, google_finance_market_instrument")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [BaseSerpApiGoogleFinanceTickerSearchElementItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
        })
