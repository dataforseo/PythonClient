...
class MerchantAmazonPaidSerpElementItem(BaseMerchantAmazonElementItem):
    """
    ...
    url: Optional[StrictStr] = Field(default=None, description=r"the URL of the product page")
    image_url: Optional[StrictStr] = Field(default=None, description=r"URL of the product image featured in the results")
    bought_past_month: Optional[StrictInt] = Field(default=None, description=r"number of product purchases in the past month")
    ...
    data_asin: Optional[StrictStr] = Field(default=None, description=r"unique product identifier on Amazon. note that there is no full list of possible values as the data_asin is a dynamic value assigned by Amazon. example:. B07G82D89J")
