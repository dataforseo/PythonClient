...
class BacklinksAnchorsLiveItem(BaseModel):
    ...
    backlinks_spam_score: Optional[StrictInt] = Field(default=None, description=r"average spam score of all backlinks with this anchor. learn more about how the metric is calculated on this help center page")
