...
class MerchantAmazonSellerItemSerpElementItem(BaseMerchantAmazonSellersElementItem):
    ...
    rank_absolute: Optional[StrictInt] = Field(default=None, description=r"absolute rank in SERP. absolute position among all the elements found in Amazon Sellers SERP")
    position: Optional[StrictStr] = Field(default=None, description=r"alignment of the element in SERP. possible values:. left, right")
    xpath: Optional[StrictStr] = Field(default=None, description=r"XPath of the element")
    seller_name: Optional[StrictStr] = Field(default=None, description=r"business name of the seller")
    seller_url: Optional[StrictStr] = Field(default=None, description=r"url forwarding to the seller’s page on Amazon")
    ships_from: Optional[StrictStr] = Field(default=None, description=r"sender company name")
    price: Optional[PriceInfo] = Field(default=None, description=r"product pricing details. if there are no details, the value will be null")
    percentage_discount: Optional[StrictFloat] = Field(default=None, description=r"value of the percentage discount")
    ...
    rating: Optional[RatingElement] = Field(default=None, description=r"seller rating details. seller popularity rate based on customer reviews")
    condition: Optional[StrictStr] = Field(default=None, description=r"product condition. condition of the product offered by the seller")
    condition_description: Optional[StrictStr] = Field(default=None, description=r"product condition details. expanded details on the condition of the product offered by the seller")
