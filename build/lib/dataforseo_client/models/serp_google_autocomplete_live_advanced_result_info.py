...
from dataforseo_client.models.autocomplete import Autocomplete
...
class SerpGoogleAutocompleteLiveAdvancedResultInfo(BaseModel):
    ...
    spell: Optional[SpellInfo] = Field(default=None, description=r"autocorrection of the search engine. if the search engine provided results for a keyword that was corrected, we will specify the keyword corrected by the search engine and the type of autocorrection;. in this case, will equal null")
    refinement_chips: Optional[RefinementChipsInfo] = Field(default=None, description=r"search refinement chips")
    item_types: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"types of search results in SERP. contains types of search results (items) found in SERP.. possible item types:. autocomplete")
    ...
    items: Optional[List[Optional[Autocomplete]]] = Field(default=None, description=r"items of the element")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [Autocomplete.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
        })
