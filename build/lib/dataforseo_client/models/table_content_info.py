...
class TableContentInfo(BaseModel):
    ...
    TableContentInfo
    """ # noqa: E501
    header: Optional[List[Optional[TableContentItemInfo]]] = Field(default=None, description=r"parsed content of the header")
    body: Optional[List[Optional[TableContentItemInfo]]] = Field(default=None, description=r"content of the body of the table")
    footer: Optional[List[Optional[TableContentItemInfo]]] = Field(default=None, description=r"content of the footer of the table")
