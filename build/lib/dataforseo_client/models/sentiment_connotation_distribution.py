...
class SentimentConnotationDistribution(BaseModel):
    ...
    """ # noqa: E501
    anger: Optional[ContentAnalysisSummaryInfo] = Field(default=None, description=r"")
    happiness: Optional[ContentAnalysisSummaryInfo] = Field(default=None, description=r"")
    love: Optional[ContentAnalysisSummaryInfo] = Field(default=None, description=r"")
    sadness: Optional[ContentAnalysisSummaryInfo] = Field(default=None, description=r"")
    share: Optional[ContentAnalysisSummaryInfo] = Field(default=None, description=r"")
    fun: Optional[ContentAnalysisSummaryInfo] = Field(default=None, description=r"")
