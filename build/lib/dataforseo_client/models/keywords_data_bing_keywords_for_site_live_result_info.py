...
class KeywordsDataBingKeywordsForSiteLiveResultInfo(BaseModel):
    ...
    search_volume: Optional[StrictInt] = Field(default=None, description=r"monthly average search volume rate. represents the (approximate) number of searches for the keyword on the Bing search engine, depending on the user’s targetingsearch volume is rounded to the closest decimal valuesif there is no data, then the value is null")
