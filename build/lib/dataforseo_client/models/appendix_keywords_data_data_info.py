...
class AppendixKeywordsDataDataInfo(BaseModel):
    ...
    """ # noqa: E501
    keywords_for_keywords: Optional[AppendixInfo] = Field(default=None, description=r"")
    keywords_for_site: Optional[AppendixInfo] = Field(default=None, description=r"")
    search_volume: Optional[AppendixInfo] = Field(default=None, description=r"")
    ad_traffic_by_keywords: Optional[AppendixInfo] = Field(default=None, description=r"")
    ...
    explore: Optional[AppendixInfo] = Field(default=None, description=r"")
    ...
    bing: Optional[AppendixBingKeywordsDataLimitsRatesDataInfo] = Field(default=None, description=r"")
    ...
    keyword_suggestions_for_url: Optional[AppendixInfo] = Field(default=None, description=r"")
    naver: Optional[AppendixNaverKeywordsDataDataInfo] = Field(default=None, description=r"")
    google: Optional[AppendixBingKeywordsDataLimitsRatesDataInfo] = Field(default=None, description=r"")
    keyword_ideas_ads_api: Optional[AppendixSerpDaysRatesDataInfo] = Field(default=None, description=r"")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        _dict['naver'] = self.naver.to_dict() if self.naver else None
        _dict['google'] = self.google.to_dict() if self.google else None
        _dict['keyword_ideas_ads_api'] = self.keyword_ideas_ads_api.to_dict() if self.keyword_ideas_ads_api else None
        return _dict
