...
class ProductInformationProductInformationDetailsItem(BaseMerchantAmazonProductInformationElementItem):
    """
    ...
    body: Optional[Dict[str, Optional[StrictStr]]] = Field(default=None, description=r"contains information specified about the product within the section_name")
