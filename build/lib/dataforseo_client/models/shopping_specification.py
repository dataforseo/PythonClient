...
class ShoppingSpecification(BaseModel):
    ...
    position: Optional[StrictStr] = Field(default=None, description=r"alignment of the element on the product specification page. can take the following values:. right")
