...
class SerpApiGoogleFinanceDetailsElementItem(BaseSerpApiGoogleFinanceElementItem):
    ...
    badges: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"google finance badges relevant to the element. example: Futures Contract")
    previous_close: Optional[StrictFloat] = Field(default=None, description=r"value of the previous close")
    start_day_range: Optional[StrictFloat] = Field(default=None, description=r"value of the start day range")
    end_day_range: Optional[StrictFloat] = Field(default=None, description=r"value of the end day range")
    start_year_range: Optional[StrictFloat] = Field(default=None, description=r"value of the start year range")
    end_year_range: Optional[StrictFloat] = Field(default=None, description=r"value of the end year range")
    market_cap: Optional[StrictFloat] = Field(default=None, description=r"market cap value")
    volume: Optional[StrictFloat] = Field(default=None, description=r"total volume value")
    avg_volume: Optional[StrictFloat] = Field(default=None, description=r"average volume value")
    pe_ratio: Optional[StrictFloat] = Field(default=None, description=r"price-earnings ratio")
    dividend_yield: Optional[StrictFloat] = Field(default=None, description=r"dividend yield value")
    primary_exchange: Optional[StrictStr] = Field(default=None, description=r"primary exchange value")
    ytd_return: Optional[StrictFloat] = Field(default=None, description=r"year-to-date return value")
    expense_ratio: Optional[StrictFloat] = Field(default=None, description=r"expense ratio value")
    category: Optional[StrictStr] = Field(default=None, description=r"category name")
    net_assets: Optional[StrictFloat] = Field(default=None, description=r"")
    yield_: Optional[StrictFloat] = Field(default=None, description=r"yield value")
    front_load: Optional[StrictFloat] = Field(default=None, description=r"front load value")
    market_segment: Optional[StrictStr] = Field(default=None, description=r"name of the relevant market segment")
    open_interest: Optional[StrictFloat] = Field(default=None, description=r"open interest value")
    settlement_price: Optional[StrictFloat] = Field(default=None, description=r"settlement price value")
    cdp_climate_change_score: Optional[StrictStr] = Field(default=None, description=r"climate change score by carbon disclosure project methodology")
    metrics_currency: Optional[StrictStr] = Field(default=None, description=r"currency of the metrics")
