...
class MerchantAmazonAsinTasksReadyResultInfo(BaseModel):
    ...
    endpoint_advanced: Optional[StrictStr] = Field(default=None, description=r"URL for collecting the results of the Amazon ASIN Advanced task")
    endpoint_html: Optional[StrictStr] = Field(default=None, description=r"URL for collecting the results of the Amazon ASIN HTML task")
