...
class KeywordsDataBingAudienceEstimationTaskPostRequestInfo(BaseModel):
    ...
    age: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"selection of age ranges for targeting. possible values: eighteen_to_twenty_four, fifty_to_sixty_four, sixty_five_and_above, thirteen_to_seventeen, thirty_five_to_forty_nine, twenty_five_to_thirty_four, unknown, zero_to_twelve")
    bid: Optional[StrictFloat] = Field(default=None, description=r"desired bid setting value in USD. maximum value: 1000")
    daily_budget: Optional[StrictFloat] = Field(default=None, description=r"daily campaign budget value in USD. maximum value: 10000")
    gender: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"gender to target. possible values: male, female, unknown")
    industry: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"industry of LinkedIn profile targeting. if you use this field, you can receive the list of available industry names  with industry_id by making a separate request to the https://api.dataforseo.com/v3/keywords_data/bing/audience_estimation/industries. example: 806301758")
    job_function: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"job function of LinkedIn profile targeting. if you use this field, you can receive the list of available job function names  with job_function_id by making a separate request to the https://api.dataforseo.com/v3/keywords_data/bing/audience_estimation/job_functions. example: 806300451")
