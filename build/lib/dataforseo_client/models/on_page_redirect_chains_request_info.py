...
class OnPageRedirectChainsRequestInfo(BaseModel):
    ...
    url: Optional[StrictStr] = Field(default=None, description=r"page URL. optional field. absolute URL of the target page. if you use this field, the API response will return only redirect chains which contain the specified URL")
    limit: Optional[StrictInt] = Field(default=None, description=r"the maximum number of returned redirect chains. optional field. default value: 100. maximum value: 1000")
    offset: Optional[StrictInt] = Field(default=None, description=r"offset in the results array of returned redirect chains. optional field. default value: 0. if you specify the 10 value, the first ten redirect chains in the results array will be omitted and the data will be provided for the successive redirect chains")
    filters: Optional[List[Optional[Any]]] = Field(default=None, description=r"array of results filtering parameters. optional field. you can use only one filtering parameter with this endpoint. the following filtering parameter is supported:. is_redirect_loop. the following operators are supported:. regex, not_regex, =, <>. examples:. ['is_redirect_loop','=','true']. ['is_redirect_loop','<>','false']")
