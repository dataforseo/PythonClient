...
class MerchantGoogleSellersTasksReadyResultInfo(BaseModel):
    ...
    se_type: Optional[StrictStr] = Field(default=None, description=r"type of search engine. can take the following values: shopping")
    ...
    endpoint_advanced: Optional[StrictStr] = Field(default=None, description=r"URL for collecting the results of Google Shopping Sellers Advanced task")
    endpoint_html: Optional[StrictStr] = Field(default=None, description=r"URL for collecting the results of Google Shopping Sellers HTML task")
