...
class BacklinksDomainIntersection(BaseModel):
    ...
    backlinks_spam_score: Optional[StrictInt] = Field(default=None, description=r"average spam score of the backlinks pointing to the target. learn more about how the metric is calculated on this help center page")
