...
class BacklinksDomainIntersectionLiveRequestInfo(BaseModel):
    ...
    offset: Optional[StrictInt] = Field(default=None, description=r"offset in the array of returned results. optional field. default value: 0. if you specify the 10 value, the first ten backlinks in the results array will be omitted and the data will be provided for the successive backlinks")
    limit: Optional[StrictInt] = Field(default=None, description=r"the maximum number of returned results. optional field. default value: 100. maximum value: 1000")
    ...
    intersection_mode: Optional[StrictStr] = Field(default=None, description=r"indicates whether to intersect backlinks. optional field. use this field to intersect or merge results for the specified domains. possible values: all, partial. all – results are based on all backlinks;. partial – results are based on the intersecting backlinks only;. default value: all")
