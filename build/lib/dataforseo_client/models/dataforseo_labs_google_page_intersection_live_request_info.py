...
class DataforseoLabsGooglePageIntersectionLiveRequestInfo(BaseModel):
    ...
    item_types: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"search results type. indicates type of search results included in the response. optional field. possible values:. ['organic', 'paid', 'featured_snippet', 'local_pack']. default value:. ['organic', 'paid']")
    ...
    offset: Optional[StrictInt] = Field(default=None, description=r"offset in the items array of returned keywords. optional field. default value: 0. if you specify 10 here, the first ten keywords in the results array will be omitted and the data will be provided for the successive keywords")
