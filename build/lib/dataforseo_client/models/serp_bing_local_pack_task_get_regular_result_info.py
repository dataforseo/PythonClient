...
class SerpBingLocalPackTaskGetRegularResultInfo(BaseModel):
    ...
    spell: Optional[SpellInfo] = Field(default=None, description=r"autocorrection of the search engine. if the search engine provided results for a keyword that was corrected, we will specify the keyword corrected by the search engine and the type of autocorrection. equals null")
    refinement_chips: Optional[RefinementChipsInfo] = Field(default=None, description=r"search refinement chips. equals null")
    item_types: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"types of search results in SERP. contains types of search results (items) found in SERP.. possible item types:. local_pack")
    ...
    items: Optional[List[Optional[BaseBingSerpApiElementItem]]] = Field(default=None, description=r"elements of search results found in SERP")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [BaseBingSerpApiElementItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
        })
