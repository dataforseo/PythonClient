...
from dataforseo_client.models.on_page_microdata_info_item import OnPageMicrodataInfoItem
...
class OnPageMicrodataResultInfo(BaseModel):
    ...
    test_summary: Optional[TestSummary] = Field(default=None, description=r"microdata validation test results")
    items_count: Optional[StrictInt] = Field(default=None, description=r"number of items in the results array")
    items: Optional[List[Optional[OnPageMicrodataInfoItem]]] = Field(default=None, description=r"items array")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        _dict['test_summary'] = self.test_summary.to_dict() if self.test_summary else None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [OnPageMicrodataInfoItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
        })
