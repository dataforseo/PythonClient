...
class DataforseoLabsAmazonRankedKeywordsLiveResultInfo(BaseModel):
    ...
    items: Optional[List[Optional[DataforseoLabsAmazonRankedKeywordsLiveItem]]] = Field(default=None, description=r"contains detected Amazon product competitors and related data")
