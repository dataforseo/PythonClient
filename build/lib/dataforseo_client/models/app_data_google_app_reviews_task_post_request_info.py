...
class AppDataGoogleAppReviewsTaskPostRequestInfo(BaseModel):
    ...
    """ # noqa: E501
    app_id: Optional[StrictStr] = Field(default=None, description=r"id of the app. required field. ID of the mobile application on Google Play;. you can find the ID in the URL of every app listed on Google Play;. example:. https://play.google.com/store/apps/details?id=org.telegram.messenger")
    ...
    depth: Optional[StrictInt] = Field(default=None, description=r"parsing depth. optional field. number of reviews to be returned in the API response;. we strongly recommend setting the parsing depth in the multiples of 150, because our system processes 150 reviews in a row;. default value: 150;. maximum value: 100000;. Your account will be billed per each SERP containing up to 150 results;. Setting depth above 150 may result in additional charges if the search engine returns more than 150 results;. The cost can be calculated on the Pricing page.")
    rating: Optional[StrictInt] = Field(default=None, description=r"filter reviews by rating. optional field. you can use this field to filter the results;. possible types of filtering:. 5 — return reviews with five-star rating only;. 4 — return reviews with four-star rating only;. 3 — return reviews with three-star rating only;. 2 — return reviews with two-star rating only;. 1 — return reviews with one-star rating only;. by default, the API returns all reviews regardless of the number of stars")
    sort_by: Optional[StrictStr] = Field(default=None, description=r"results sorting parameters. optional field. you can use this field to sort the results;. possible types of sorting:. newest — sort by the most recent reviews;. most_relevant — sort by the most relevant reviews;. default rule: most_relevant")
