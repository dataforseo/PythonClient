...
class SerpApiGoogleFinanceEarningsCalendarElementItem(BaseSerpApiGoogleFinanceElementItem):
    """
    ...
    items: Optional[List[Optional[GoogleFinanceEarningsCalendarElement]]] = Field(default=None, description=r"market indexes data. array of items containing market indexes data;. possible type of items: google_finance_asset_pair_element, google_finance_market_instrument_element, google_finance_market_index_element")
