...
class ContentAnalysisSentimentAnalysisLiveResultInfo(BaseModel):
    ...
    positive_connotation_distribution: Optional[PositiveConnotationDistribution] = Field(default=None, description=r"citation distribution by sentiment connotation types. contains objects with citation counts and relevant data distributed by types of sentiments (sentiment polarity);. possible sentiment connotation types: positive, negative, neutral")
    sentiment_connotation_distribution: Optional[SentimentConnotationDistribution] = Field(default=None, description=r"citation distribution by sentiment connotations. contains objects with citation counts and relevant data distributed by sentiments (emotional reactions);. possible sentiment connotation types: anger, happiness, love, sadness, share, fun")
