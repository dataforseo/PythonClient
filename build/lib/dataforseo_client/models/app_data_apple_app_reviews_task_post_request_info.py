...
class AppDataAppleAppReviewsTaskPostRequestInfo(BaseModel):
    ...
    sort_by: Optional[StrictStr] = Field(default=None, description=r"results sorting parameters. optional field. you can use this field to sort the results;. possible types of sorting:. most_recent — sort by the most recent reviews;. most_helpful — sort by the most relevant reviews;. default rule: most_helpful")
