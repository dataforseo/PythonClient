...
class PositiveConnotationDistribution(BaseModel):
    ...
    """ # noqa: E501
    positive: Optional[ContentAnalysisSummaryInfo] = Field(default=None, description=r"")
    negative: Optional[ContentAnalysisSummaryInfo] = Field(default=None, description=r"")
    neutral: Optional[ContentAnalysisSummaryInfo] = Field(default=None, description=r"")
