...
class AppendixBusinessDataGoogleInfo(BaseModel):
    ...
    """ # noqa: E501
    my_business_info: Optional[AppendixInfo] = Field(default=None, description=r"")
    my_business_updates: Optional[AppendixInfo] = Field(default=None, description=r"")
    hotel_info: Optional[AppendixSerpDaysRatesDataInfo] = Field(default=None, description=r"")
    hotel_searches: Optional[AppendixInfo] = Field(default=None, description=r"")
    reviews: Optional[AppendixInfo] = Field(default=None, description=r"")
    questions_and_answers: Optional[AppendixInfo] = Field(default=None, description=r"")
    extended_reviews: Optional[AppendixInfo] = Field(default=None, description=r"")
