...
class BusinessDataGoogleReviewsTaskPostRequestInfo(BaseModel):
    ...
    cid: Optional[StrictStr] = Field(default=None, description=r"unique, google-defined id of the business entity. required field if you don’t specify keyword or place_id. example:. 194604053573767737. learn more about the identifier in this help center article")
    place_id: Optional[StrictStr] = Field(default=None, description=r"identifier of the business entity in Google Maps. required field if you don’t specify keyword or cid. example:. GhIJQWDl0CIeQUARxks3icF8U8A. learn more about the identifier in this help center article")
    ...
    sort_by: Optional[StrictStr] = Field(default=None, description=r"results sorting parameters. optional field. you can use this field to sort the results. possible types of sorting:. newest – sort by newest first. highest_rating – sort by highest rating. lowest_rating – sort by lowest rating. relevant – sort by relevance. default value: relevant")
