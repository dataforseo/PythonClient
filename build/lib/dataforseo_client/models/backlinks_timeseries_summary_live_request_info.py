...
class BacklinksTimeseriesSummaryLiveRequestInfo(BaseModel):
    ...
    """ # noqa: E501
    target: Optional[StrictStr] = Field(default=None, description=r"domain to get data for. required field. a domain should be specified without https:// and www.. example:. 'forbes.com'")
    date_from: Optional[StrictStr] = Field(default=None, description=r"starting date of the time range. optional field. this field indicates the date which will be used as a threshold for summary data;. minimum value: 2019-01-30. maximum value shouldn’t exceed the date specified in the date_to. date format: 'yyyy-mm-dd'. example:. '2021-01-01'")
