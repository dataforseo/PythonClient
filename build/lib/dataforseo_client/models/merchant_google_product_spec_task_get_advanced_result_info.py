...
class MerchantGoogleProductSpecTaskGetAdvancedResultInfo(BaseModel):
    ...
    image_url: Optional[StrictStr] = Field(default=None, description=r"URL of the product image")
    tags: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"tags of the product")
    ...
    item_types: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"types of items found on the product specification page. possible item types:. shopping_specification")
    items_count: Optional[StrictInt] = Field(default=None, description=r"the number of results returned in the items array")
    items: Optional[List[Optional[ShoppingSpecification]]] = Field(default=None, description=r"items on the product specification page. contains all product attributes and related data listed on the product specification page")
