...
class AppendixMerchantLimitsRatesDataInfo(BaseModel):
    ...
    """ # noqa: E501
    google: Optional[AppendixMerchantGoogleInfo] = Field(default=None, description=r"")
    amazon: Optional[AppendixMerchantAmazonInfo] = Field(default=None, description=r"")
