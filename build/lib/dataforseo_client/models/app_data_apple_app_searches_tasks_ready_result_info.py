...
class AppDataAppleAppSearchesTasksReadyResultInfo(BaseModel):
    ...
    endpoint_advanced: Optional[StrictStr] = Field(default=None, description=r"URL for collecting the results of the Apple App Searches task")
    endpoint_html: Optional[StrictStr] = Field(default=None, description=r"URL for collecting the results of the Apple App Searches HTML task. if HTML tasks are not supported in the specified endpoint, the value will be null")
