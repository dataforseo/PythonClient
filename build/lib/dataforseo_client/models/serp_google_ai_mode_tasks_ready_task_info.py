...
from dataforseo_client.models.serp_google_ai_mode_tasks_ready_result_info import SerpGoogleAiModeTasksReadyResultInfo
from dataforseo_client.models.base_response_task_info import BaseResponseTaskInfo



class SerpGoogleAiModeTasksReadyTaskInfo(BaseModel):
    """
    ...
    result: Optional[List[Optional[SerpGoogleAiModeTasksReadyResultInfo]]] = Field(default=None, description=r"array of results")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "path": obj.get("path"),
            "data": obj.get("data"),
            "result": [SerpGoogleAiModeTasksReadyResultInfo.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None,
        })
