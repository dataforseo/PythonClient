...
class DataforseoLabsGoogleKeywordsForAppLiveResultInfo(BaseModel):
    ...
    items: Optional[List[Optional[DataforseoLabsGoogleKeywordsForAppLiveItem]]] = Field(default=None, description=r"contains data related to the ranking keywords for the app specified in the app_id field")
