...
class AppendixExploreKeywordsDataPriceData(BaseModel):
    ...
    """ # noqa: E501
    live: Optional[AppendixTaskKeywordsDataPriceDataInfo] = Field(default=None, description=r"")
    task_get: Optional[AppendixTaskKeywordsDataPriceDataInfo] = Field(default=None, description=r"")
