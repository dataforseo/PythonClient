...
from dataforseo_client.models.tripadvisor_search_organic import TripadvisorSearchOrganic
...
class BusinessDataTripadvisorSearchTaskGetResultInfo(BaseModel):
    ...
    """ # noqa: E501
    keyword: Optional[StrictStr] = Field(default=None, description=r"keyword received in a POST array. this field will contain the alias parameter if it was specified in a POST array")
    ...
    check_url: Optional[StrictStr] = Field(default=None, description=r"direct URL to Tripadvisor results. you can use it to make sure that we provided accurate results")
    ...
    item_types: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"item types encountered in the result. possible item types: tripadvisor_search_organic")
    ...
    items: Optional[List[Optional[TripadvisorSearchOrganic]]] = Field(default=None, description=r"Tripadvisor search listing results. you can get more results by using the depth parameter when setting a task")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [TripadvisorSearchOrganic.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
        })
