...
class BacklinksPageIntersectionLiveRequestInfo(BaseModel):
    ...
    """ # noqa: E501
    targets: Optional[Dict[str, Optional[StrictStr]]] = Field(default=None, description=r"domains, subdomains or webpages to get links for. required field. you can set up to 20 domains, subdomains or webpages. a domain or a subdomain should be specified without https:// and www.. a page should be specified with absolute URL (including http:// or https://). example:. 'targets': {. '1': 'http://planet.postgresql.org/',. '2': 'http://gborg.postgresql.org/'. }")
    exclude_targets: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"domains, subdomains or webpages you want to exclude. optional field. you can set up to 10 domains, subdomains or webpages. if you use this array, results will contain the referring pages that link to targets but don’t link to exclude_targets. example:. 'exclude_targets': [. 'bbc.com',. 'https://www.apple.com/iphone/*',. 'https://dataforseo.com/apis/*']")
    backlinks_status_type: Optional[StrictStr] = Field(default=None, description=r"set what backlinks to return and count. optional field. you can use this field to choose what backlinks will be returned and used for aggregated metrics for your targets;. possible values:. all – all backlinks will be returned and counted;. live – backlinks found during the last check will be returned and counted;. lost – lost backlinks will be returned and counted;. default value: live")
    ...
    offset: Optional[StrictInt] = Field(default=None, description=r"offset in the results array of the returned backlinks. optional field. default value: 0. if you specify the 10 value, the first ten backlinks in the results array will be omitted and the data will be provided for the successive backlinks")
    ...
    internal_list_limit: Optional[StrictInt] = Field(default=None, description=r"maximum number of elements within internal arrays. optional field. you can use this field to limit the number of elements within the following arrays:. attributes. domain_from_platform_type. default value: 10. maximum value: 1000")
    include_subdomains: Optional[StrictBool] = Field(default=None, description=r"indicates if the subdomains of the targets will be included in the search. optional field. if set to false, the subdomains will be ignored. default value: true")
    include_indirect_links: Optional[StrictBool] = Field(default=None, description=r"indicates if indirect links to the targets will be included in the results. optional field. if set to true, the results will include data on indirect links pointing to a page that either redirects to a target, or points to a canonical page. if set to false, indirect links will be ignored. default value: true")
    ...
    intersection_mode: Optional[StrictStr] = Field(default=None, description=r"indicates whether to intersect backlinks. optional field. use this field to intersect or merge results for the specified URLs. possible values: all, partial. all – results are based on all backlinks;. partial – results are based on the intersecting backlinks only;. default value: all")
