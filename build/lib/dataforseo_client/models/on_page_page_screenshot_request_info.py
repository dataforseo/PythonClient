...
class OnPagePageScreenshotRequestInfo(BaseModel):
    ...
    """ # noqa: E501
    url: Optional[StrictStr] = Field(default=None, description=r"page url. required field. absolute URL of the page to snap. note: if the URL you indicate here returns a 404 status code or the indicated value is not a valid URL, you will obtain 'error_message':'Screenshot is empty' in the response array")
    ...
    full_page_screenshot: Optional[StrictBool] = Field(default=None, description=r"take a screenshot of the full page. optional field. set to false if you want to capture only the part of the page displayed before scrolling. default value: true")
