...
class BingRelatedSearchesSerpElementItem(BaseBingSerpApiElementItem):
    """
    ...
    items: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"items in SERP")
