...
class SerpApiGoogleFinanceQuoteElementItem(BaseSerpApiGoogleFinanceElementItem):
    """
    ...
    quote: Optional[BaseSerpApiGoogleFinanceElementItem] = Field(default=None, description=r"quoted market indexes")
    graph_items: Optional[List[Optional[GraphItems]]] = Field(default=None, description=r"values on graph")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        graph_items_items = []
        if self.graph_items:
            for _item in self.graph_items:
                if _item:
                    graph_items_items.append(_item.to_dict())
            _dict['graph_items'] = graph_items_items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "graph_items": [GraphItems.from_dict(_item) for _item in obj["graph_items"]] if obj.get("graph_items") is not None else None,
        })
