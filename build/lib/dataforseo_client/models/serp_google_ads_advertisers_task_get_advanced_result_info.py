...
class SerpGoogleAdsAdvertisersTaskGetAdvancedResultInfo(BaseModel):
    ...
    item_types: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"types of search results in SERP. contains types of search results (items) found in SERP.. possible item types:. ads_muti_account_advertiser, ads_advertiser, ads_domain")
    ...
    items: Optional[List[Optional[BaseSerpApiAdsAdvertiserElementItem]]] = Field(default=None, description=r"items of the element")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [BaseSerpApiAdsAdvertiserElementItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
        })
