...
class AppendixBusinessDataPriceData(BaseModel):
    ...
    social_media: Optional[AppendixSocialMediaBusinessDataPriceData] = Field(default=None, description=r"")
    ...
    yelp: Optional[AppendixTrBusinessDataPriceDataInfo] = Field(default=None, description=r"")
