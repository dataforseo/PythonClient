...
class AppleRankedSerpElementInfo(BaseModel):
    ...
    serp_item: Optional[AppStoreSearchOrganic] = Field(default=None, description=r"contains data on the SERP element. the list of supported SERP elements can be found below")
