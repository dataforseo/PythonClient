...
class SerpGoogleSearchByImageTaskGetAdvancedResultInfo(BaseModel):
    ...
    """ # noqa: E501
    image_url: Optional[StrictStr] = Field(default=None, description=r"URL specified in a POST array")
    keyword: Optional[StrictStr] = Field(default=None, description=r"keyword Google associated with the specified image")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [BaseSerpApiGoogleSearchByImagesElementItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
        })
