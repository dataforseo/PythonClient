...
class DataforseoLabsGoogleHistoricalBulkTrafficEstimationLiveResultInfo(BaseModel):
    ...
    items: Optional[List[Optional[DataforseoLabsGoogleHistoricalBulkTrafficEstimationLiveItem]]] = Field(default=None, description=r"array of items with relevant traffic estimation data")
