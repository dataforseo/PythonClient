...
class DataforseoLabsAmazonRelatedKeywordsLiveResultInfo(BaseModel):
    ...
    seed_keyword_data: Optional[AmazonKeywordData] = Field(default=None, description=r"keyword data for the seed keyword. fields in the object are identical to that of keyword_data")
    ...
    items: Optional[List[Optional[DataforseoLabsAmazonRelatedKeywordsLiveItem]]] = Field(default=None, description=r"contains objects with keywords and related data")
