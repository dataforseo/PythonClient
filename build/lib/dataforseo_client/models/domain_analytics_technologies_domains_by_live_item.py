...
class DomainAnalyticsTechnologiesDomainsByLiveItem(BaseModel):
    ...
    technologies: Optional[TechnologiesInfo] = Field(default=None, description=r"technologies used by target domain. contains objects with the names of technologies used on the website;. to get a full list of technologies and their structure, refer to the technologies endpoint")
