...
class AiOptimizationClaudeLlmResponsesLiveRequestInfo(BaseModel):
    ...
    max_output_tokens: Optional[StrictInt] = Field(default=None, description=r"maximum number of tokens in the AI response. optional field. minimum value: 1. maximum value: 2048. default value: 2048. Note: when web_search is set to true, the output token count may exceed the specified max_output_tokens limit")
    ...
    top_p: Optional[StrictFloat] = Field(default=None, description=r"diversity of the AI response. optional field. controls diversity of the response by limiting token selection;. minimum value: 0. maximum value: 1. default value: null")
    ...
    web_search_country_iso_code: Optional[StrictStr] = Field(default=None, description=r"ISO country code of the location. optional field. possible values: 'AR','AT','AU','BE','BR','CA','CH','CL','CN','DE','DK','ES','FI','FR','GB','HK','ID','IN','IT','JP','KR','MX','MY','NL','NO','NZ','PH','PL','PT','RU','SA','SE','TR','TW','US','ZA'")
    web_search_city: Optional[StrictStr] = Field(default=None, description=r"city name of the location. optional field. Note: specify web_search_country_iso_code to use this parameter")
