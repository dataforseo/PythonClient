...
class BacklinksHistoryLiveItem(BaseModel):
    ...
    rank: Optional[StrictInt] = Field(default=None, description=r"domain rank on the given date. learn more about the metric and how it is calculated in this help center article")
