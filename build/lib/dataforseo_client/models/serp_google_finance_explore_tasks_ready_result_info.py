...
class SerpGoogleFinanceExploreTasksReadyResultInfo(BaseModel):
    """
    ...
    se_type: Optional[StrictStr] = Field(default=None, description=r"type of search engine. example: finance_explore")
