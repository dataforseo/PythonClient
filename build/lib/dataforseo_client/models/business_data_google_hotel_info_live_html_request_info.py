...
class BusinessDataGoogleHotelInfoLiveHtmlRequestInfo(BaseModel):
    ...
    check_in: Optional[StrictStr] = Field(default=None, description=r"check-in date. optional field. if you don’t specify this field, tomorrow’s date will be used by default;. date format: 'yyyy-mm-dd'. example:. '2019-01-15'")
    check_out: Optional[StrictStr] = Field(default=None, description=r"check-out date. optional field. if you don’t specify this field, our system will apply the date of two days from now by default;. date format: 'yyyy-mm-dd'. example:. '2019-01-15'")
