...
from dataforseo_client.models.content_parsing_element import ContentParsingElement
...
class OnPageContentParsingLiveResultInfo(BaseModel):
    ...
    items: Optional[List[Optional[ContentParsingElement]]] = Field(default=None, description=r"items array")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [ContentParsingElement.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
        })
