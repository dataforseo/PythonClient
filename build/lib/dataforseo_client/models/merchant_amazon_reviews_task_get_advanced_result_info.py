...
class MerchantAmazonReviewsTaskGetAdvancedResultInfo(BaseModel):
    ...
    title: Optional[StrictStr] = Field(default=None, description=r"title of the product on Amazon. the title of the product for which the reviews are collected")
    image: Optional[AiModeImagesElementInfo] = Field(default=None, description=r"product image data")
    rating: Optional[RatingElement] = Field(default=None, description=r"rating of the product on Amazon. popularity rate based on reviews and displayed in SERP")
    reviews_count: Optional[StrictInt] = Field(default=None, description=r"the total number of reviews")
    item_types: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"type of search results in Amazon SERP. contains types of search results (items) found in Amazon SERP;. possible item types:. amazon_review_item")
    ...
    items: Optional[List[Optional[AmazonReviewItem]]] = Field(default=None, description=r"found reviews. you can get more results by using the depth parameter when setting a task")
