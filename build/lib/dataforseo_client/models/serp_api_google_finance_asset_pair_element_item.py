...
class SerpApiGoogleFinanceAssetPairElementItem(BaseSerpApiGoogleFinanceTickerSearchElementItem):
    """
    ...
    base_symbol: Optional[StrictStr] = Field(default=None, description=r"identifier of the base asset in a pair. example: EUR")
    quote_symbol: Optional[StrictStr] = Field(default=None, description=r"identifier of the quote asset in a pair. example: USD")
    base_display_name: Optional[StrictStr] = Field(default=None, description=r"full name of the base asset in a pair. example: Euro")
    quote_display_name: Optional[StrictStr] = Field(default=None, description=r"full name of the base asset in a pair. example: Euro")
    price: Optional[StrictFloat] = Field(default=None, description=r"value of the base asset compared to the quote asset")
    price_delta: Optional[StrictFloat] = Field(default=None, description=r"change in price. change in price at a given timestamp")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        _dict['base_symbol'] = self.base_symbol
        _dict['quote_symbol'] = self.quote_symbol
        _dict['base_display_name'] = self.base_display_name
        _dict['quote_display_name'] = self.quote_display_name
