...
class DataforseoLabsGoogleHistoricalRankOverviewLiveRequestInfo(BaseModel):
    ...
    date_from: Optional[StrictStr] = Field(default=None, description=r"starting date of the time range. optional field. if you don’t specify this field, the data will be provided for the previous 6 months. minimal possible value: 2020-10-01. date format: 'yyyy-mm-dd'")
    ...
    ignore_synonyms: Optional[StrictBool] = Field(default=None, description=r"ignore highly similar keywords. optional field. if set to true, only data based on core keywords will be returned, data for all highly similar keywords will be excluded;. default value: false")
