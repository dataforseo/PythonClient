...
class AppDataAppleAppSearchesTaskGetAdvancedResultInfo(BaseModel):
    ...
    """ # noqa: E501
    keyword: Optional[StrictStr] = Field(default=None, description=r"keyword received in a POST request")
    ...
    check_url: Optional[StrictStr] = Field(default=None, description=r"direct URL to search engine results. in this case, the value will be null")
    ...
    items_count: Optional[StrictInt] = Field(default=None, description=r"the number of items in the results array")
    items: Optional[List[Optional[AppStoreSearchOrganic]]] = Field(default=None, description=r"found apps")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [AppStoreSearchOrganic.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
        })
