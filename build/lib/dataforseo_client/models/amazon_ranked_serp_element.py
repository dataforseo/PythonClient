...
class AmazonRankedSerpElement(BaseModel):
    ...
    last_updated_time: Optional[StrictStr] = Field(default=None, description=r"date and time when SERP data was last updated. in the UTC format: “yyyy-mm-dd hh-mm-ss +00:00”. example:. 2019-11-15 12:57:46 +00:00")
