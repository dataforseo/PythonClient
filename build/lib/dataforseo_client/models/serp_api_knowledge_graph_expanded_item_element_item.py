...
class SerpApiKnowledgeGraphExpandedItemElementItem(BaseSerpApiKnowledgeGraphElementItem):
    """
    ...
    expanded_element: Optional[List[Optional[KnowledgeGraphExpandedElement]]] = Field(default=None, description=r"link of the element")
