...
class DataforseoLabsAppleAppIntersectionLiveResultInfo(BaseModel):
    ...
    app_ids: Optional[Dict[str, Optional[StrictStr]]] = Field(default=None, description=r"ids of the apps in a POST array")
    ...
    items: Optional[List[Optional[DataforseoLabsAppleAppIntersectionLiveItem]]] = Field(default=None, description=r"contains data related to the ranking keywords for the app specified in the app_id field")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [DataforseoLabsAppleAppIntersectionLiveItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
        })
