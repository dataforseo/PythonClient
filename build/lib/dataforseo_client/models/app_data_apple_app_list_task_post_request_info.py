...
class AppDataAppleAppListTaskPostRequestInfo(BaseModel):
    ...
    """ # noqa: E501
    app_collection: Optional[StrictStr] = Field(default=None, description=r"app collection. required field. app collection on App Store from which apps will be collected;. you can specify the following values:. top_free_ios, top_paid_ios, top_grossing_ios, new_ios, new_free_ios, new_paid_ios")
    ...
    depth: Optional[StrictInt] = Field(default=None, description=r"parsing depth. optional field. number of apps to be returned from the App Store SERP;. we strongly recommend setting the parsing depth in the multiples of 100, because our system processes 100 results in a row;. default value: 100. maximum value: 1000. Your account will be billed per each SERP containing up to 100 results;. Setting depth above 100 may result in additional charges if the search engine returns more than 100 results;. The cost can be calculated on the Pricing page.")
    app_category: Optional[StrictStr] = Field(default=None, description=r"application category on the App Store. optional field. you can filter the results by app category;. example:. lifestyle;. you can review the full list of available categories here or by making a separate request to https://api.dataforseo.com/v3/app_data/apple/categories")
