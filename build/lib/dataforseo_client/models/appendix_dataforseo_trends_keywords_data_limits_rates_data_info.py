...
class AppendixDataforseoTrendsKeywordsDataLimitsRatesDataInfo(BaseModel):
    ...
    subregion_interests: Optional[AppendixInfo] = Field(default=None, description=r"")
    demography: Optional[AppendixInfo] = Field(default=None, description=r"")
    merged_data: Optional[AppendixInfo] = Field(default=None, description=r"")
