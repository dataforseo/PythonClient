...
class SerpGoogleDatasetSearchTaskPostRequestInfo(BaseModel):
    ...
    language_code: Optional[StrictStr] = Field(default=None, description=r"search engine language code. optional field. possible value:. en")
    ...
    postback_data: Optional[StrictStr] = Field(default=None, description=r"postback_url datatype. required field if you specify postback_url. corresponds to the datatype that will be sent to your server. only value: advanced")
