...
class AppendixMerchantGoogleInfo(BaseModel):
    ...
    """ # noqa: E501
    products: Optional[AppendixSerpDaysRatesDataInfo] = Field(default=None, description=r"")
    sellers: Optional[AppendixSellersGoogleMerchantLimitsRatesDataInfo] = Field(default=None, description=r"")
    product_spec: Optional[AppendixSerpDaysRatesDataInfo] = Field(default=None, description=r"")
    product_info: Optional[AppendixSerpDaysRatesDataInfo] = Field(default=None, description=r"")
