...
class OnPageImageLinkItem(BaseOnPageLinkItem):
    """
    OnPageImageLinkItem
    """ # noqa: E501
    ...
    link_attribute: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"link attribute added to external link. indicates link attributes added to the link_to on the page_from. example:. ['ugc','noopener']")
    text: Optional[StrictStr] = Field(default=None, description=r"anchor text")
    image_alt: Optional[StrictStr] = Field(default=None, description=r"alternative text for the image")
    image_src: Optional[StrictStr] = Field(default=None, description=r"url of the image")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        _dict['link_attribute'] = self.link_attribute
        _dict['text'] = self.text
        _dict['image_alt'] = self.image_alt
        _dict['image_src'] = self.image_src
        return _dict
