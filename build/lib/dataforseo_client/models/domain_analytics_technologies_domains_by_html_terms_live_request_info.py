...
class DomainAnalyticsTechnologiesDomainsByHtmlTermsLiveRequestInfo(BaseModel):
    ...
    """ # noqa: E501
    search_terms: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"target search terms. required field. specify target HTML elements, tags, attributes, their content or all of the above. if you specify more than one search term, you will receive only the domains containing all of the specified terms in the HTML code of their homepage. maximum number of search terms you can specify: 10. example:. ['data-attrid']")
    keywords: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"target keywords in the domain’s title, description or meta keywords. optional field. UTF-8 encoding. maximum number of keywords you can specify: 10. example:. ['seo','software']. learn more about rules and limitations of keyword and keywords fields in DataForSEO APIs in this Help Center article")
