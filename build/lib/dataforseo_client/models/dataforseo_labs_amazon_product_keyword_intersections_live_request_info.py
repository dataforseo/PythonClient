...
class DataforseoLabsAmazonProductKeywordIntersectionsLiveRequestInfo(BaseModel):
    ...
    intersection_mode: Optional[StrictStr] = Field(default=None, description=r"mode for finding asin intersections. optional field. possible values: union, intersect;. default value: intersect;. learn more about the parameter in this help center guide")
