...
class DataforseoLabsGoogleTopSearchesLiveRequestInfo(BaseModel):
    ...
    limit: Optional[StrictInt] = Field(default=None, description=r"the maximum number of returned keywords. optional field. note: you can get more than 1000 results by using the offset_token provided in the response to each subsequent request. default value: 1000. maximum value: 1000")
