...
class AppendixDataforseoLabsPriceData(BaseModel):
    ...
    """ # noqa: E501
    app_competitors: Optional[AppendixBingKeywordsDataPriceDataInfo] = Field(default=None, description=r"")
    app_intersection: Optional[AppendixBingKeywordsDataPriceDataInfo] = Field(default=None, description=r"")
    bulk_app_metrics: Optional[AppendixBingKeywordsDataPriceDataInfo] = Field(default=None, description=r"")
    bulk_keyword_difficulty: Optional[AppendixBingKeywordsDataPriceDataInfo] = Field(default=None, description=r"")
    bulk_search_volume: Optional[AppendixBingKeywordsDataPriceDataInfo] = Field(default=None, description=r"")
    bulk_traffic_estimation: Optional[AppendixBingKeywordsDataPriceDataInfo] = Field(default=None, description=r"")
    ...
    domain_whois_overview: Optional[AppendixBingKeywordsDataPriceDataInfo] = Field(default=None, description=r"")
    ...
    keywords_for_categories: Optional[AppendixBingKeywordsDataPriceDataInfo] = Field(default=None, description=r"")
    keywords_for_site: Optional[AppendixBingKeywordsDataPriceDataInfo] = Field(default=None, description=r"")
    keyword_suggestions: Optional[AppendixBingKeywordsDataPriceDataInfo] = Field(default=None, description=r"")
    ...
    product_competitors: Optional[AppendixBingKeywordsDataPriceDataInfo] = Field(default=None, description=r"")
    product_keyword_intersections: Optional[AppendixBingKeywordsDataPriceDataInfo] = Field(default=None, description=r"")
    product_rank_overview: Optional[AppendixBingKeywordsDataPriceDataInfo] = Field(default=None, description=r"")
    ranked_keywords: Optional[AppendixBingKeywordsDataPriceDataInfo] = Field(default=None, description=r"")
    related_keywords: Optional[AppendixBingKeywordsDataPriceDataInfo] = Field(default=None, description=r"")
    relevant_pages: Optional[AppendixBingKeywordsDataPriceDataInfo] = Field(default=None, description=r"")
    search_intent: Optional[AppendixBingKeywordsDataPriceDataInfo] = Field(default=None, description=r"")
    serp_competitors: Optional[AppendixBingKeywordsDataPriceDataInfo] = Field(default=None, description=r"")
    subdomains: Optional[AppendixBingKeywordsDataPriceDataInfo] = Field(default=None, description=r"")
    top_searches: Optional[AppendixBingKeywordsDataPriceDataInfo] = Field(default=None, description=r"")
