...
class SerpGoogleFinanceExploreLiveHtmlRequestInfo(BaseModel):
    ...
    news_type: Optional[StrictStr] = Field(default=None, description=r"financial news filters. optional field. possible values: top_stories, local_market, world_markets. default value: top_stories")
