...
class DataforseoLabsBingBulkTrafficEstimationLiveItem(BaseModel):
    """
    ...
    metrics: Optional[Dict[str, Optional[BulkMetricsInfo]]] = Field(default=None, description=r"traffic data relevant to the specified domain")
