...
class SerpGoogleJobsTaskPostRequestInfo(BaseModel):
    ...
    employment_type: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"employment contract type. optional field. type of employment contract for which the search results will be returned;. possible values:. fulltime, partime, contractor, intern")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        _dict['location_radius'] = self.location_radius
        _dict['language_name'] = self.language_name
        _dict['language_code'] = self.language_code
        _dict['depth'] = self.depth
        _dict['employment_type'] = self.employment_type
        _dict['tag'] = self.tag
