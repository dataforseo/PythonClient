...
class OnPageContentParsingLiveRequestInfo(BaseModel):
    ...
    store_raw_html: Optional[StrictBool] = Field(default=None, description=r"store HTML of a crawled page. optional field. set to true if you want to get the HTML of the page using the OnPage Raw HTML endpoint. default value: false")
