...
from dataforseo_client.models.ai_optimization_claude_llm_responses_models_result_info import AiOptimizationClaudeLlmResponsesModelsResultInfo
from dataforseo_client.models.base_response_task_info import BaseResponseTaskInfo



class AiOptimizationClaudeLlmResponsesModelsTaskInfo(BaseModel):
    """
    ...
    result: Optional[List[Optional[AiOptimizationClaudeLlmResponsesModelsResultInfo]]] = Field(default=None, description=r"array of results")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "path": obj.get("path"),
            "data": obj.get("data"),
            "result": [AiOptimizationClaudeLlmResponsesModelsResultInfo.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None,
        })
