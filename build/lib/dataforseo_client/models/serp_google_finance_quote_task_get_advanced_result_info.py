...
class SerpGoogleFinanceQuoteTaskGetAdvancedResultInfo(BaseModel):
    """
    ...
    items: Optional[List[Optional[BaseSerpApiGoogleFinanceElementItem]]] = Field(default=None, description=r"market indexes related to the market trends element")
