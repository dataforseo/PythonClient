...
from dataforseo_client.models.ai_optimization_ai_keyword_data_available_filters_result_info import AiOptimizationAiKeywordDataAvailableFiltersResultInfo
from dataforseo_client.models.base_response_task_info import BaseResponseTaskInfo



class AiOptimizationAiKeywordDataAvailableFiltersTaskInfo(BaseModel):
    """
    ...
    result: Optional[List[Optional[AiOptimizationAiKeywordDataAvailableFiltersResultInfo]]] = Field(default=None, description=r"")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "path": obj.get("path"),
            "data": obj.get("data"),
            "result": [AiOptimizationAiKeywordDataAvailableFiltersResultInfo.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None,
        })
