...
class AppDataGoogleAppReviewsTasksReadyResultInfo(BaseModel):
    ...
    endpoint_advanced: Optional[StrictStr] = Field(default=None, description=r"URL for collecting the results of the Google App Reviews task")
    endpoint_html: Optional[StrictStr] = Field(default=None, description=r"URL for collecting the results of the Google App Reviews HTML task. if HTML tasks are not supported in the specified endpoint, the value will be null")
