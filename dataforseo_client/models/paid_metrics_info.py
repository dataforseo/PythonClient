...
class PaidMetricsInfo(BaseModel):
    """
    PaidMetricsInfo
    """ # noqa: E501
    ...
    pos_1: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="number of paid SERPs where the domain ranks #1")
    pos_2_3: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="number of paid SERPs where the domain ranks #2-3")
    pos_4_10: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="number of paid SERPs where the domain ranks #4-10")
    pos_11_20: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="number of paid SERPs where the domain ranks #11-20")
    pos_21_30: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="number of paid SERPs where the domain ranks #21-30")
    pos_31_40: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="number of paid SERPs where the domain ranks #31-40")
    pos_41_50: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="number of paid SERPs where the domain ranks #41-50")
    pos_51_60: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="number of paid SERPs where the domain ranks #51-60")
    pos_61_70: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="number of paid SERPs where the domain ranks #61-70")
    pos_71_80: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="number of paid SERPs where the domain ranks #71-80")
    pos_81_90: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="number of paid SERPs where the domain ranks #81-90")
    pos_91_100: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="number of paid SERPs where the domain ranks #91-100")
    ...
    count: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="total count of paid SERPs that contain the domain")
    estimated_paid_traffic_cost: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="estimated cost of monthly search traffic represents the estimated cost of paid monthly traffic (USD) based on etv and cpc values learn more about how the metric is calculated in this help center article")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PaidMetricsInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PaidMetricsInfo from a dict"""
        if obj is None:
            return None
