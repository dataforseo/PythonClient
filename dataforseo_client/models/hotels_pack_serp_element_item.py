...
class HotelsPackSerpElementItem(BaseSerpApiElementItem):
    """
    ...
    items: Optional[List[Optional[HotelsPackElement]]] = Field(default=None, description="contains arrays of specific images")
