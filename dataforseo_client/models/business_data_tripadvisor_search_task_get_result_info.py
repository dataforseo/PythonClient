...
class BusinessDataTripadvisorSearchTaskGetResultInfo(BaseModel):
    ...
    items: Optional[List[Optional[TripadvisorSearchOrganic]]] = Field(default=None, description="Tripadvisor search listing results. you can get more results by using the depth parameter when setting a task")
