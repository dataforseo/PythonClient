...
class SerpApiMapsSearchElementItem(BaseSerpApiGoogleMapsElementItem):
    ...
    snippet: Optional[StrictStr] = Field(default=None, description=r"*element snippet*. contains the address and other information about the local establishment featured in the element")
    address: Optional[StrictStr] = Field(default=None, description=r"*address line*. address of the local establishment featured in the element")
    address_info: Optional[AddressInfo] = Field(default=None, description=r"*object containing address components of the local establishment*")
    place_id: Optional[StrictStr] = Field(default=None, description=r"*unique place identifier*. [place id](https://developers.google.com/places/place-id) of the local establishment featured in the element")
    phone: Optional[StrictStr] = Field(default=None, description=r"*phone number*. phone number of the local establishment featured in the element")
    ...
    cid: Optional[StrictStr] = Field(default=None, description=r"*google-defined client id*. unique id of a local establishment;. can be used with [Google Reviews API](/v3/reviews/google/overview/?php) to get a full list of reviews")
    ...
    is_claimed: Optional[StrictBool] = Field(default=None, description=r"*indicates whether ownership of this local establishment is claimed*")
    local_justifications: Optional[List[Optional[LocalJustificationInfo]]] = Field(default=None, description=r"*Google local justifications*. snippets of text that 'justify' why the business is showing up for search query")
    is_directory_item: Optional[StrictBool] = Field(default=None, description=r"*indicates whether this local establishment is a directory*")
