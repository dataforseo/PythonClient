...
class DataforseoLabsAmazonRankedKeywordsLiveItem(BaseModel):
    ...
    ranked_serp_element: Optional[AmazonRankedSerpElement] = Field(default=None, description="contains data on the products’s SERP element found for the returned keyword")
