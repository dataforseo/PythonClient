...
class DataLabsEventsSerpElementItem(BaseDataforseoLabsApiElementItem):
    """
    ...
    items: Optional[List[Optional[EventsElement]]] = Field(default=None, description="elements of search results found in SERP")
