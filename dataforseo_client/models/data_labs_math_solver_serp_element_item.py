...
class DataLabsMathSolverSerpElementItem(BaseDataforseoLabsApiElementItem):
    """
    ...
    items: Optional[List[Optional[MathSolverElement]]] = Field(default=None, description="elements of search results found in SERP")
