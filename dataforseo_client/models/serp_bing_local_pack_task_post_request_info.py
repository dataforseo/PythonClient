...
class SerpBingLocalPackTaskPostRequestInfo(BaseModel):
    ...
    depth: Optional[StrictInt] = Field(default=None, description=r"parsing depth. optional field. number of results in SERP. default value: 5. max value: 200. Your account will be billed per each SERP containing up to 5 results;. Setting depth above 5 may result in additional charges if the search engine returns more than 5 results;. The cost can be calculated on the Pricing page.")
