...
class SerpApiGoogleFinanceNewsElementItem(BaseSerpApiGoogleFinanceElementItem):
    """
    ...
    items: Optional[List[Optional[GoogleFinanceNewsElement]]] = Field(default=None, description="market indexes data. array of items containing market indexes data;. possible type of items: google_finance_asset_pair_element, google_finance_market_instrument_element, google_finance_market_index_element")
