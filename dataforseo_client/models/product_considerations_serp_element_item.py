...
class ProductConsiderationsSerpElementItem(BaseSerpApiElementItem):
    """
    ...
    items: Optional[List[Optional[ProductConsiderationsElement]]] = Field(default=None, description=r"contains arrays of elements available in the list")
