...
class SerpGoogleAiModeTaskGetAdvancedTaskInfo(BaseModel):
    ...
    result: Optional[List[SerpGoogleAiModeTaskGetAdvancedResultInfo]] = Field(default=None, description="array of results")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SerpGoogleAiModeTaskGetAdvancedTaskInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SerpGoogleAiModeTaskGetAdvancedTaskInfo from a dict"""
        if obj is None:
            return None
