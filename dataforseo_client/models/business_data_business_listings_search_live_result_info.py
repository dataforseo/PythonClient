...
class BusinessDataBusinessListingsSearchLiveResultInfo(BaseModel):
    ...
    items: Optional[List[Optional[BusinessDataBusinessListingsSearchLiveItem]]] = Field(default=None, description="encountered item types. types of search engine results encountered in the items array;. possible item types: business_listing")
