...
class MerchantGoogleProductsTaskGetAdvancedResultInfo(BaseModel):
    ...
    item_types: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"*types of search results found in Google Shopping SERP*. contains types of all search results (`items`) found in the returned SERP. possible item types:. `google_shopping_sponsored_carousel`, `google_shopping_paid`, `google_shopping_serp`, `google_shopping_carousel`, `related_searches`")
