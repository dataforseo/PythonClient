...
class MerchantGoogleProductsTaskGetAdvancedResultInfo(BaseModel):
    ...
    check_url: Optional[StrictStr] = Field(default=None, description=r"direct URL to Google Shopping resultsyou can use it to make sure that we provided accurate results")
    ...
    item_types: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"types of search results found in Google Shopping SERPcontains types of all search results (items) found in the returned SERPpossible item types:google_shopping_sponsored_carousel, google_shopping_paid, google_shopping_serp, google_shopping_carousel, related_searches")
    items_count: Optional[StrictInt] = Field(default=None, description=r"the number of results returned in the items array")
    items: Optional[List[Optional[BaseMerchantGoogleShoppingProductsElementItem]]] = Field(default=None, description=r"additional items present in the elementcontains a list of related keywords;if there are none, equals null")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [BaseMerchantGoogleShoppingProductsElementItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
        })
