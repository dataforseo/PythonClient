...
class MerchantGoogleProductsTaskGetAdvancedResultInfo(BaseModel):
    ...
    items: Optional[List[Optional[BaseMerchantGoogleShoppingProductsElementItem]]] = Field(default=None, description="additional items present in the element. contains a list of related keywords;. if there are none, equals null")
