...
class MerchantAmazonAsinLiveHtmlRequestInfo(BaseModel):
    ...
    """ # noqa: E501
    asin: Optional[StrictStr] = Field(default=None, description=r"product ID. required field. unique product identifier (ASIN) in Amazon. you can receive the asin parameter by making a separate request to the Amazon Products endpoint")
