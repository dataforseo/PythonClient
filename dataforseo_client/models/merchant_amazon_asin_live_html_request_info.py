...
class MerchantAmazonAsinLiveHtmlRequestInfo(BaseModel):
    """
    MerchantAmazonAsinLiveHtmlRequestInfo
    """ # noqa: E501
    asin: Optional[StrictStr] = Field(default=None, description=r"product IDrequired fieldunique product identifier (ASIN) in Amazonyou can receive the asin parameter by making a separate request to the Amazon Products endpoint")
