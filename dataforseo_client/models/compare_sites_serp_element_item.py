...
class CompareSitesSerpElementItem(BaseSerpApiElementItem):
    """
    ...
    items: Optional[List[Optional[CompareSitesElement]]] = Field(default=None, description=r"contains arrays of elements available in the list")
