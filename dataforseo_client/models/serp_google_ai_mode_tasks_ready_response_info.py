...
class SerpGoogleAiModeTasksReadyResponseInfo(BaseModel):
    ...
    tasks: Optional[List[SerpGoogleAiModeTasksReadyTaskInfo]] = Field(default=None, description="array of tasks")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SerpGoogleAiModeTasksReadyResponseInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SerpGoogleAiModeTasksReadyResponseInfo from a dict"""
        if obj is None:
            return None
