...
class RefineProductsSerpElementItem(BaseSerpApiElementItem):
    """
    ...
    items: Optional[List[Optional[RefineProductsElement]]] = Field(default=None, description=r"contains arrays of elements available in the list")
