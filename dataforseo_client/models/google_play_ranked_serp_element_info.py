...
from dataforseo_client.models.google_play_search_organic import GooglePlaySearchOrganic



class GooglePlayRankedSerpElementInfo(BaseModel):
    """
    GooglePlayRankedSerpElementInfo
    """ # noqa: E501
    se_type: Optional[StrictStr] = Field(default=None, description="search engine type")
    serp_item: Optional[GooglePlaySearchOrganic] = Field(default=None, description="contains data on the SERP element. the list of supported SERP elements can be found below")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "serp_item": GooglePlaySearchOrganic.from_dict(obj["serp_item"]) if obj.get("serp_item") is not None else None,
