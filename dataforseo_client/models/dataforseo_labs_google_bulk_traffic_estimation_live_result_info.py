...
class DataforseoLabsGoogleBulkTrafficEstimationLiveResultInfo(BaseModel):
    ...
    items: Optional[List[DataforseoLabsGoogleBulkTrafficEstimationLiveItem]] = Field(default=None, description="array of items with relevant traffic estimation data")
