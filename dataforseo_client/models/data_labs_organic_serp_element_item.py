...
class DataLabsOrganicSerpElementItem(BaseDataforseoLabsApiElementItem):
    ...
    etv: Optional[StrictFloat] = Field(default=None, description=r"estimated traffic volume. estimated organic monthly traffic to the domain or webpage;. calculated as the product of CTR (click-through-rate) and search volume values of all keywords the domain or webpage rank for;. learn more about how the metric is calculated in this help center article")
    estimated_paid_traffic_cost: Optional[StrictFloat] = Field(default=None, description=r"estimated cost of converting organic search traffic into paid. represents the estimated monthly cost of running ads for all keywords that a domain or webpage ranks for;. the metric is calculated as the product of organic etv and paid cpc values and indicates the cost of driving the estimated volume of monthly organic traffic through PPC advertising in Google Search;. learn more about how the metric is calculated in this help center article")
