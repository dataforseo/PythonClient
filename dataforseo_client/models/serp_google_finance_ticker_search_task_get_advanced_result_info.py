...
class SerpGoogleFinanceTickerSearchTaskGetAdvancedResultInfo(BaseModel):
    ...
    items: Optional[List[BaseGoogleFinanceTickerSearchSerpElementItem]] = Field(default=None, description="items of search results found in SERP array of items containing market indexes data; possible type of items: google_finance_market_index, google_finance_asset_pair, google_finance_market_instrument")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [BaseGoogleFinanceTickerSearchSerpElementItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
