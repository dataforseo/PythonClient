...
class SerpBingOrganicLiveRegularResultInfo(BaseModel):
    ...
    items: Optional[List[Optional[BaseSerpApiElementItem]]] = Field(default=None, description="items inside the element. array of 8 search queries related to the keyword")
