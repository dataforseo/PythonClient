...
class ContentAnalysisPhraseTrendsLiveResultInfo(BaseModel):
    ...
    top_domains: Optional[List[TopDomainCountInfo]] = Field(default=None, description="top domains citing the target keyword contains objects with top domains citing the target keyword and citation count per each domain")
