...
class BacklinksSummaryLiveResultInfo(BaseModel):
    ...
    rank: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="target rank learn more about the metric and how it is calculated in this help center article")
    backlinks: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="indicates the number of backlinks")
    backlinks_spam_score: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="spam score of the backlinks displays the total spam score of all backlinks pointing to the target domain, subdomain, or webpage; to learn more about how the metric is calculated, refer to this Help Center page")
    ...
    referring_main_domains: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="indicates the number of referring main domains")
