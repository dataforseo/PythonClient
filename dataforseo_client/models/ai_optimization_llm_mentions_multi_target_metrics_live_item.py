...
class AiOptimizationLlmMentionsMultiTargetMetricsLiveItem(BaseModel):
    """
    AiOptimizationLlmMentionsMultiTargetMetricsLiveItem
    """ # noqa: E501
    key: Optional[StrictStr] = Field(default=None, description=r"*grouping key*. the specific identifier for the group dimension")
