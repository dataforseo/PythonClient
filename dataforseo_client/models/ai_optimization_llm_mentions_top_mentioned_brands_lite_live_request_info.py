...
class AiOptimizationLlmMentionsTopMentionedBrandsLiteLiveRequestInfo(BaseModel):
    """
    AiOptimizationLlmMentionsTopMentionedBrandsLiteLiveRequestInfo
    """ # noqa: E501
    ...
    include_brands: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"*array of brands to include in the response*. optional field. if specified, only the listed brands will be returned in the `items` array. example:. `['BMW','Audi']`")
    exclude_brands: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"*array of brands to exclude from the response*. optional field. if specified, the listed brands will be omitted from the `items` array. example:. `['BMW','Audi']`")
