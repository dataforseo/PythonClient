...
class KeywordsDataDataforseoTrendsExploreLiveResultInfo(BaseModel):
    ...
    items: Optional[List[Optional[DataforseoTrendsDataforseoTrendsGraphElementItem]]] = Field(default=None, description="contains keyword popularity and related data")
