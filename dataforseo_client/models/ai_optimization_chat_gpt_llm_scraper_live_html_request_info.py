...
class AiOptimizationChatGptLlmScraperLiveHtmlRequestInfo(BaseModel):
    ...
    expand_citations: Optional[StrictBool] = Field(default=None, description=r"return expanded citation bar in HTML resultsoptional fieldto enable this parameter, force_web_search must also be enabled;when enabled, the endpoint will return HTML data from the expanded citation bar;default value: false")
