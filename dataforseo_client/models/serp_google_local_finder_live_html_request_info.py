...
class SerpGoogleLocalFinderLiveHtmlRequestInfo(BaseModel):
    ...
    min_rating: Optional[StrictStr] = Field(default=None, description=r"filter results by minimum ratingoptional fieldpossible values for desktop: 3.5, 4, 4.5;possible values for mobile: 2, 2.5, 3, 3.5, 4, 4.5")
