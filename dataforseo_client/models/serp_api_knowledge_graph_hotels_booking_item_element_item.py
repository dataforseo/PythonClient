...
class SerpApiKnowledgeGraphHotelsBookingItemElementItem(BaseSerpApiKnowledgeGraphElementItem):
    ...
    items: Optional[List[Optional[KnowledgeGraphHotelsBookingElement]]] = Field(default=None, description="additional items present in the element. if there are none, equals null")
