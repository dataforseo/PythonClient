...
class SerpYoutubeOrganicLiveAdvancedResultInfo(BaseModel):
    """
    ...
    item_types: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"types of search results in SERP. contains types of search results (items) found in SERP.. possible item types:. youtube_channel, youtube_video, youtube_video_paid, youtube_playlist")
    ...
    items: Optional[List[Optional[BaseSerpApiYoutubeOrganicElementItem]]] = Field(default=None, description=r"elements of search results found in SERP")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [BaseSerpApiYoutubeOrganicElementItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
        })
