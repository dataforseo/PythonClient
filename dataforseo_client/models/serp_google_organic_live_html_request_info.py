...
class SerpGoogleOrganicLiveHtmlRequestInfo(BaseModel):
    ...
    expand_ai_overview: Optional[StrictBool] = Field(default=None, description=r"expand ai overviewoptional fieldset to true to expand the ai_overview item;default value: false")
