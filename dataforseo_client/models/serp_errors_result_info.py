...
class SerpErrorsResultInfo(BaseModel):
    ...
    error_code: Optional[StrictInt] = Field(default=None, description=r"*error code of the task*. error code of the task generated by DataForSEO. [see full list of error codes](https://docs.dataforseo.com/v3/appendix/errors/)")
    error_message: Optional[StrictStr] = Field(default=None, description=r"*error message or error URL*. error message generated by DataForSEO, or URL that caused an error. [see full list of error messages](https://docs.dataforseo.com/v3/appendix/errors/)")
    ...
    http_method: Optional[StrictStr] = Field(default=None, description=r"*HTTP method that caused an error*")
