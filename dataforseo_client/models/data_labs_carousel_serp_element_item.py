...
from dataforseo_client.models.dataforseo_labs_carousel_element import DataforseoLabsCarouselElement
from dataforseo_client.models.base_dataforseo_labs_api_element_item import BaseDataforseoLabsApiElementItem



class DataLabsCarouselSerpElementItem(BaseDataforseoLabsApiElementItem):
    """
    ...
    items: Optional[List[Optional[DataforseoLabsCarouselElement]]] = Field(default=None, description=r"historical SERPs and related data found in the database")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "xpath": obj.get("xpath"),
            "title": obj.get("title"),
            "items": [DataforseoLabsCarouselElement.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
        })
