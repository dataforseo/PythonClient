...
class DomainAnalyticsTechnologiesTechnologiesSummaryLiveRequestInfo(BaseModel):
    ...
    keywords: Optional[List[StrictStr]] = Field(default=None, description="target keywords in the domain’s title, description or meta keywords optional field UTF-8 encoding example: [\"seo\",\"software\"]")
