...
class ScholarlyArticlesSerpElementItem(BaseSerpApiElementItem):
    """
    ...
    items: Optional[List[Optional[ScholarlyArticlesElement]]] = Field(default=None, description=r"contains arrays of elements available in the list")
