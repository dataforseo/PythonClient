...
class DataforseoLabsGoogleBulkTrafficEstimationLiveRequestInfo(BaseModel):
    ...
    ignore_synonyms: Optional[StrictBool] = Field(default=None, description=r"*ignore highly similar keywords*. optional field. if set to_`true`, only core keywords will be returned, all highly similar keywords will be excluded;  . default value: `false`")
