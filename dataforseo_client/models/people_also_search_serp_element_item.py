...
class PeopleAlsoSearchSerpElementItem(BaseSerpApiElementItem):
    """
    ...
    items: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"contains arrays of elements available in the list")
