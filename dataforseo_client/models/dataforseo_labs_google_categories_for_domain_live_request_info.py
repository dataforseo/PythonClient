...
class DataforseoLabsGoogleCategoriesForDomainLiveRequestInfo(BaseModel):
    ...
    """ # noqa: E501
    target: Optional[StrictStr] = Field(default=None, description=r"*domain or subdomain*. **required field**. the domain or subdomain name of the target website. the domain or subdomain should be specified without `https://` and `www.`")
    ...
    include_subcategories: Optional[StrictBool] = Field(default=None, description=r"*indicates if the subcategories will be included in the search*. optional field. if set to `false`, the subcategories will be ignored. default value: `false`. learn more about the parameter in this [help center article](https://dataforseo.com/help-center/include_subcategories-in-categories-for-domain-endpoint)")
    include_clickstream_data: Optional[StrictBool] = Field(default=None, description=r"*include or exclude data from clickstream-based metrics in the result*. optional field. if the parameter is set to_`true`, you will receive `clickstream_etv`, `clickstream_gender_distribution`, and_`clickstream_age_distribution`_fields with clickstream data in the response. default value: `false`. with this parameter enabled, you will be charged double the price for the request. learn more about how clickstream-based metrics are calculated in this [help center article](https://dataforseo.com/help-center/what-are-clickstream-based-metrics-and-how-do-we-calculate-them)n")
    ...
    limit: Optional[StrictInt] = Field(default=None, description=r"*the maximum number of returned categories*. optional field. default value: `100`. maximum value: `1000`")
    offset: Optional[StrictInt] = Field(default=None, description=r"*offset in the results array of returned categories*. optional field. default value: `0`. if you specify the `10` value, the first ten categories in the results array will be omitted and the data will be provided for the successive categories")
