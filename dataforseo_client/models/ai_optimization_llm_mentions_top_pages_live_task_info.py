...
from dataforseo_client.models.ai_optimization_llm_mentions_top_pages_live_result_info import AiOptimizationLlmMentionsTopPagesLiveResultInfo
from dataforseo_client.models.base_response_task_info import BaseResponseTaskInfo



class AiOptimizationLlmMentionsTopPagesLiveTaskInfo(BaseModel):
    """
    ...
    result: Optional[List[Optional[AiOptimizationLlmMentionsTopPagesLiveResultInfo]]] = Field(default=None, description=r"array of results")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "path": obj.get("path"),
            "data": obj.get("data"),
            "result": [AiOptimizationLlmMentionsTopPagesLiveResultInfo.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None,
        })
