...
class KeywordsDataDataforseoTrendsExploreLiveRequestInfo(BaseModel):
    ...
    """ # noqa: E501
    keywords: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"*keywords*. **required field**. the maximum number of keywords you can specify: 5. learn more about rules and limitations of `keyword` and `keywords` fields in DataForSEO APIs in this [Help Center article](https://dataforseo.com/help-center/rules-and-limitations-of-keyword-and-keywords-fields-in-dataforseo-apis)")
