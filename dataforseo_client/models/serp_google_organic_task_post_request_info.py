...
class SerpGoogleOrganicTaskPostRequestInfo(BaseModel):
    ...
    remove_from_url: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"remove specific parameters from URLsoptional fieldusing this field, you can specify up to 10 parameters to remove from URLs in the resultexample:'remove_from_url': ['srsltid']")
    expand_ai_overview: Optional[StrictBool] = Field(default=None, description=r"expand ai overviewoptional fieldset to true to expand the ai_overview item;default value: false;Note: this parameter applies only to HTML task results")
