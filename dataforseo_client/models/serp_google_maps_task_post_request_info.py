...
class SerpGoogleMapsTaskPostRequestInfo(BaseModel):
    ...
    device: Optional[StrictStr] = Field(default=None, description=r"device type. optional field. can take the values:desktop, mobile. default value: desktop. note: for mobile device, only 20 results are returned for every SERP")
    ...
    search_this_area: Optional[StrictBool] = Field(default=None, description=r"show results from the displayed area. optional field. can take the values:true, false. default value: trueif set to false, the search_this_area mode will be turned off. Note: if the search_this_area mode is turned off, Google Maps listings might contain results beyond the displayed area")
