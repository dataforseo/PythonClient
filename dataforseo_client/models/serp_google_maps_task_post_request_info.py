...
class SerpGoogleMapsTaskPostRequestInfo(BaseModel):
    ...
    search_this_area: Optional[StrictBool] = Field(default=None, description=r"[popup_img text='search this area' width='751' height='524' src='https://docs_v3.dataforseo.com/wp-content/uploads/2020/10/search_this_area_751x524-1.png']. optional field. can take the values:true, false. default value: trueif set to false, the search_this_area mode will be turned off. Note: if the search_this_area mode is turned off, Google Maps listings might contain results beyond the displayed area")
