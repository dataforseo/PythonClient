...
class KeywordsDataBingSearchVolumeLiveResultInfo(BaseModel):
    ...
    search_volume: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="monthly average search volume rate search volume is rounded to the nearest tens")
