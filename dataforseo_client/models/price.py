...
class Price(BaseModel):
    ...
    Price
    """ # noqa: E501
    current: Optional[StrictFloat] = Field(default=None, description=r"current price. indicates the current price of the product or service featured in the result")
    regular: Optional[StrictFloat] = Field(default=None, description=r"regular price. indicates the regular price of the product or service with no discounts applied")
    max_value: Optional[StrictFloat] = Field(default=None, description=r"the maximum price. the maximum price of the product or service as indicated in the result")
