...
class SerpGoogleNewsLiveAdvancedResultInfo(BaseModel):
    ...
    includes_non_news_search_results: Optional[StrictBool] = Field(default=None, description=r"")
    ...
    items: Optional[List[Optional[BaseSerpApiGoogleNewsElementItem]]] = Field(default=None, description=r"")
