...
class AmazonInfo(BaseModel):
    ...
    rank_absolute: Optional[StrictInt] = Field(default=None, description=r"absolute rank in Amazon SERP. absolute position among all the elements in SERP")
    position: Optional[StrictStr] = Field(default=None, description=r"the alignment of the element in Amazon SERP. can take the following values:. left, right")
