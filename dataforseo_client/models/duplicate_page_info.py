...
class DuplicatePageInfo(BaseModel):
    ...
    DuplicatePageInfo
    """ # noqa: E501
    similarity: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="content similarity score by default, the content is considered duplicate if the value is greater than or equals 6 can take values from 0 to 10")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DuplicatePageInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DuplicatePageInfo from a dict"""
        if obj is None:
            return None
