...
from dataforseo_client.models.merchant_amazon_products_live_html_result_info import MerchantAmazonProductsLiveHtmlResultInfo
from dataforseo_client.models.base_response_task_info import BaseResponseTaskInfo



class MerchantAmazonProductsLiveHtmlTaskInfo(BaseModel):
    """
    ...
    result: Optional[List[Optional[MerchantAmazonProductsLiveHtmlResultInfo]]] = Field(default=None, description=r"array of results")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "path": obj.get("path"),
            "data": obj.get("data"),
            "result": [MerchantAmazonProductsLiveHtmlResultInfo.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None,
        })
