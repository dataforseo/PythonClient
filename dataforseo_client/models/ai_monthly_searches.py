...
class AiMonthlySearches(BaseModel):
    """
    AiMonthlySearches
    """ # noqa: E501
    year: Optional[StrictInt] = Field(default=None, description="year")
    month: Optional[StrictInt] = Field(default=None, description="month")
    ai_search_volume: Optional[StrictInt] = Field(default=None, description="AI search volume rate in a certain month of a year")
