...
class DataforseoLabsRelevantPagesLiveItem(BaseModel):
    ...
    metrics: Optional[Dict[str, Optional[DataforseoLabsMetricsInfo]]] = Field(default=None, description="rankings and traffic metrics for the relevant page")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        _dict['page_address'] = self.page_address
