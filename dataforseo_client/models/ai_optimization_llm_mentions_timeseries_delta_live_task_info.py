...
from dataforseo_client.models.ai_optimization_llm_mentions_timeseries_delta_live_result_info import AiOptimizationLlmMentionsTimeseriesDeltaLiveResultInfo
from dataforseo_client.models.base_response_task_info import BaseResponseTaskInfo



class AiOptimizationLlmMentionsTimeseriesDeltaLiveTaskInfo(BaseModel):
    """
    ...
    result: Optional[List[Optional[AiOptimizationLlmMentionsTimeseriesDeltaLiveResultInfo]]] = Field(default=None, description=r"*array of results*")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "path": obj.get("path"),
            "data": obj.get("data"),
            "result": [AiOptimizationLlmMentionsTimeseriesDeltaLiveResultInfo.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None,
        })
