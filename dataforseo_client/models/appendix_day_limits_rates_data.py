...
class AppendixDayLimitsRatesData(BaseModel):
    ...
    """ # noqa: E501
    serp: Optional[AppendixSerpDaysRatesDataInfo] = Field(default=None, description="")
    ...
    keywords_data: Optional[AppendixKeywordsDataDaysRatesDataInfo] = Field(default=None, description="")
    total_keywords_data: Optional[StrictFloat] = Field(default=None, description="")
    appendix: Optional[AppendixAppendixDaysRatesDataInfo] = Field(default=None, description="")
