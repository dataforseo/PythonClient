...
class AiOptimizationLlmMentionsTopMentionedBrandCategoriesLiveItem(BaseModel):
    """
    AiOptimizationLlmMentionsTopMentionedBrandCategoriesLiveItem
    """ # noqa: E501
    brand_category: Optional[StrictStr] = Field(default=None, description=r"brand category. brand category found in LLM mentions for the specified target")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        _dict['brand_category'] = self.brand_category
        location_items = []
        if self.location:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "brand_category": obj.get("brand_category"),
