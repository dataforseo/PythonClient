...
class MerchantRelatedSearchesSerpElementItem(BaseMerchantAmazonElementItem):
    """
    ...
    items: Optional[List[Optional[RelatedSearchesElement]]] = Field(default=None, description="Amazon product items")
