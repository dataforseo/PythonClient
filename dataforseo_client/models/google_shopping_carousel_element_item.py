...
from dataforseo_client.models.google_shopping_carousel_element import GoogleShoppingCarouselElement
...
class GoogleShoppingCarouselElementItem(BaseMerchantGoogleShoppingProductsElementItem):
    """
    ...
    title: Optional[StrictStr] = Field(default=None, description=r"title of the special offer")
    items: Optional[List[Optional[GoogleShoppingCarouselElement]]] = Field(default=None, description=r"additional items present in the element. if there are none, equals null")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "xpath": obj.get("xpath"),
            "title": obj.get("title"),
            "items": [GoogleShoppingCarouselElement.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
        })
