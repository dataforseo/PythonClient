...
class GoogleShoppingCarouselElementItem(BaseMerchantGoogleShoppingProductsElementItem):
    ...
    items: Optional[List[Optional[GoogleShoppingCarouselElement]]] = Field(default=None, description=r"additional items present in the elementif there are none, equals null")
