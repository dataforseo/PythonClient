...
class DataforseoLabsLocationsAndLanguagesResultInfo(BaseModel):
    ...
    location_code_parent: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="the code of the superordinate location the value will be null as Country is the only supported location_type for this API")
