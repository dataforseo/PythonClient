...
class DataforseoLabsGoogleKeywordsForCategoriesLiveRequestInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["category_codes", "location_name", "location_code", "language_name", "language_code", "category_intersection", "include_serp_info", "ignore_synonyms", "limit", "offset", "offset_token", "filters", "order_by", "tag"]
