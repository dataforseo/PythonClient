...
class DataforseoLabsGoogleKeywordsForCategoriesLiveRequestInfo(BaseModel):
    ...
    """ # noqa: E501
    category_codes: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"*product and service categories*. **required field**. The maximum number of categories you can specify: 20. you can download [the full list of possible categories](https://cdn.dataforseo.com/v3/categories/categories_dataforseo_labs_2023_10_25.csv)")
