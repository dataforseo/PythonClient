...
class LocalServicesSerpElementItem(BaseSerpApiElementItem):
    """
    ...
    items: Optional[List[Optional[LocalServicesElement]]] = Field(default=None, description=r"contains arrays of elements available in the list")
