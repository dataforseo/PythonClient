...
class BusinessDataGoogleExtendedReviewsTaskPostRequestInfo(BaseModel):
    ...
    depth: Optional[StrictInt] = Field(default=None, description="parsing depth. optional field. number of reviews in SERP. we strongly recommend setting the parsing depth in the multiples of twenty, because our systems processes twenty reviews in a row. default value: 20. maximum value: 1000")
