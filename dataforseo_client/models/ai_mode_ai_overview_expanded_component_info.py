...
class AiModeAiOverviewExpandedComponentInfo(BaseModel):
    """
    ...
    links: Optional[List[Optional[AiModeLinkElementInfo]]] = Field(default=None, description="sitelinks. the links shown below some of Google’s search results. if there are none, equals null")
