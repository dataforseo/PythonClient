...
class KeywordsDataBingKeywordsForSiteLiveRequestInfo(BaseModel):
    ...
    """ # noqa: E501
    target: Optional[StrictStr] = Field(default=None, description=r"domain or URL. required field. the domain name or URL of the target website")
    ...
    device: Optional[StrictStr] = Field(default=None, description=r"device type. optional field. specify this field if you want to get the data for a particular device typepossible values: all, mobile, desktop, tablet. default value: all")
