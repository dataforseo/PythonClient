...
class KeywordsDataBingKeywordsForSiteTaskGetResultInfo(BaseModel):
    ...
    cpc: Optional[StrictFloat] = Field(default=None, description="cost-per-click. represents the average cost per click (USD) historically paid for the keyword.. if there is no data the value is null")
