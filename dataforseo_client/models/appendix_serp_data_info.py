...
class AppendixSerpDataInfo(BaseModel):
    ...
    tasks_ready_queue: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["task_post", "task_get", "tasks_ready", "locations", "languages", "live", "errors", "tasks_fixed", "jobs", "screenshot", "tasks_ready_queue"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if tasks_ready_queue (nullable) is None
        # and model_fields_set contains the field
        if self.tasks_ready_queue is None and "tasks_ready_queue" in self.model_fields_set:
            _dict['tasks_ready_queue'] = None
