...
class DataforseoLabsGoogleRelevantPagesLiveRequestInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["target", "location_name", "location_code", "language_name", "language_code", "item_types", "include_clickstream_data", "limit", "offset", "historical_serp_mode", "ignore_synonyms", "filters", "order_by", "tag"]
