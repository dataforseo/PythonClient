...
class BingCarouselSerpElementItem(BaseBingSerpApiElementItem):
    """
    ...
    items: Optional[List[Optional[SerpApiCarouselElement]]] = Field(default=None, description=r"additional items present in the element. if there are none, equals null")
