...
class DataforseoLabsGoogleAppIntersectionLiveResultInfo(BaseModel):
    ...
    items: Optional[List[Optional[DataforseoLabsGoogleAppIntersectionLiveItem]]] = Field(default=None, description="contains data related to the ranking keywords for the app specified in the app_id field")
