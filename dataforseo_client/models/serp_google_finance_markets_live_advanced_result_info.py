...
class SerpGoogleFinanceMarketsLiveAdvancedResultInfo(BaseModel):
    ...
    spell: Optional[SpellInfo] = Field(default=None, description="autocorrection of the search engine. if the search engine provided results for a keyword that was corrected, we will specify the keyword corrected by the search engine and the type of autocorrection;. in this case, the value will be null")
    ...
    items: Optional[List[Optional[BaseSerpApiGoogleFinanceElementItem]]] = Field(default=None, description="market indexes related to the market trends element. possible type of items: google_finance_asset_pair_element, google_finance_market_instrument_element, google_finance_market_index_element")
