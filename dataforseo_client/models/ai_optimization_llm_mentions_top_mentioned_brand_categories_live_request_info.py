...
class AiOptimizationLlmMentionsTopMentionedBrandCategoriesLiveRequestInfo(BaseModel):
    """
    ...
    include_brand_categories: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"*array of brand_categories to include in the response*. optional field. if specified, only the listed brand categories will be returned in the `items` array. example:. `'include_brand_categories': ['business']`")
    exclude_brand_categories: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"*array of brand categories to exclude from the response*. optional field. if specified, the listed brand categories will be omitted from the `items` array. example:. `'exclude_brand_categories': ['business']`")
