...
class DataLabsPeopleAlsoSearchSerpElementItem(BaseDataforseoLabsApiElementItem):
    """
    ...
    items: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"historical SERPs and related data found in the database")
