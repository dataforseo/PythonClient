...
from dataforseo_client.models.ai_optimization_llm_mentions_timeseries_delta_live_item import AiOptimizationLlmMentionsTimeseriesDeltaLiveItem



class AiOptimizationLlmMentionsTimeseriesDeltaLiveResultInfo(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [AiOptimizationLlmMentionsTimeseriesDeltaLiveItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
        })
