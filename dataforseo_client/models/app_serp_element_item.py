...
class AppSerpElementItem(BaseSerpApiElementItem):
    """
    AppSerpElementItem
    """ # noqa: E501
    ...
    items: Optional[List[Optional[AppElement]]] = Field(default=None, description=r"contains arrays of elements available in the list")
