...
class OnPageMicrodataRequestInfo(BaseModel):
    ...
    url: Optional[StrictStr] = Field(default=None, description=r"*resource URL*. **required field**. you can get this URL in the response of the [Pages](/v3/on_page/pages/) endpoint. example:. `https://dataforseo.com/apis`")
