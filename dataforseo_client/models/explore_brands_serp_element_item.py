...
class ExploreBrandsSerpElementItem(BaseSerpApiElementItem):
    """
    ...
    items: Optional[List[Optional[ExploreBrandsElement]]] = Field(default=None, description=r"contains arrays of elements available in the list")
