...
class DataforseoLabsGoogleKeywordIdeasLiveResultInfo(BaseModel):
    ...
    total_count: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="total number of results relevant to your request in our database")
    items_count: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="number of results returned in the items array")
