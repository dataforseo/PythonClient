...
class DataforseoLabsGoogleKeywordIdeasLiveResultInfo(BaseModel):
    ...
    seed_keywords: Optional[List[Optional[StrictStr]]] = Field(default=None, description="keywords in a POST array keywords are returned with decoded %## (plus symbol ‘+’ will be decoded to a space character)")
