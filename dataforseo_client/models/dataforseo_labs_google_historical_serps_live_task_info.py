...
class DataforseoLabsGoogleHistoricalSerpsLiveTaskInfo(BaseModel):
    ...
    result: Optional[List[Optional[DataforseoLabsGoogleHistoricalSerpsLiveResultInfo]]] = Field(default=None, description="array of results. the array includes objects with SERPs for each month within the specified time frame")
