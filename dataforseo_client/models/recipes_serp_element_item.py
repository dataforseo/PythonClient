...
class RecipesSerpElementItem(BaseSerpApiElementItem):
    """
    ...
    items: Optional[List[Optional[RecipesElement]]] = Field(default=None, description=r"contains arrays of elements available in the list")
