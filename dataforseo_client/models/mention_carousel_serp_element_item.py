...
class MentionCarouselSerpElementItem(BaseSerpApiElementItem):
    """
    ...
    items: Optional[List[Optional[MentionCarouselElement]]] = Field(default=None, description=r"contains arrays of elements available in the list")
