...
if TYPE_CHECKING:
    ...
    from dataforseo_client.models.serp_api_bing_people_also_ask_ai_overview_expanded_element_item import SerpApiBingPeopleAlsoAskAiOverviewExpandedElementItem;
...
class BaseSerpApiBingPeopleAlsoAskExpandedElementItem(BaseModel):
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        ...
        'people_also_ask_ai_overview_expanded_element': 'SerpApiBingPeopleAlsoAskAiOverviewExpandedElementItem',
    }
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[
        ...
        if object_type == 'SerpApiBingPeopleAlsoAskAiOverviewExpandedElementItem':
            return import_module("dataforseo_client.models.serp_api_bing_people_also_ask_ai_overview_expanded_element_item").SerpApiBingPeopleAlsoAskAiOverviewExpandedElementItem.from_dict(obj)
