...
class DataforseoLabsAmazonProductCompetitorsLiveResultInfo(BaseModel):
    ...
    items: Optional[List[Optional[DataforseoLabsAmazonProductCompetitorsLiveItem]]] = Field(default=None, description="contains detected Amazon product competitors and related data")
