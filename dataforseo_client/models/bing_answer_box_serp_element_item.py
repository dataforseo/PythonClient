...
class BingAnswerBoxSerpElementItem(BaseBingSerpApiElementItem):
    """
    ...
    links: Optional[List[Optional[LinkElement]]] = Field(default=None, description=r"links featured in the organic result")
