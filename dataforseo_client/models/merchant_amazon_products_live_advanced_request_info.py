...
class MerchantAmazonProductsLiveAdvancedRequestInfo(BaseModel):
    """
    ...
    se_domain: Optional[StrictStr] = Field(default=None, description=r"search engine domainoptional fieldwe choose the relevant search engine domain automatically according to the location and language you specifyhowever, you can set a custom search engine domain in this fieldexample:amazon.com, amazon.co.uk, amazon.fr, etc.")
    ...
    max_crawl_pages: Optional[StrictInt] = Field(default=None, description=r"page crawl limitoptional fieldnumber of search results pages to crawlmax value: 7Note: the max_crawl_pages and depth parameters complement each other;learn more at our help center")
    department: Optional[StrictStr] = Field(default=None, description=r"amazon product departmentoptional fieldspecify one of the following amazon departments for extracting product listings:'Arts & Crafts', 'Automotive', 'Baby', 'Beauty & Personal Care', 'Books', 'Computers', 'Digital Music', 'Electronics', 'Kindle Store', 'Prime Video', 'Women's Fashion', 'Men's Fashion', 'Girls' Fashion', 'Boys' Fashion', 'Deals', 'Health & Household', 'Home & Kitchen', 'Industrial & Scientific', 'Luggage', 'Movies & TV', 'Music, CDs & Vinyl', 'Pet Supplies', 'Software', 'Sports & Outdoors', 'Tools & Home Improvement', 'Toys & Games', 'Video Games'")
    search_param: Optional[StrictStr] = Field(default=None, description=r"additional parameters of the search queryoptional fieldyou can use the following Amazon search URL parameters for customizing the searchexample:&low-price=52 - search for products that cost more than 52 USD;&high-price=45 - search for products that cost less than 45 USD;&sort=relevancerank - sort results by relevance;&sort=featured-rank - sort results by featured products;&sort=price-asc-rank - sort by ascending price;&sort=price-desc-rank - sort by descending price;&sort=review-rank - sort by the average customer reviews value;&sort=date-desc-rank - sort by the newest arrivalNote that search_param values will be ignored if any of the following parameters is used: price_min, price_max, sort_by")
    price_min: Optional[StrictInt] = Field(default=None, description=r"minimum product priceoptional fieldminimum price of the returned products listed on Amazon for the specified queryexample:5Note: if you specify price_min, the search_param parameter will be ignored")
    price_max: Optional[StrictInt] = Field(default=None, description=r"maximum product priceoptional fieldmaximum price of the returned products listed on Amazon for the specified queryexample:100Note: if you specify price_max, the search_param parameter will be ignored")
    sort_by: Optional[StrictStr] = Field(default=None, description=r"results sorting rulesoptional fieldthe following sorting rules are supported:relevance, price_low_to_high, price_high_to_low, featured, avg_customer_review, newest_arrivalexample:sort_by:'relevance'Note: if you specify sort_by, the search_param parameter will be ignored")
