...
class MerchantAmazonProductsLiveAdvancedRequestInfo(BaseModel):
    ...
    depth: Optional[StrictInt] = Field(default=None, description=r"parsing depth. optional field. number of results to be retrieved from the Amazon results page. default value: 100. max value: 700. Your account will be billed per each SERP containing up to 100 results; . Setting depth above 100 may result in additional charges if the search engine returns more than 100 results;. The cost can be calculated on the Pricing page.")
    ...
    price_min: Optional[StrictInt] = Field(default=None, description=r"minimum product price. optional field. minimum price of the returned products listed on Amazon for the specified query. example:. 5. Note: if you specify price_min, the search_param parameter will be ignored")
    price_max: Optional[StrictInt] = Field(default=None, description=r"maximum product price. optional field. maximum price of the returned products listed on Amazon for the specified query. example:. 100. Note: if you specify price_max, the search_param parameter will be ignored")
    sort_by: Optional[StrictStr] = Field(default=None, description=r"results sorting rules. optional field. the following sorting rules are supported:. relevance, price_low_to_high, price_high_to_low, featured, avg_customer_review, newest_arrival. example:. sort_by:'relevance'. Note: if you specify sort_by, the search_param parameter will be ignored")
