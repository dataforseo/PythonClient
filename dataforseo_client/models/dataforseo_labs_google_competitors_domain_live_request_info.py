...
class DataforseoLabsGoogleCompetitorsDomainLiveRequestInfo(BaseModel):
    ...
    """ # noqa: E501
    target: Optional[StrictStr] = Field(default=None, description=r"*domain*. **required field**. the domain name of the target website. the domain should be specified without `https://` and `www.`. you can specify page URL, but the results will be specific to the domain in the specified URL")
