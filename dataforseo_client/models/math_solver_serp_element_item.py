...
class MathSolverSerpElementItem(BaseSerpApiElementItem):
    """
    ...
    items: Optional[List[Optional[MathSolverElement]]] = Field(default=None, description=r"contains arrays of elements available in the list")
