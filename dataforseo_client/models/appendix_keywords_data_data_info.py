...
class AppendixKeywordsDataDataInfo(BaseModel):
    ...
    naver: Optional[AppendixNaverKeywordsDataDataInfo] = Field(default=None, description="")
    google: Optional[AppendixBingKeywordsDataLimitsRatesDataInfo] = Field(default=None, description="")
    keyword_ideas_ads_api: Optional[AppendixSerpDaysRatesDataInfo] = Field(default=None, description="")
