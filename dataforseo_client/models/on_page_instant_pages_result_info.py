...
class OnPageInstantPagesResultInfo(BaseModel):
    ...
    crawl_status: Optional[CrawlStatusInfo] = Field(default=None, description="details of the crawling session. in this case the value will be null")
    ...
    items: Optional[List[Optional[OnPageStylesheetResourceItem]]] = Field(default=None, description="items array")
