...
class BacklinksPageIntersection(BaseModel):
    ...
    backlink_spam_score: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="spam score of the backlink learn more about how the metric is calculated on this help center page")
    ...
    page_from_external_links: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="number of external links found on the referring page")
    page_from_internal_links: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="number of internal links found on the referring page")
    page_from_size: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="size of the referring page, in bytes example: 63357")
    ...
    page_from_status_code: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="HTTP status code returned by the referring page example: 200")
    ...
    links_count: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="number of identical backlinks found on the referring page")
    group_count: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="indicates total number of backlinks from this domain for example, if mode is set to one_per_domain, this field will indicate the total number of backlinks coming from this domain")
    ...
    url_to_status_code: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="status code of the referenced page if the value is null, our crawler hasn’t yet visited the webpage the link is pointing to example: 200")
    url_to_spam_score: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="spam score of the referenced page if the value is null, our crawler hasn’t yet visited the webpage the link is pointing to learn more about how the metric is calculated on this help center page")
    ...
    indirect_link_path: Optional[List[BacklinksRedirectInfo]] = Field(default=None, description="indirect link path indicates a URL or a sequence of URLs that lead to url_to")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BacklinksPageIntersection from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BacklinksPageIntersection from a dict"""
        if obj is None:
            return None
