...
class KeywordsDataDataforseoTrendsMergedDataLiveResultInfo(BaseModel):
    ...
    items: Optional[List[Optional[BaseKeywordDataDataforseoTrendsItem]]] = Field(default=None, description="keyword popularity values per location. values in this array represent percentages relative to the maximum value within each region")
