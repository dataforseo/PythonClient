...
class AiOptimizationLlmMentionsTopMentionedPagesLiveItem(BaseModel):
    """
    AiOptimizationLlmMentionsTopMentionedPagesLiveItem
    """ # noqa: E501
    page: Optional[StrictStr] = Field(default=None, description=r"*URL of a found page*. the URL of a page found in LLM mentions for the specified target")
