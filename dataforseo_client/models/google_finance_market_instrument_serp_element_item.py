...
class GoogleFinanceMarketInstrumentSerpElementItem(BaseGoogleFinanceTickerSearchSerpElementItem):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "rank_group", "rank_absolute", "identifier", "displayed_name", "url", "location", "trend", "timestamp", "percentage_delta", "ticker", "price", "price_delta", "price_currency"]
