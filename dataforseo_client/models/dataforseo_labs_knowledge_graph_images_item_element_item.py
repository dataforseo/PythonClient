...
class DataforseoLabsKnowledgeGraphImagesItemElementItem(BaseDataforseoLabsKnowledgeGraphElementItem):
    """
    ...
    items: Optional[List[Optional[KnowledgeGraphImagesElement]]] = Field(default=None, description="additional items present in the element. if there are none, equals null")
