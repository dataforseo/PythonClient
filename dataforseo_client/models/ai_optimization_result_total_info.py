...
class AiOptimizationResultTotalInfo(BaseModel):
    """
    ...
    sources_domain: Optional[List[Optional[GroupElement]]] = Field(default=None, description=r"found source domains relevant to the targetarray of objects containing data on top domains that are cited as sources in LLM responseslearn more about the sources and how to retrieve LLM citation data at our Help Center")
