...
class DataforseoLabsGoogleCategoriesForDomainLiveResultInfo(BaseModel):
    ...
    items: Optional[List[Optional[DataforseoLabsGoogleCategoriesForDomainLiveItem]]] = Field(default=None, description="contains relevant categories and related ranking data")
