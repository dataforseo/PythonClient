...
from dataforseo_client.models.ai_optimization_llm_mentions_search_mentions_live_result_info import AiOptimizationLlmMentionsSearchMentionsLiveResultInfo
from dataforseo_client.models.base_response_task_info import BaseResponseTaskInfo



class AiOptimizationLlmMentionsSearchMentionsLiveTaskInfo(BaseModel):
    """
    ...
    result: Optional[List[Optional[AiOptimizationLlmMentionsSearchMentionsLiveResultInfo]]] = Field(default=None, description=r"array of results")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "path": obj.get("path"),
            "data": obj.get("data"),
            "result": [AiOptimizationLlmMentionsSearchMentionsLiveResultInfo.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None,
        })
