...
class PeopleAlsoAskElement(BaseModel):
    ...
    expanded_element: Optional[List[Optional[BaseSerpApiPeopleAlsoAskExpandedElementItem]]] = Field(default=None, description="expanded element")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        _dict['seed_question'] = self.seed_question
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "xpath": obj.get("xpath"),
            "expanded_element": [BaseSerpApiPeopleAlsoAskExpandedElementItem.from_dict(_item) for _item in obj["expanded_element"]] if obj.get("expanded_element") is not None else None,
        })
