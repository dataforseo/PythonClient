...
class StocksBoxSerpElementItem(BaseSerpApiElementItem):
    """
    ...
    source: Optional[StrictStr] = Field(default=None, description=r"source of the element. indicates the source of information included in the recipes_element")
    ...
    domain: Optional[StrictStr] = Field(default=None, description=r"domain of the website hosting the video")
