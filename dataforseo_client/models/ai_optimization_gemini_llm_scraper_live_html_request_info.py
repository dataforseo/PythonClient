...
class AiOptimizationGeminiLlmScraperLiveHtmlRequestInfo(BaseModel):
    ...
    expand_citations: Optional[StrictBool] = Field(default=None, description=r"return expanded citation bar in HTML results. optional field. when enabled, the endpoint will return HTML data from the expanded citation bar;. default value: false")
