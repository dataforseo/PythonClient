...
class Info(BaseModel):
    ...
    Info
    """ # noqa: E501
    hour: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="hours in the 24-hour format")
    minute: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="minutes")
