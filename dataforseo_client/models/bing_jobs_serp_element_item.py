...
class BingJobsSerpElementItem(BaseBingSerpApiElementItem):
    """
    ...
    items: Optional[List[Optional[JobsElement]]] = Field(default=None, description=r"additional items present in the element. if there are none, equals null")
