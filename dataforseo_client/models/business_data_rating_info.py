...
class BusinessDataRatingInfo(BaseModel):
    """
    ...
    votes_count: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="the amount of feedback")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BusinessDataRatingInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BusinessDataRatingInfo from a dict"""
        if obj is None:
            return None
