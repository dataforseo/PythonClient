...
class CarouselSerpElementItem(BaseSerpApiElementItem):
    """
    ...
    items: Optional[List[Optional[SerpApiCarouselElement]]] = Field(default=None, description=r"contains arrays of elements available in the list")
