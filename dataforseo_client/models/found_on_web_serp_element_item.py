...
class FoundOnWebSerpElementItem(BaseSerpApiElementItem):
    """
    ...
    items: Optional[List[Optional[FoundOnWebElement]]] = Field(default=None, description=r"contains arrays of elements available in the list")
