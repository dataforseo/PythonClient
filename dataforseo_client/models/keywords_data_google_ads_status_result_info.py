...
class KeywordsDataGoogleAdsStatusResultInfo(BaseModel):
    ...
    last_year_in_monthly_searches: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="the latest year for which search volume data is available")
    last_month_in_monthly_searches: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="the latest month for which search volume data is available")
