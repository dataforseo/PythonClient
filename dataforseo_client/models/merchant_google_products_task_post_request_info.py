...
class MerchantGoogleProductsTaskPostRequestInfo(BaseModel):
    ...
    depth: Optional[StrictInt] = Field(default=None, description=r"parsing depth. optional field. number of results to be retrieved from the Google Shopping results page. default value: 40. max value: 120. Your account will be billed per each SERP containing up to 40 results;. Setting depth above 40 may result in additional charges if the search engine returns more than 40 results;. The cost can be calculated on the Pricing page.")
    max_crawl_pages: Optional[StrictInt] = Field(default=None, description=r"page crawl limit. optional field. number of search results pages to crawl. max value: 7. Note: the max_crawl_pages and depth parameters complement each other;. learn more at our help center")
    ...
    price_min: Optional[StrictInt] = Field(default=None, description=r"minimum product price. optional field. minimum price of the returned products listed on Google Shopping for the specified query. example:. 5. Note: if you specify price_min, the search_param parameter will be ignored")
    price_max: Optional[StrictInt] = Field(default=None, description=r"maximum product price. optional field. maximum price of the returned products listed on Google Shopping for the specified query. example:. 100. Note: if you specify price_max, the search_param parameter will be ignored")
    sort_by: Optional[StrictStr] = Field(default=None, description=r"results sorting rules. optional field. the following sorting rules are supported:. review_score, price_low_to_high, price_high_to_low. example:. sort_by:'review_score'. Note: if you specify sort_by, the search_param parameter will be ignored")
