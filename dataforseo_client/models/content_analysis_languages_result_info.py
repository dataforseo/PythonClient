...
class ContentAnalysisLanguagesResultInfo(BaseModel):
    ...
    """ # noqa: E501
    location_code: Optional[StrictInt] = Field(default=None, description="")
    location_name: Optional[StrictStr] = Field(default=None, description="")
    location_code_parent: Optional[StrictInt] = Field(default=None, description="")
    country_iso_code: Optional[StrictStr] = Field(default=None, description="")
    location_type: Optional[StrictStr] = Field(default=None, description="")
