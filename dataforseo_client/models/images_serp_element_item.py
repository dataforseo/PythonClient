...
class ImagesSerpElementItem(BaseSerpApiElementItem):
    """
    ...
    related_image_searches: Optional[List[Optional[RelatedImageSearchesElement]]] = Field(default=None, description=r"*contains keywords and images related to the specified search term*. **Note:** this array is deprecated and always returns `null`", deprecated=True)
