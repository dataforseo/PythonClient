...
class DataforseoLabsGoogleDomainRankOverviewLiveRequestInfo(BaseModel):
    ...
    """ # noqa: E501
    target: Optional[StrictStr] = Field(default=None, description=r"*domain*. **required field**. the domain name of the target website. the domain should be specified without `https://` and `www.`")
    ...
    ignore_synonyms: Optional[StrictBool] = Field(default=None, description=r"*ignore highly similar keywords*. optional field. if set to_`true`, all highly similar keywords will be excluded from the ranking and traffic calculations, the results will be based on data for main keywords from groups of synonyms. default value: `false`n")
    limit: Optional[StrictInt] = Field(default=None, description=r"*the maximum number of returned results for domain*. optional field. default value: `100`. maximum value: `1000`")
