...
class SerpGoogleAiModeTaskGetHtmlResultInfo(BaseModel):
    ...
    items: Optional[List[SerpHtmlItemInfo]] = Field(default=None, description="elements of search results found in SERP")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SerpGoogleAiModeTaskGetHtmlResultInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SerpGoogleAiModeTaskGetHtmlResultInfo from a dict"""
        if obj is None:
            return None
