...
class OnPageRedirectResourceElementItem(BaseOnPageResourceItemInfo):
    """
    OnPageRedirectResourceElementItem
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["resource_type", "status_code", "location", "url", "resource_errors", "size", "encoded_size", "total_transfer_size", "fetch_time", "cache_control", "checks", "content_encoding", "media_type", "server", "last_modified", "fetch_timing", "is_resource"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OnPageRedirectResourceElementItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OnPageRedirectResourceElementItem from a dict"""
        if obj is None:
            return None
