...
class WorkHours(BaseModel):
    ...
    WorkHours
    """ # noqa: E501
    timetable: Optional[Dict[str, Optional[List[Optional[WorkDayInfo]]]]] = Field(default=None, description="work hours timetable")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        _dict['timetable'] = self.timetable
        _dict['current_status'] = self.current_status
        return _dict
