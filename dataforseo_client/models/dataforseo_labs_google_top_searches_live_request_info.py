...
class DataforseoLabsGoogleTopSearchesLiveRequestInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["location_name", "location_code", "language_name", "language_code", "include_serp_info", "ignore_synonyms", "filters", "order_by", "tag", "limit", "offset", "offset_token"]
