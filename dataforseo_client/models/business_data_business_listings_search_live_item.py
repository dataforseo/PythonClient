...
class BusinessDataBusinessListingsSearchLiveItem(BaseModel):
    ...
    hotel_rating: Optional[StrictInt] = Field(default=None, description=r"*hotel class rating*. class ratings range between 1-5 stars, [learn more](https://support.google.com/business/answer/7660515?hl=en). if there is no hotel class rating information, the value will be `null`")
    ...
    contact_info: Optional[List[Optional[BusinessDataContactInfo]]] = Field(default=None, description=r"*available contacts of the business*. list of contacts to interact with the business")
