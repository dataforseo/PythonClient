...
class AppDataGoogleAppListingsSearchLiveItem(BaseModel):
    ...
    item: Optional[GooglePlayInfoOrganic] = Field(default=None, description="detailed information about the app")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "item": GooglePlayInfoOrganic.from_dict(obj["item"]) if obj.get("item") is not None else None,
        })
