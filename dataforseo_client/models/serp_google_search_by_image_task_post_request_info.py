...
class SerpGoogleSearchByImageTaskPostRequestInfo(BaseModel):
    ...
    """ # noqa: E501
    image_url: Optional[StrictStr] = Field(default=None, description=r"URL of the imagerequired fieldthe results will be based on the image you specified in this fieldexample:https://upload.wikimedia.org/wikipedia/commons/e/ed/Elon_Musk_Royal_Society.jpg")
