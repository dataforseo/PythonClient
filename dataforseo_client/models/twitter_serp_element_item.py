...
class TwitterSerpElementItem(BaseSerpApiElementItem):
    """
    ...
    items: Optional[List[Optional[TwitterElement]]] = Field(default=None, description=r"contains arrays of elements available in the list")
