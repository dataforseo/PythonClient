...
class RankedSerpElementInfo(BaseModel):
    """
    RankedSerpElementInfo
    """ # noqa: E501
    ...
    se_results_count: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="number of search results for the returned keyword")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RankedSerpElementInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RankedSerpElementInfo from a dict"""
        if obj is None:
            return None
