...
class AiOptimizationClaudeLlmResponsesTaskPostRequestInfo(BaseModel):
    ...
    temperature: Optional[StrictFloat] = Field(default=None, description=r"randomness of the AI response. optional field. higher values make output more diverse; . lower values make output more focused;. minimum value: 0. maximum value: 1. default value: 0.7Note: temperature cannot be used together with top_p in the same request")
    top_p: Optional[StrictFloat] = Field(default=None, description=r"diversity of the AI response. optional field . controls diversity of the response by limiting token selection;. minimum value: 0. maximum value: 1 . default value: nullNote: top_p cannot be used together with temperature in the same request")
