...
class AiOptimizationClaudeLlmResponsesTaskPostRequestInfo(BaseModel):
    ...
    temperature: Optional[StrictFloat] = Field(default=None, description=r"*randomness of the AI response*. optional field. higher values make output more diverse; . lower values make output more focused;. minimum value: `0`. maximum value: `1`. default value: `0.7`. **Note:** `temperature` cannot be used together with `top_p` in the same request")
    top_p: Optional[StrictFloat] = Field(default=None, description=r"*diversity of the AI response*. optional field . controls diversity of the response by limiting token selection;. minimum value: `0`. maximum value: `1` . default value: `null`. **Note:** `top_p` cannot be used together with `temperature` in the same request")
    web_search: Optional[StrictBool] = Field(default=None, description=r"*enable web search for current information*. optional field. when enabled, the AI model can access and cite current web information;. **Note:** refer to the [Models endpoint](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/) for a list of models that support `web_search`; . default value: `false`;. The cost of the parameter can be calculated on the [Pricing](https://docs.anthropic.com/en/docs/about-claude/pricing) page")
    ...
    web_search_country_iso_code: Optional[StrictStr] = Field(default=None, description=r"*ISO country code of the location used for searching the web*. optional field. possible values: `'AR','AT','AU','BE','BR','CA','CH','CL','CN','DE','DK','ES','FI','FR','GB','HK','ID','IN','IT','JP','KR','MX','MY','NL','NO','NZ','PH','PL','PT','RU','SA','SE','TR','TW','US','ZA'`")
    web_search_city: Optional[StrictStr] = Field(default=None, description=r"*city name of the location used for searching the web*. optional field")
