...
class MerchantAmazonAsinLiveAdvancedResultInfo(BaseModel):
    ...
    """ # noqa: E501
    asin: Optional[StrictStr] = Field(default=None, description=r"ASIN received in a POST array. the unique product identifier in Amazon (ASIN) received in a POST array. learn more about the identified in this help center guide")
