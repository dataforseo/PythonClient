...
class MerchantAmazonAsinLiveAdvancedResultInfo(BaseModel):
    ...
    """ # noqa: E501
    asin: Optional[StrictStr] = Field(default=None, description=r"*ASIN received in a POST array*. the unique product identifier in Amazon (ASIN) received in a POST array. learn more about the identified in [this help center guide](https://dataforseo.com/help-center/asin-in-amazon-api)")
    ...
    item_types: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"*types of search results found on Amazon*. contains types of all search results (`items`) found in the returned SERP. possible item types:. `amazon_product_info`")
