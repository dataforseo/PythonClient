...
class AppendixClickstreamDataKeywordsDataLimitsRatesDataInfo(BaseModel):
    ...
    """ # noqa: E501
    dataforseo_search_volume: Optional[AppendixInfo] = Field(default=None, description="")
    ...
    global_search_volume: Optional[AppendixInfo] = Field(default=None, description="")
