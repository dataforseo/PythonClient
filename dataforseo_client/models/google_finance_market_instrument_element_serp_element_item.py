...
class GoogleFinanceMarketInstrumentElementSerpElementItem(BaseGoogleFinanceSerpElementItem):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "ticker", "price", "price_delta", "price_currency", "identifier", "displayed_name", "url", "location", "trend", "timestamp", "percentage_delta"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleFinanceMarketInstrumentElementSerpElementItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleFinanceMarketInstrumentElementSerpElementItem from a dict"""
        if obj is None:
            return None
