...
if TYPE_CHECKING:
    from dataforseo_client.models.serp_api_google_news_news_search_element_item import SerpApiGoogleNewsNewsSearchElementItem;
    from dataforseo_client.models.serp_api_google_news_top_stories_element_item import SerpApiGoogleNewsTopStoriesElementItem;



class BaseSerpApiGoogleNewsElementItem(BaseModel):
    """
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'news_search': 'SerpApiGoogleNewsNewsSearchElementItem',
        'top_stories': 'SerpApiGoogleNewsTopStoriesElementItem',
    }
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[
        ...
        if object_type == 'SerpApiGoogleNewsNewsSearchElementItem':
            return import_module("dataforseo_client.models.serp_api_google_news_news_search_element_item").SerpApiGoogleNewsNewsSearchElementItem.from_dict(obj)
