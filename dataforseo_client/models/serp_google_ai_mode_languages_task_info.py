...
class SerpGoogleAiModeLanguagesTaskInfo(BaseModel):
    ...
    result: Optional[List[SerpGoogleAiModeLanguagesResultInfo]] = Field(default=None, description="array of results")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SerpGoogleAiModeLanguagesTaskInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SerpGoogleAiModeLanguagesTaskInfo from a dict"""
        if obj is None:
            return None
