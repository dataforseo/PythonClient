...
class SerpGoogleOrganicTaskGetRegularResultInfo(BaseModel):
    ...
    """ # noqa: E501
    keyword: Optional[StrictStr] = Field(default=None, description=r"keyword received in a POST arraykeyword is returned with decoded %## (plus symbol '+' will be decoded to a space character)")
    ...
    check_url: Optional[StrictStr] = Field(default=None, description=r"direct URL to search engine resultsyou can use it to make sure that we provided accurate results")
