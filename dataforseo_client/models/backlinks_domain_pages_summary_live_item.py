...
class BacklinksDomainPagesSummaryLiveItem(BaseModel):
    ...
    referring_domains_nofollow: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="number of domains pointing at least one nofollow link to the page")
    ...
    referring_pages_nofollow: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="number of referring pages pointing at least one nofollow link to the page")
