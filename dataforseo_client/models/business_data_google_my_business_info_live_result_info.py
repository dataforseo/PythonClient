...
class BusinessDataGoogleMyBusinessInfoLiveResultInfo(BaseModel):
    ...
    items: Optional[List[Optional[ItemsGoogleBusinessInfo]]] = Field(default=None, description="encountered item types. types of search engine results encountered in the items array;. possible item types: google_business_info")
