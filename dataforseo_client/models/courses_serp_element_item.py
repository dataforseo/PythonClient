...
class CoursesSerpElementItem(BaseSerpApiElementItem):
    """
    ...
    items: Optional[List[Optional[CoursesElement]]] = Field(default=None, description=r"contains arrays of elements available in the list")
