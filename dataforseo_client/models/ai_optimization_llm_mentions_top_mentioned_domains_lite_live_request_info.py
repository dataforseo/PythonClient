...
class AiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo(BaseModel):
    """
    ...
    include_domains: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"*array of domains to include in the response*. optional field. if specified, only the listed domains will be returned in the `items` array. example:. `['dataforseo.com','seoinsider.com']`")
    exclude_domains: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"*array of domains to exclude from the response*. optional field. if specified, the listed domains will be omitted from the `items` array. example:. `['google.com','bing.com']`")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        _dict['include_domains'] = self.include_domains
