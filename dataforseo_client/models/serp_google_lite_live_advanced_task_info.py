...
from dataforseo_client.models.serp_google_lite_live_advanced_result_info import SerpGoogleLiteLiveAdvancedResultInfo
from dataforseo_client.models.base_response_task_info import BaseResponseTaskInfo



class SerpGoogleLiteLiveAdvancedTaskInfo(BaseModel):
    """
    ...
    result: Optional[List[Optional[SerpGoogleLiteLiveAdvancedResultInfo]]] = Field(default=None, description=r"array of results")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "path": obj.get("path"),
            "data": obj.get("data"),
            "result": [SerpGoogleLiteLiveAdvancedResultInfo.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None,
        })
