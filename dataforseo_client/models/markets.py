...
class Markets(BaseModel):
    ...
    Markets
    """ # noqa: E501
    market: Optional[StrictStr] = Field(default=None, description="financial market identifier. possible values: US, Europe, Asia, Currencies, Crypto, Futures")
    items: Optional[List[Optional[BaseSerpApiGoogleFinanceElementItem]]] = Field(default=None, description="elements of search results found in SERP")
