...
class BacklinksBulkPagesSummaryLiveRequestInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["targets", "offset", "internal_list_limit", "backlinks_status_type", "filters", "order_by", "backlinks_filters", "include_subdomains", "include_indirect_links", "exclude_internal_backlinks", "tag"]
