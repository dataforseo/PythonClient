...
class AiOptimizationLlmMentionsTopMentionedPagesLiteLiveRequestInfo(BaseModel):
    """
    ...
    include_pages: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"array of page URLs to include in the response. optional field. if specified, only the listed pages will be returned in the items array. example:. `['https://dataforseo.com/apis/ai-optimization-api/llm-mentions-api', 'https://dataforseo.com/apis/ai-optimization-api']`")
    exclude_pages: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"array of page URLs to exclude from the response. optional field. if specified, the listed pages will be omitted from the items array. example:. `['https://dataforseo.com/apis/ai-optimization-api/llm-mentions-api', 'https://dataforseo.com/apis/ai-optimization-api']`")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        _dict['include_pages'] = self.include_pages
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "include_pages": obj.get("include_pages"),
