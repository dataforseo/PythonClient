...
from dataforseo_client.models.google_finance_futures_chain_markets import GoogleFinanceFuturesChainMarkets
from typing import Optional, Set
from typing_extensions import Self

class GoogleFinanceFuturesChainSerpElementItem(BaseGoogleFinanceSerpElementItem):
    """
    ...
    markets: Optional[List[GoogleFinanceFuturesChainMarkets]] = Field(default=None, description="financial markets data array of items containing market indexes and other financial information related to these indexes")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleFinanceFuturesChainSerpElementItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleFinanceFuturesChainSerpElementItem from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "markets": [GoogleFinanceFuturesChainMarkets.from_dict(_item) for _item in obj["markets"]] if obj.get("markets") is not None else None
        })
        return _obj
