...
class AmazonReviewItem(BaseModel):
    ...
    verified: Optional[StrictBool] = Field(default=None, description=r"indicates whether the review has the “Verified Purchase” mark")
    subtitle: Optional[StrictStr] = Field(default=None, description=r"subtitle of the review")
    helpful_votes: Optional[StrictStr] = Field(default=None, description=r"helpful votes count. number of users who clicked on the ‘Helpful” button under the review text")
    images: Optional[List[Optional[AiModeImagesElementInfo]]] = Field(default=None, description=r"images of the product submitted by the reviewer")
    videos: Optional[List[Optional[VideoElement]]] = Field(default=None, description=r"videos of the product submitted by the reviewer")
    user_profile: Optional[UserProfileInfo] = Field(default=None, description=r"user profile of the reviewer")
