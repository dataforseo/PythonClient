...
class DataforseoLabsGoogleDomainMetricsByCategoriesLiveResultInfo(BaseModel):
    ...
    categories: Optional[List[Optional[StrictInt]]] = Field(default=None, description="categories in a POST array")
    ...
    items: Optional[List[Optional[DataforseoLabsGoogleDomainMetricsByCategoriesLiveItem]]] = Field(default=None, description="contains historical ranking and traffic data")
