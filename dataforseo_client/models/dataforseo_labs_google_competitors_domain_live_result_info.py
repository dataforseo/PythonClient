...
from dataforseo_client.models.dataforseo_labs_google_competitors_domain_live_item import DataforseoLabsGoogleCompetitorsDomainLiveItem
...
class DataforseoLabsGoogleCompetitorsDomainLiveResultInfo(BaseModel):
    ...
    items: Optional[List[Optional[DataforseoLabsGoogleCompetitorsDomainLiveItem]]] = Field(default=None, description=r"contains data related to the target and competitor domains")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [DataforseoLabsGoogleCompetitorsDomainLiveItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
        })
