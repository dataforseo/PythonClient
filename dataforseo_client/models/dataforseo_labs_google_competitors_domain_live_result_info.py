...
class DataforseoLabsGoogleCompetitorsDomainLiveResultInfo(BaseModel):
    ...
    items: Optional[List[Optional[DataforseoLabsCompetitorsDomainLiveItem]]] = Field(default=None, description="contains data related to the target and competitor domains")
