...
class MerchantGoogleProductInfoTaskPostRequestInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["product_id", "data_docid", "priority", "location_name", "location_code", "location_coordinate", "language_name", "language_code", "se_domain", "tag", "postback_url", "postback_data", "pingback_url"]
