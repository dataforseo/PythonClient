...
class KnowledgeGraphHotelsBookingItemSerpElementItem(BaseSerpApiElementItem):
    """
    ...
    items: Optional[List[Optional[KnowledgeGraphHotelsBookingElement]]] = Field(default=None, description=r"contains arrays of elements available in the list")
