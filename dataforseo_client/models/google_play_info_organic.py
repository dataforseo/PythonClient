...
class GooglePlayInfoOrganic(BaseModel):
    ...
    reviews_count: Optional[StrictInt] = Field(default=None, description=r"the total number of reviews the app has")
    ...
    main_category: Optional[StrictStr] = Field(default=None, description=r"main category of the app")
    installs: Optional[StrictStr] = Field(default=None, description=r"number of installs of the app. approximate number of installs as displayed on the app page")
    installs_count: Optional[StrictInt] = Field(default=None, description=r"number of installs of the app. the exact number of installs of the app")
    ...
    developer_email: Optional[StrictStr] = Field(default=None, description=r"email address of the developer")
    developer_address: Optional[StrictStr] = Field(default=None, description=r"physical address of the developer")
    developer_website: Optional[StrictStr] = Field(default=None, description=r"official website of the developer")
    ...
    released_date: Optional[StrictStr] = Field(default=None, description=r"date and time when the app was released. in the UTC format: “yyyy-mm-dd hh-mm-ss +00:00”;. example:. 2019-11-15 12:57:46 +00:00")
    ...
    images: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"app images. contains URLs to the images published on the app page on Google Play")
    videos: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"app videos. contains URLs to the video published on the app page on Google Play")
    ...
    genres: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"app genres. contains relevant app categories")
    tags: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"app tags. contains relevant app tags")
