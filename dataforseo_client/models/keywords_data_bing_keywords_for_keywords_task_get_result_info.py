...
class KeywordsDataBingKeywordsForKeywordsTaskGetResultInfo(BaseModel):
    ...
    search_volume: Optional[StrictInt] = Field(default=None, description=r"*monthly average search volume rate*. represents the (approximate) number of searches for the keyword on the Bing search engine, depending on the user’s targeting. search volume is rounded to the closest decimal values. if there is no data, then the value is_`null`n")
