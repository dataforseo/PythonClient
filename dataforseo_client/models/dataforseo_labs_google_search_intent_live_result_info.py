...
class DataforseoLabsGoogleSearchIntentLiveResultInfo(BaseModel):
    ...
    items: Optional[List[Optional[DataforseoLabsGoogleSearchIntentLiveItem]]] = Field(default=None, description="array of items with relevant traffic estimation data")
