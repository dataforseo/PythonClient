...
from dataforseo_client.models.dataforseo_labs_google_serp_competitors_live_item import DataforseoLabsGoogleSerpCompetitorsLiveItem
...
class DataforseoLabsGoogleSerpCompetitorsLiveResultInfo(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        _dict['seed_keywords'] = self.seed_keywords
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [DataforseoLabsGoogleSerpCompetitorsLiveItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
        })
