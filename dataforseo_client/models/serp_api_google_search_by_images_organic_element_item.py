...
class SerpApiGoogleSearchByImagesOrganicElementItem(BaseSerpApiGoogleSearchByImagesElementItem):
    ...
    faq: Optional[FaqBox] = Field(default=None, description=r"*frequently asked questions*.             questions and answers extension shown below some of Google's search results.             if there are none, equals `null`", deprecated=True)
