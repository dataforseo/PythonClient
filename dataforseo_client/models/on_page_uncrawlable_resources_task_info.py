...
from dataforseo_client.models.on_page_uncrawlable_resources_result_info import OnPageUncrawlableResourcesResultInfo
from dataforseo_client.models.base_response_task_info import BaseResponseTaskInfo



class OnPageUncrawlableResourcesTaskInfo(BaseModel):
    """
    ...
    result: Optional[List[Optional[OnPageUncrawlableResourcesResultInfo]]] = Field(default=None, description=r"*array of results*")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "path": obj.get("path"),
            "data": obj.get("data"),
            "result": [OnPageUncrawlableResourcesResultInfo.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None,
        })
