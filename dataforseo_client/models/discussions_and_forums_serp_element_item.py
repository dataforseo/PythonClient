...
class DiscussionsAndForumsSerpElementItem(BaseSerpApiElementItem):
    """
    ...
    items: Optional[List[Optional[DiscussionsAndForumsElement]]] = Field(default=None, description=r"contains arrays of elements available in the list")
