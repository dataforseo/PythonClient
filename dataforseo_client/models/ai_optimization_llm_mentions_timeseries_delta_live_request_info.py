...
class AiOptimizationLlmMentionsTimeseriesDeltaLiveRequestInfo(BaseModel):
    """
    ...
    date_from: Optional[StrictStr] = Field(default=None, description=r"start date of the time range. required field. minimal value: 2025-08-01. date format: 'yyyy-mm-dd'")
    date_to: Optional[StrictStr] = Field(default=None, description=r"end date of the time range. required field. Note:the value specified in date_from cannot exceed the value in date_to. date format: 'yyyy-mm-dd'")
    group_range: Optional[StrictStr] = Field(default=None, description=r"timeseries delta range. required field. possible values:. day, week, month, year")
