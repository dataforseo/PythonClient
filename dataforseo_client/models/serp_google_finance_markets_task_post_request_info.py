...
class SerpGoogleFinanceMarketsTaskPostRequestInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["location_name", "location_code", "language_name", "language_code", "priority", "device", "os", "market_type", "tag", "postback_url", "postback_data", "pingback_url"]
