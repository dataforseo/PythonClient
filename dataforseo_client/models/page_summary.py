...
class PageSummary(BaseModel):
    ...
    referring_domains: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="indicates the number of referring domains")
    ...
    referring_pages: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="indicates the number of pages pointing to the page")
