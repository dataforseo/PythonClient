...
class MultiCarouselSerpElementItem(BaseSerpApiElementItem):
    """
    ...
    items: Optional[List[Optional[MultiCarouselElement]]] = Field(default=None, description=r"contains arrays of elements available in the list")
