...
class JobsSerpElementItem(BaseSerpApiElementItem):
    """
    JobsSerpElementItem
    """ # noqa: E501
    ...
    items: Optional[List[Optional[JobsElement]]] = Field(default=None, description=r"contains arrays of elements available in the list")
