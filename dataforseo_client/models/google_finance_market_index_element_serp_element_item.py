...
class GoogleFinanceMarketIndexElementSerpElementItem(BaseGoogleFinanceSerpElementItem):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "ticker", "market_identifier", "index_value", "index_value_delta", "identifier", "displayed_name", "url", "location", "trend", "timestamp", "percentage_delta"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleFinanceMarketIndexElementSerpElementItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleFinanceMarketIndexElementSerpElementItem from a dict"""
        if obj is None:
            return None
