...
class SerpGoogleFinanceExploreTaskGetHtmlResultInfo(BaseModel):
    """
    ...
    items: Optional[List[Optional[SerpHtmlItemInfo]]] = Field(default=None, description="elements of search results found in SERP")
