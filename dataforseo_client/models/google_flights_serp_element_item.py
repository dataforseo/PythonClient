...
class GoogleFlightsSerpElementItem(BaseSerpApiElementItem):
    """
    ...
    items: Optional[List[Optional[GoogleFlightsElement]]] = Field(default=None, description=r"contains arrays of elements available in the list")
