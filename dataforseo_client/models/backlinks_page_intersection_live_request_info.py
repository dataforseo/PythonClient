...
class BacklinksPageIntersectionLiveRequestInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["targets", "exclude_targets", "backlinks_status_type", "filters", "order_by", "offset", "limit", "internal_list_limit", "include_subdomains", "include_indirect_links", "exclude_internal_backlinks", "intersection_mode", "rank_scale", "tag"]
