...
from dataforseo_client.models.ai_optimization_llm_mentions_search_mentions_live_item import AiOptimizationLlmMentionsSearchMentionsLiveItem



class AiOptimizationLlmMentionsSearchMentionsLiveResultInfo(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [AiOptimizationLlmMentionsSearchMentionsLiveItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
        })
