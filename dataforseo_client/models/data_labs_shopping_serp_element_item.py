...
class DataLabsShoppingSerpElementItem(BaseDataforseoLabsApiElementItem):
    """
    ...
    items: Optional[List[Optional[ShoppingElement]]] = Field(default=None, description=r"historical SERPs and related data found in the database")
