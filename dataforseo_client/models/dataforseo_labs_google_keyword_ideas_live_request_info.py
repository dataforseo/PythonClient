...
class DataforseoLabsGoogleKeywordIdeasLiveRequestInfo(BaseModel):
    ...
    closely_variants: Optional[StrictBool] = Field(default=None, description=r"*search mode*. optional field. if set to_`true` the results will be based on the phrase-match search algorithm. if set to `false` the results will be based on the broad-match search algorithm. default value: `false`n")
    ignore_synonyms: Optional[StrictBool] = Field(default=None, description=r"*ignore highly similar keywords*. optional field. if set to_`true` only core keywords will be returned, all highly similar keywords will be excluded;  . default value: `false`n")
    ...
    include_clickstream_data: Optional[StrictBool] = Field(default=None, description=r"*include or exclude data from clickstream-based metrics in the result*. optional field. if the parameter is set to_`true`, you will receive `clickstream_keyword_info`, `keyword_info_normalized_with_clickstream`, and `keyword_info_normalized_with_bing` fields in the response. default value: `false`. with this parameter enabled, you will be charged double the price for the request. learn more about how clickstream-based metrics are calculated in this [help center article](https://dataforseo.com/help-center/what-are-clickstream-based-metrics-and-how-do-we-calculate-them)n")
    limit: Optional[StrictInt] = Field(default=None, description=r"*the maximum number of keywords in the results array*. optional field. default value: `700`. maximum value: `1000`")
