...
class OnPageMicrodataResultInfo(BaseModel):
    ...
    test_summary: Optional[TestSummary] = Field(default=None, description="microdata validation test results")
    items_count: Optional[StrictInt] = Field(default=None, description="number of items in the results array")
    items: Optional[List[Optional[OnPageMicrodataInfoItem]]] = Field(default=None, description="items array")
