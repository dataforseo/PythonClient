...
class BingShoppingSerpElementItem(BaseBingSerpApiElementItem):
    """
    ...
    items: Optional[List[Optional[ShoppingElement]]] = Field(default=None, description=r"additional items present in the element. if there are none, equals null")
