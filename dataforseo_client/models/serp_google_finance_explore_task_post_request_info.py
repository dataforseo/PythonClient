...
class SerpGoogleFinanceExploreTaskPostRequestInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["location_name", "location_code", "language_name", "language_code", "priority", "device", "os", "news_type", "tag", "postback_url", "postback_data", "pingback_url"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if news_type (nullable) is None
        # and model_fields_set contains the field
        if self.news_type is None and "news_type" in self.model_fields_set:
            _dict['news_type'] = None
