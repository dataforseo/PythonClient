...
from dataforseo_client.models.chat_gpt_local_businesses_element import ChatGptLocalBusinessesElement
from dataforseo_client.models.base_chat_gpt_llm_scraper_element_item import BaseChatGptLlmScraperElementItem



class ChatGptLocalBusinessesElementItem(BaseChatGptLlmScraperElementItem):
    """
    ...
    items: Optional[List[Optional[ChatGptLocalBusinessesElement]]] = Field(default=None, description=r"elements of ChatGPT results")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [ChatGptLocalBusinessesElement.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
        })
