...
class AiOptimizationLlmMentionsTimeseriesNewLostLiveRequestInfo(BaseModel):
    """
    ...
    group_range: Optional[StrictStr] = Field(default=None, description=r"timeseries range. required field. possible values:. day, week, month, year")
