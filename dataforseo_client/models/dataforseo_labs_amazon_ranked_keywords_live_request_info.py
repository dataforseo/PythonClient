...
class DataforseoLabsAmazonRankedKeywordsLiveRequestInfo(BaseModel):
    ...
    """ # noqa: E501
    asin: Optional[StrictStr] = Field(default=None, description=r"*product ID*. **required field**. [unique product identifier (ASIN)](https://dataforseo.com/help-center/asin-in-amazon-api) on Amazon;. you can receive the `asin` parameter by making a separate request to the [Amazon Products endpoint](/v3/merchant/amazon/products/task_post/)")
