...
class AiOptimizationGeminiLlmScraperTasksReadyResultInfo(BaseModel):
    """
    ...
    function: Optional[StrictStr] = Field(default=None, description=r"search engine function. example: llm_scraper")
