...
class DataforseoLabsGoogleRankedKeywordsLiveResultInfo(BaseModel):
    ...
    metrics: Optional[Dict[str, Optional[DataforseoLabsMetricsInfo]]] = Field(default=None, description="ranking data relevant to the specified domain. ranking data is provided by the rank_group parameters that show the result’s rank considering only equivalent SERP elements")
    metrics_absolute: Optional[Dict[str, Optional[DataforseoLabsMetricsInfo]]] = Field(default=None, description="ranking data relevant to the specified domain. ranking data is provided by the rank_absolute parameters that indicate the result’s position among all SERP elements")
