...
class AppendixHotelInfoGoogleBusinessDataPriceData(BaseModel):
    ...
    """ # noqa: E501
    live: Optional[AppendixTaskGetProductGoogleMerchantPriceDataInfo] = Field(default=None, description="")
    task_get: Optional[AppendixTaskGetProductGoogleMerchantPriceDataInfo] = Field(default=None, description="")
