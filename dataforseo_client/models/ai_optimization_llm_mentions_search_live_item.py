...
class AiOptimizationLlmMentionsSearchLiveItem(BaseModel):
    ...
    first_response_at: Optional[StrictStr] = Field(default=None, description=r"date and time when the response data was first recordedin the UTC format: “yyyy-mm-dd hh-mm-ss +00:00”example:2025-10-21 06:25:30 +00:00")
    last_response_at: Optional[StrictStr] = Field(default=None, description=r"date and time when the response data was last updatedin the UTC format: “yyyy-mm-dd hh-mm-ss +00:00”example:2025-10-21 06:25:30 +00:00")
    brand_entities: Optional[List[Optional[BrandEntities]]] = Field(default=None, description=r"array of brand entitiescontains information on brands mentioned in the response")
