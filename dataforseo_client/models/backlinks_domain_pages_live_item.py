...
class BacklinksDomainPagesLiveItem(BaseModel):
    ...
    main_domain: Optional[StrictStr] = Field(default=None, description=r"*main website domain*. main website domain does not include subdomains")
    domain: Optional[StrictStr] = Field(default=None, description=r"*domain*. domain where the page was found")
    ...
    page: Optional[StrictStr] = Field(default=None, description=r"*page URL*. relevant page URL")
    ip: Optional[StrictStr] = Field(default=None, description=r"*Internet Protocol address*")
    ...
    meta: Optional[BacklinksPageMeta] = Field(default=None, description=r"*page meta data*")
    page_summary: Optional[PageSummary] = Field(default=None, description=r"*contains backlink data for this page*")
