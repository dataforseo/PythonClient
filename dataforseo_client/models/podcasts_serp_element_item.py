...
class PodcastsSerpElementItem(BaseSerpApiElementItem):
    """
    ...
    items: Optional[List[Optional[PodcastsElement]]] = Field(default=None, description=r"contains arrays of elements available in the list")
