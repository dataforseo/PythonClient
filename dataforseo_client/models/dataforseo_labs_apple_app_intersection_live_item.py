...
from dataforseo_client.models.dataforseo_labs_app_data_intersection_live_item import DataforseoLabsAppDataIntersectionLiveItem
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "intersection_result": dict(
                (_k, DataforseoLabsAppDataIntersectionLiveItem.from_dict(_v))
