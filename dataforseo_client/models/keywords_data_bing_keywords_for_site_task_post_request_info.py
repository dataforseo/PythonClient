...
class KeywordsDataBingKeywordsForSiteTaskPostRequestInfo(BaseModel):
    ...
    """ # noqa: E501
    target: Optional[StrictStr] = Field(default=None, description=r"domain or URL. required field. the URL of the webpage or the domain to scan for possible keywords")
    ...
    language_name: Optional[StrictStr] = Field(default=None, description=r"full name of search engine language. required field if you don’t specify language_code. if you use this field, you don’t need to specify language_code. supported languages:. English, French, German")
    language_code: Optional[StrictStr] = Field(default=None, description=r"search engine language code. required field if you don’t specify language_name. if you use this field, you don’t need to specify language_name. supported languages:. en, fr, de")
    keywords_negative: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"keywords negative array. optional field. These keywords will be ignored in the results array;. You can specify a maximum of 200 terms that you want to exclude from the results;. the specified keywords will be converted to lowercase format")
    device: Optional[StrictStr] = Field(default=None, description=r"device type. optional field. specify this field if you want to get the data for a particular device type. possible values: all, mobile, desktop, tablet. default value: all")
    sort_by: Optional[StrictStr] = Field(default=None, description=r"results sorting parameters. optional field. Use these parameters to sort the results by search_volume, cpc, competition or relevance in the descending order. default value: relevance")
    date_from: Optional[StrictStr] = Field(default=None, description=r"starting date of the time range. optional field. minimal value: 24 months from today’s date;. if you don’t specify this field, data will be provided for the last 12 months. date format: 'yyyy-mm-dd'. example:. '2020-01-01'. Note: we do not recommend using a custom time range for the past year’s dates")
    date_to: Optional[StrictStr] = Field(default=None, description=r"ending date of the time range. optional field. if you don’t specify this field, data will be provided for the last 12 months;. minimum value: two years back from today’s date;. maximum value: one month from today’s date;. date format: 'yyyy-mm-dd'. example:. '2020-03-15'. Note: we do not recommend using a custom time range for the past year’s dates")
    ...
    search_partners: Optional[StrictBool] = Field(default=None, description=r"Bing search partners type. optional field. if you specify true, the results will be delivered for owned, operated, and syndicated networks across Bing, Yahoo, AOL and partner sites that host Bing, AOL, and Yahoo search.. default value: false – results are returned for Bing, AOL, and Yahoo search networks")
