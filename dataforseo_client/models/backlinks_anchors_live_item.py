...
class BacklinksAnchorsLiveItem(BaseModel):
    ...
    backlinks_spam_score: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="average spam score of all backlinks with this anchor learn more about how the metric is calculated on this help center page")
    ...
    referring_pages: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="indicates the number of pages pointing to target with this anchor")
    referring_pages_nofollow: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="number of referring pages pointing at least one nofollow link to the target with this anchor")
