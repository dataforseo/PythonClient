...
class BacklinksAnchorsLiveItem(BaseModel):
    ...
    anchor: Optional[StrictStr] = Field(default=None, description=r"*anchor of the backlink*")
    ...
    first_seen: Optional[StrictStr] = Field(default=None, description=r"*date and time when our crawler found the backlink with this anchor for the first time*. in the UTC format: “yyyy-mm-dd hh-mm-ss +00:00”. example:. `2019-11-15 12:57:46 +00:00`")
    ...
    backlinks_spam_score: Optional[StrictInt] = Field(default=None, description=r"*average spam score of all backlinks with this anchor*. learn more about how the metric is calculated on [this help center page](https://dataforseo.com/help-center/what-is-spam-score-and-how-is-it-calculated)")
    ...
    referring_pages: Optional[StrictInt] = Field(default=None, description=r"*indicates the number of pages pointing to `target` with this anchor*")
    referring_pages_nofollow: Optional[StrictInt] = Field(default=None, description=r"*number of referring pages pointing at least one nofollow link to the `target` with this anchor*")
