...
class PeopleAlsoAskAiOverviewExpandedElementSerpElementItem(BasePeopleAlsoAskExpandedElementItem):
    """
    PeopleAlsoAskAiOverviewExpandedElementSerpElementItem
    """ # noqa: E501
    items: Optional[List[AiOverviewElement]] = Field(default=None, description="contains arrays of elements available in the list")
    ...
    __properties: ClassVar[List[str]] = ["type", "items", "references"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PeopleAlsoAskAiOverviewExpandedElementSerpElementItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PeopleAlsoAskAiOverviewExpandedElementSerpElementItem from a dict"""
        if obj is None:
            return None
