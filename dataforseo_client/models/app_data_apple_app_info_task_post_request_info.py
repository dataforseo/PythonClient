...
class AppDataAppleAppInfoTaskPostRequestInfo(BaseModel):
    ...
    """ # noqa: E501
    app_id: Optional[StrictStr] = Field(default=None, description=r"*id of the app*. **required field**. ID of the mobile application on App Store;. you can find the ID in the URL of every app listed on App Store;. example:. in the URL `https://apps.apple.com/us/app/id**835599320**`. the id is `835599320`")
