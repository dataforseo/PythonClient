...
class AiOptimizationLlmMentionsSearchMentionsLiveItem(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        _dict['is_web_search_based'] = self.is_web_search_based
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "is_web_search_based": obj.get("is_web_search_based"),
        })
