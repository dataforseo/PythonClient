...
class AiOptimizationPerplexityLlmResponsesLiveResultInfo(BaseModel):
    ...
    web_search: Optional[StrictBool] = Field(default=None, description=r"indicates if web search was usedNote: web search is enabled by default in Perplexity Sonar models")
    ...
    items: Optional[List[Optional[MessageAiOptimizationLlmResponseElementItem]]] = Field(default=None, description=r"array of response itemscontains structured AI response data")
    fan_out_queries: Optional[Any] = Field(default=None, description=r"array of fan-out queriescontains related search queries derived from the main query to provide a more comprehensive response")
