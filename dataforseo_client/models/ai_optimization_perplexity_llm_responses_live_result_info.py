...
class AiOptimizationPerplexityLlmResponsesLiveResultInfo(BaseModel):
    ...
    web_search: Optional[StrictBool] = Field(default=None, description="indicates if web search was used. Note: web search is enabled by default in Perplexity Sonar models")
