...
class OrganicSerpElementItem(BaseSerpApiElementItem):
    ...
    faq: Optional[FaqBox] = Field(default=None, description=r"frequently asked questions. questions and answers extension shown below some of Google’s search results. Note: this object is deprecated and always returns null")
