...
class GoogleShoppingSerpElementItem(BaseMerchantGoogleShoppingProductsElementItem):
    ...
    price_multiplier: Optional[StrictInt] = Field(default=None, description=r"price multiplier for instalment planindicates the number of months covered by the monthly payment for the product")
    old_price: Optional[StrictFloat] = Field(default=None, description=r"product old pricedisplayed if the product price has been changedexample:499")
    currency: Optional[StrictStr] = Field(default=None, description=r"currency in the ISO formatexample:USD")
    product_id: Optional[StrictStr] = Field(default=None, description=r"unique product identifier on Google Shoppingnote that there is no full list of possible values as the product_id is a dynamic value assigned by Googleif there are no values, you will get nullexample:4485466949985702538learn more about the parameter in this help center guide")
    data_docid: Optional[StrictStr] = Field(default=None, description=r"unique identifier of the SERP data elementnote that there is no full list of possible values as the data_docid is a dynamic value assigned by Googleexample:17363035694596624076")
    ...
    additional_specifications: Optional[Dict[str, Optional[StrictStr]]] = Field(default=None, description=r"object containing additional url parametersyou can get more details about the product by using this object in the POST request to the Google Shopping Product Specification and Google Shopping Sellers endpoint")
    reviews_count: Optional[StrictInt] = Field(default=None, description=r"number of product reviewsindicates the number of reviews left by users on Google Shoppingif there are no values, you will get null")
    is_best_match: Optional[StrictBool] = Field(default=None, description=r"'best match' labelif the value is true, the product is marked with the 'best match' labelif there are no values, you will get null")
    ...
    shop_rating: Optional[RatingElement] = Field(default=None, description=r"shop ratingthe popularity rate of the seller based on user reviews")
    ...
    stores_count_info: Optional[StoresCountInfo] = Field(default=None, description=r"stores count informationcontains information about the number of stores that offer the same product")
