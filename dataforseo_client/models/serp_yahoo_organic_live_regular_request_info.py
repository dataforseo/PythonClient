...
class SerpYahooOrganicLiveRegularRequestInfo(BaseModel):
    ...
    match_value: Optional[StrictStr] = Field(default=None, description=r"target domain, subdomain, or wildcard value. required field if stop_crawl_on_match is specified;. required field if stop_crawl_on_match is specified. specify a target domain, subdomain, or wildcard value;. Note: domain or subdomain must be specified without a request protocol;. example: 'match_value': 'dataforseo.com',. 'match_value': '/blog/post-*'")
