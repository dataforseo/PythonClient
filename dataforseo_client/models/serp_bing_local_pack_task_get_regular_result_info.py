...
class SerpBingLocalPackTaskGetRegularResultInfo(BaseModel):
    ...
    spell: Optional[SpellInfo] = Field(default=None, description="autocorrection of the search engine. if the search engine provided results for a keyword that was corrected, we will specify the keyword corrected by the search engine and the type of autocorrection. equals null")
    refinement_chips: Optional[RefinementChipsInfo] = Field(default=None, description="search refinement chips. equals null")
    ...
    items: Optional[List[Optional[BaseSerpApiElementItem]]] = Field(default=None, description="elements of search results found in SERP")
