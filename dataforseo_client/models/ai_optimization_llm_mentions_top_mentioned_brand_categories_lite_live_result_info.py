...
from dataforseo_client.models.ai_optimization_llm_mentions_top_mentioned_brand_categories_lite_live_item import AiOptimizationLlmMentionsTopMentionedBrandCategoriesLiteLiveItem



class AiOptimizationLlmMentionsTopMentionedBrandCategoriesLiteLiveResultInfo(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [AiOptimizationLlmMentionsTopMentionedBrandCategoriesLiteLiveItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
        })
