...
class TripadvisorReviewSearch(BaseModel):
    ...
    url: Optional[StrictStr] = Field(default=None, description=r"URL of the review")
    rating: Optional[RatingInfo] = Field(default=None, description=r"the rating score submitted by the reviewer")
    date_of_visit: Optional[StrictStr] = Field(default=None, description=r"date of the reviewer’s visit to the local establishment. in the UTC format: “yyyy-mm-dd hh-mm-ss +00:00”. example:. 2019-11-15 12:57:46 +00:00")
    ...
    review_id: Optional[StrictStr] = Field(default=None, description=r"ID of the review")
    ...
    language: Optional[StrictStr] = Field(default=None, description=r"language of the review text")
    original_language: Optional[StrictStr] = Field(default=None, description=r"language of the untranslated review text")
    review_images: Optional[List[Optional[ImageUrlInfo]]] = Field(default=None, description=r"contains URLs of the images used in the review")
    user_profile: Optional[BusinessDataUserProfileInfo] = Field(default=None, description=r"information from the reviewer’s profile")
    responses: Optional[List[Optional[ReviewResponseItemInfo]]] = Field(default=None, description=r"contains information about the owner’s response")
    review_highlights: Optional[Any] = Field(default=None, description=r"review highlights. contains highlighted review criteria and assessments")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        _dict['review_highlights'] = self.review_highlights
        return _dict
