...
class SerpApiPeopleAlsoAskExpandedElementItem(BaseSerpApiPeopleAlsoAskExpandedElementItem):
    """
    ...
    description: Optional[StrictStr] = Field(default=None, description=r"description")
