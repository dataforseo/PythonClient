...
class KnowledgeGraphImagesItemSerpElementItem(BaseSerpApiElementItem):
    """
    ...
    items: Optional[List[Optional[KnowledgeGraphImagesElement]]] = Field(default=None, description="contains arrays of specific images")
