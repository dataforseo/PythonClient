...
class AryContentInfo(BaseModel):
    """
    AryContentInfo
    """ # noqa: E501
    ...
    urls: Optional[List[Urls]] = Field(default=None, description="contains other URLs and anchors found in the content element")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "text": obj.get("text"),
            "url": obj.get("url"),
            "urls": [Urls.from_dict(_item) for _item in obj["urls"]] if obj.get("urls") is not None else None
        })
        return _obj
