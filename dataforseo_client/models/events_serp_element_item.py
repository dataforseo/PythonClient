...
class EventsSerpElementItem(BaseSerpApiElementItem):
    """
    ...
    items: Optional[List[Optional[EventsElement]]] = Field(default=None, description=r"contains arrays of elements available in the list")
