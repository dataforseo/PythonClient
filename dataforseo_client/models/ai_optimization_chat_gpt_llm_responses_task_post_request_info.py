...
class AiOptimizationChatGptLlmResponsesTaskPostRequestInfo(BaseModel):
    ...
    max_output_tokens: Optional[StrictInt] = Field(default=None, description=r"maximum number of tokens in the AI response. optional field. minimum value for reasoning models (e.g., model_name starts with ‘o’): 1024;. minimum value for non-reasoning models: 16;. maximum value for reasoning models: 4096;. maximum value for non-reasoning models: 2048;. default value for both reasoning and non-reasoning models: 2048;")
