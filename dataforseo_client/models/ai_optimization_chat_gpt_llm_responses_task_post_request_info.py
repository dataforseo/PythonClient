...
class AiOptimizationChatGptLlmResponsesTaskPostRequestInfo(BaseModel):
    ...
    max_output_tokens: Optional[StrictInt] = Field(default=None, description=r"maximum number of tokens in the AI response. optional field. minimum value for reasoning models (e.g., reasoning is true in the Models endpoint): 1024;. minimum value for non-reasoning models: 16;. maximum value: 4096;. default value: 2048")
    ...
    top_p: Optional[StrictFloat] = Field(default=None, description=r"diversity of the AI response. optional field . controls diversity of the response by limiting token selection;. minimum value: 0. maximum value: 1 . default value: 0.92Note:  top_p cannot be used together with temperature in the same request")
