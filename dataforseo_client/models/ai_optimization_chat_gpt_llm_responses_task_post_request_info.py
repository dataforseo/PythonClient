...
class AiOptimizationChatGptLlmResponsesTaskPostRequestInfo(BaseModel):
    ...
    max_output_tokens: Optional[StrictInt] = Field(default=None, description=r"*maximum number of tokens in the AI response*. optional field. minimum value for reasoning models (e.g., `reasoning` is `true` in the [Models endpoint](/v3/ai_optimization/chat_gpt/llm_responses/models/)): `1024`;. minimum value for non-reasoning models: `16`;. maximum value: `4096`;. default value: `2048`")
