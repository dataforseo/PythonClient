...
class GoogleTrendsGoogleTrendsQueriesListElementItem(BaseKeywordDataGoogleTrendsItem):
    """
    ...
    data: Optional[QueriesListDataInfo] = Field(default=None, description="Google Trends data from the corresponding item")
