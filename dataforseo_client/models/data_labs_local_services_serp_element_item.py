...
class DataLabsLocalServicesSerpElementItem(BaseDataforseoLabsApiElementItem):
    """
    ...
    items: Optional[List[Optional[LocalServicesElement]]] = Field(default=None, description="elements of search results found in SERP")
