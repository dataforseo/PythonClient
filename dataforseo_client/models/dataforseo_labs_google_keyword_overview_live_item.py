...
class DataforseoLabsGoogleKeywordOverviewLiveItem(BaseModel):
    """
    ...
    keyword_info: Optional[KeywordInfo] = Field(default=None, description="keyword data for the returned keyword")
    ...
    avg_backlinks_info: Optional[AvgBacklinksInfo] = Field(default=None, description="backlink data for the returned keyword. this object provides the average number of backlinks, referring pages and domains, as well as the average rank values among the top-10 websites ranking organically for the keyword")
