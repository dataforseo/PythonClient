...
class DataforseoLabsGoogleKeywordOverviewLiveItem(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["se_type", "keyword", "location_code", "language_code", "search_partners", "keyword_info", "keyword_info_normalized_with_bing", "keyword_info_normalized_with_clickstream", "clickstream_keyword_info", "keyword_properties", "serp_info", "avg_backlinks_info", "search_intent_info"]
