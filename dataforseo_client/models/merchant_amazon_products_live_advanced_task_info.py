...
from dataforseo_client.models.merchant_amazon_products_live_advanced_result_info import MerchantAmazonProductsLiveAdvancedResultInfo
from dataforseo_client.models.base_response_task_info import BaseResponseTaskInfo



class MerchantAmazonProductsLiveAdvancedTaskInfo(BaseModel):
    """
    ...
    result: Optional[List[Optional[MerchantAmazonProductsLiveAdvancedResultInfo]]] = Field(default=None, description=r"array of results")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "path": obj.get("path"),
            "data": obj.get("data"),
            "result": [MerchantAmazonProductsLiveAdvancedResultInfo.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None,
        })
