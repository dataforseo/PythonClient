...
class BingOrganicSerpElementItem(BaseBingSerpApiElementItem):
    """
    ...
    website_name: Optional[StrictStr] = Field(default=None, description=r"name of the source website")
    ...
    faq: Optional[FaqBox] = Field(default=None, description=r"frequently asked questions. questions and answers extension shown below some search results. if there are none, equals null", deprecated=True)
    ...
    about_this_result: Optional[AboutThisResultElement] = Field(default=None, description=r"contains information from the ‘About this result’ panel. note: about_this_result feature is not available in Bing search engine, that’s why it always equals null", deprecated=True)
    related_result: Optional[List[Optional[RelatedResult]]] = Field(default=None, description=r"related result from the same domain. related result from the same domain appears as a part of the main result snippet;. note: related_result feature is not available in Bing search engine, that’s why it always equals null")
