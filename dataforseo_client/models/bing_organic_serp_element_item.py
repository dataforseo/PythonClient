...
class BingOrganicSerpElementItem(BaseBingSerpApiElementItem):
    ...
    faq: Optional[FaqBox] = Field(default=None, description=r"frequently asked questions. questions and answers extension shown below some search results. if there are none, equals null")
    ...
    about_this_result: Optional[AboutThisResultElement] = Field(default=None, description=r"contains information from the ‘About this result’ panel. note: about_this_result feature is not available in Bing search engine, that’s why it always equals null")
