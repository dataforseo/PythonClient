...
class KeywordsDataGoogleAdsKeywordsForKeywordsTaskPostRequestInfo(BaseModel):
    ...
    target: Optional[StrictStr] = Field(default=None, description=r"*target website*. optional field. specify a website or URL to get a list of keywords relevant to it;. **Note:** if a website url is specified, you will still get keywords relevant for the entire website")
