...
class AiOptimizationLLmMentionsMultiTargetMetricsRequestInfo(BaseModel):
    """
    ...
    key: Optional[StrictStr] = Field(default=None, description=r"key for grouping the results. required field. groups results for comparison and serves as a label for the group;. you can specify up to 250 characters in the key field")
