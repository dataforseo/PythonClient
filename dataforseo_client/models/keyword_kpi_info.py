...
class KeywordKpiInfo(BaseModel):
    ...
    clicks: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="ad clicks the number of clicks that the keyword and match type generated during the last month")
    impressions: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="ad impressions the number of impressions that the keyword and match type generated during the last month")
    ...
    total_cost: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="total cost of an ad, USD the cost of using the specified keyword and match type during the last month")
