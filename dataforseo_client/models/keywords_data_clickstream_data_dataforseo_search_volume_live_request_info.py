...
class KeywordsDataClickstreamDataDataforseoSearchVolumeLiveRequestInfo(BaseModel):
    ...
    use_clickstream: Optional[StrictBool] = Field(default=None, description="use clickstream data to provide results optional field if this parameter set to true, you will get search volume rate based on clickstream data otherwise, Bing search volume data will be used to calculate search volume")
