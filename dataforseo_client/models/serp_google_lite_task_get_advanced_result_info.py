...
class SerpGoogleLiteTaskGetAdvancedResultInfo(BaseModel):
    """
    ...
    items: Optional[List[Optional[BaseSerpApiElementItem]]] = Field(default=None, description=r"contains results featured in the local_services element of SERP")
