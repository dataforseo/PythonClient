...
class KeywordsDataBingSearchVolumeHistoryLiveRequestInfo(BaseModel):
    ...
    device: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"device types. optional field. specify this field if you want to get the data for a particular device types. possible values: mobile, desktop, tablet, non_smartphones. default value:  ['mobile', 'desktop', 'tablet', 'non_smartphones']")
    period: Optional[StrictStr] = Field(default=None, description=r"aggregates the returned data to a certain time period. optional field. specify this field if you want to get the data in monthly, weekly or daily format. possible values: monthly, weekly, daily. monthly – returns data up to past 24 months. weekly – returns data up to past 15 weeks. daily – returns data up to past 45 days. default value:  monthly")
    date_from: Optional[StrictStr] = Field(default=None, description=r"starting date of the time range. optional field. minimum value: 24 months back from today’s date. maximum value: one day from today’s date. date format: 'yyyy-mm-dd'. example:. '2020-01-01'. Note: we do not recommend using a custom time range. Note 2: if date_from and date_to parameters are not specified, the data will be returned for the past 24 months. if you specify the period parameter:. with value weekly, you will get results for the past 15 weeks. with value daily, you will get results for the past 45 days")
    date_to: Optional[StrictStr] = Field(default=None, description=r"ending date of the time range. optional field. minimum value: two years back from today’s date;. maximum value: one day from today’s date;. date format: 'yyyy-mm-dd'. example:. '2020-03-15'. Note: we do not recommend using a custom time range. Note 2: if date_from and date_to parameters are not specified, the data will be returned for the past 24 months. if you specify the period parameter:. with value weekly, you will get results for the past 15 weeks. with value daily, you will get results for the past 45 days")
