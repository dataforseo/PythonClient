...
class BacklinksReferringNetworksLiveRequestInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["target", "network_address_type", "limit", "offset", "internal_list_limit", "backlinks_status_type", "filters", "order_by", "backlinks_filters", "include_subdomains", "include_indirect_links", "exclude_internal_backlinks", "rank_scale", "tag"]
