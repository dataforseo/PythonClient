...
class DataforseoLabsGoogleKeywordSuggestionsLiveResultInfo(BaseModel):
    ...
    seed_keyword_data: Optional[KeywordDataInfo] = Field(default=None, description="keyword data for the seed keyword. fields in this object are identical to those of the items array")
    ...
    items: Optional[List[Optional[KeywordDataInfo]]] = Field(default=None, description="contains keywords and related data")
