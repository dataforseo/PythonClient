...
class MerchantGoogleSellersTaskPostRequestInfo(BaseModel):
    ...
    data_docid: Optional[StrictStr] = Field(default=None, description=r"unique identifier of the SERP data element. required field if product_id or gid is not specified. we recommend specifying data_docid together with product_id and gid for optimal results;. you can get this value for a certain element by making a separate request to the Google Shopping Products endpoint. example:. 13071766526042404278")
    ...
    pvf: Optional[StrictStr] = Field(default=None, description=r"product variant filter  on Google Shopping. optional field. parameter in Google Shopping URL, setting optional product variant filtration;. example:. Eg4iBWNvbG9yKgV3aGl0ZRISIgxwYWNrYWdlIHNpemUqAjE0EgoiBHNpemUqAnhs")
    ...
    get_shops_on_google: Optional[StrictBool] = Field(default=None, description=r"include “buy on Google” shops. optional field. if set to true, the response will contain the list of sellers that allow to purchase a given product directly on Google. Note: if set to true, the cost of a task will be doubled")
    ...
    postback_data: Optional[StrictStr] = Field(default=None, description=r"postback_url datatype. optional field. corresponds to the datatype that will be sent to your server. possible values:. advanced")
