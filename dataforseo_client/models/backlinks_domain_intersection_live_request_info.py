...
class BacklinksDomainIntersectionLiveRequestInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["targets", "exclude_targets", "filters", "order_by", "offset", "limit", "internal_list_limit", "backlinks_status_type", "backlinks_filters", "include_subdomains", "include_indirect_links", "exclude_internal_backlinks", "intersection_mode", "rank_scale", "tag"]
