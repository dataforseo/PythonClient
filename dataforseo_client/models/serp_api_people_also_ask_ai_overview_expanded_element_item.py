...
class SerpApiPeopleAlsoAskAiOverviewExpandedElementItem(BaseSerpApiPeopleAlsoAskExpandedElementItem):
    ...
    items: Optional[List[Optional[BaseSerpApiPeopleAlsoAskAiOverviewElementItem]]] = Field(default=None, description="contains arrays of elements available in the list")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "items": [BaseSerpApiPeopleAlsoAskAiOverviewElementItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
