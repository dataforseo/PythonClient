...
class BacklinksDomainPagesLiveRequestInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["target", "limit", "offset", "internal_list_limit", "backlinks_status_type", "filters", "order_by", "backlinks_filters", "include_subdomains", "exclude_internal_backlinks", "rank_scale", "tag"]
