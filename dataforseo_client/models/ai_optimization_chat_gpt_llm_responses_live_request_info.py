...
class AiOptimizationChatGptLlmResponsesLiveRequestInfo(BaseModel):
    ...
    max_output_tokens: Optional[StrictInt] = Field(default=None, description=r"*maximum number of tokens in the AI response*. optional field. minimum value for reasoning models (e.g., `reasoning` is `true` in the [Models endpoint](/v3/ai_optimization/chat_gpt/llm_responses/models/)): `1024`;. minimum value for non-reasoning models: `16`;. maximum value: `4096`;. default value: `2048`. **Note:** if `web_search` is set to `true` or the reasoning model is specified in the request, the output token count may exceed the specified `max_output_tokens` limit")
    ...
    top_p: Optional[StrictFloat] = Field(default=None, description=r"*diversity of the AI response*. optional field . controls diversity of the response by limiting token selection;. minimum value: `0`. maximum value: `1` . default value: `0.92`. **Note:**  `top_p` cannot be used together with `temperature` in the same request")
    web_search: Optional[StrictBool] = Field(default=None, description=r"*enable web search*. optional field. when enabled, the AI model can access and cite current web information;. default value: `false`;. **Note:** refer to the [Models endpoint](https://docs.dataforseo.com/v3/ai_optimization/chat_gpt/llm_responses/models/) for a list of models that support `web_search`;")
    ...
    web_search_country_iso_code: Optional[StrictStr] = Field(default=None, description=r"*ISO country code of the location*. optional field. to enable this parameter, `web_search` must also be enabled;. when enabled, the AI model will search the web from the country you specify;. **Note:** not supported in `o3-mini`, `o1-pro`, `o1` models")
    web_search_city: Optional[StrictStr] = Field(default=None, description=r"*city name of the location*. optional field. **Note:** not supported in `o3-mini`, `o1-pro`, `o1` models")
