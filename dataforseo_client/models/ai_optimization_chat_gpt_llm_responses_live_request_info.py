...
class AiOptimizationChatGptLlmResponsesLiveRequestInfo(BaseModel):
    ...
    temperature: Optional[StrictFloat] = Field(default=None, description="randomness of the AI response. optional field. higher values make output more diverse;. lower values make output more focused;. minimum value: 0. maximum value: 2. default value: 0.94. Note: not supported in o4-mini, o3-mini, o1-pro, o1 models")
    top_p: Optional[StrictFloat] = Field(default=None, description="diversity of the AI response. optional field. controls diversity of the response by limiting token selection;. minimum value: 0. maximum value: 1. default value: 0.92. Note: not supported in o4-mini, o3-mini, o1-pro, o1 models")
