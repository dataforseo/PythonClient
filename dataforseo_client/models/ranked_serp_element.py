...
class RankedSerpElement(BaseModel):
    ...
    serp_item: Optional[BaseDataforseoLabsApiElementItem] = Field(default=None, description=r"contains data on the SERP element. the list of supported SERP elements can be found below")
    ...
    previous_updated_time: Optional[StrictStr] = Field(default=None, description=r"previous to the most recent date and time when SERP data was updated. in the UTC format: “yyyy-mm-dd hh-mm-ss +00:00”. example:. 2019-10-15 12:57:46 +00:00")
