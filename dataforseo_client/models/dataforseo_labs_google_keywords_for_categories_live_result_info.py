...
class DataforseoLabsGoogleKeywordsForCategoriesLiveResultInfo(BaseModel):
    ...
    seed_categories: Optional[List[Optional[StrictInt]]] = Field(default=None, description=r"categories in a POST array")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        _dict['seed_categories'] = self.seed_categories
