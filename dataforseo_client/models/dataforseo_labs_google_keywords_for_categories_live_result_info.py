...
class DataforseoLabsGoogleKeywordsForCategoriesLiveResultInfo(BaseModel):
    ...
    seed_categories: Optional[List[Optional[Union[StrictFloat, StrictInt]]]] = Field(default=None, description="categories in a POST array")
    ...
    total_count: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="the total amount of results in our database relevant to your request")
    ...
    offset: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="current offset value")
