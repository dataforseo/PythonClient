...
class DataforseoLabsGoogleHistoricalBulkTrafficEstimationLiveRequestInfo(BaseModel):
    ...
    """ # noqa: E501
    targets: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"*target domains and subdomains*. **required field**. you can specify domains and subdomains in this field;. domains and subdomains should be specified without `https://` and `www.`;. you can set up to 1000 domains or subdomains")
    location_name: Optional[StrictStr] = Field(default=None, description=r"*full name of the location*. if you use this field, you don't have to specify `location_code`. you can receive the list of available locations with their `location_name` by making a separate request to the. `https://api.dataforseo.com/v3/dataforseo_labs/locations_and_languages`. ignore this field to get the results for all available locations. example:. `United Kingdom`")
    location_code: Optional[StrictInt] = Field(default=None, description=r"*location code*. if you use this field, you don't have to specify `location_name`. you can receive the list of available locations with their `location_code` by making a separate request to the. `https://api.dataforseo.com/v3/dataforseo_labs/locations_and_languages`. ignore this field to get the results for all available locations. example:. `2840`")
    language_name: Optional[StrictStr] = Field(default=None, description=r"*full name of the language*. if you use this field, you don’t need to specify `language_code`. you can receive the list of available languages with their `language_name` by making a separate request to the. `https://api.dataforseo.com/v3/dataforseo_labs/locations_and_languages`. ignore this field to get the results for all available languages. example:. `English`")
    language_code: Optional[StrictStr] = Field(default=None, description=r"*language code*. if you use this field, you don’t need to specify `language_name`. you can receive the list of available languages with their `language_code` by making a separate request to the. `https://api.dataforseo.com/v3/dataforseo_labs/locations_and_languages`. ignore this field to get the results for all available languages. example:. `en`")
    date_from: Optional[StrictStr] = Field(default=None, description=r"*starting date of the time range*. optional field. if you don't specify this field, the data will be provided for the previous 12 months. minimal possible value: `2020-10-01`. date format: `'yyyy-mm-dd'`")
    date_to: Optional[StrictStr] = Field(default=None, description=r"*ending date of the time range*. optional field. if you don't specify this field, the today's date will be used by default;. date format: `'yyyy-mm-dd'`. example:. `'2021-04-01'`")
