...
class SerpGoogleJobsTaskGetAdvancedResultInfo(BaseModel):
    ...
    spell: Optional[SpellInfo] = Field(default=None, description="autocorrection of the search engine. if the search engine provided results for a keyword that was corrected, we will specify the keyword corrected by the search engine and the type of autocorrection;. in this case, equals null")
    ...
    items: Optional[List[Optional[GoogleJobsItem]]] = Field(default=None, description="items of the element")
