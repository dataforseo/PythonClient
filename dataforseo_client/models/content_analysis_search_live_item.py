...
class ContentAnalysisSearchLiveItem(BaseModel):
    ...
    spam_score: Optional[StrictInt] = Field(default=None, description=r"*backlink spam score of the `url`*. this value is based on backlink data for the given URL from DataForSEO Backlink Index;. learn more about how the metric is calculated on [this help center page](https://dataforseo.com/help-center/what-is-spam-score-and-how-is-it-calculated)")
    ...
    country: Optional[StrictStr] = Field(default=None, description=r"*country code of the domain registration*. to obtain a full list of available countries, refer to the [Locations](/v3/content_analysis/locations/) endpoint")
