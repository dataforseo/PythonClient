...
class DataforseoLabsAppleBulkAppMetricsLiveResultInfo(BaseModel):
    ...
    items: Optional[List[Optional[DataforseoLabsleBulkAppMetricsLiveItem]]] = Field(default=None, description="contains data related to the ranking app metrics of the specified application")
