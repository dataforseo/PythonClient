...
from dataforseo_client.models.merchant_amazon_asin_live_advanced_result_info import MerchantAmazonAsinLiveAdvancedResultInfo
from dataforseo_client.models.base_response_task_info import BaseResponseTaskInfo



class MerchantAmazonAsinLiveAdvancedTaskInfo(BaseModel):
    """
    ...
    result: Optional[List[Optional[MerchantAmazonAsinLiveAdvancedResultInfo]]] = Field(default=None, description=r"*array of results*")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "path": obj.get("path"),
            "data": obj.get("data"),
            "result": [MerchantAmazonAsinLiveAdvancedResultInfo.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None,
        })
