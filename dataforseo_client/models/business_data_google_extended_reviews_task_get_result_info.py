...
class BusinessDataGoogleExtendedReviewsTaskGetResultInfo(BaseModel):
    ...
    items: Optional[List[Optional[GoogleExtendedReviewsSearch]]] = Field(default=None, description="found reviews. you can get more results by using the depth parameter when setting a task")
