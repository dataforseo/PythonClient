...
class DataLabsCoursesSerpElementItem(BaseDataforseoLabsApiElementItem):
    """
    ...
    categories: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"array of course categories. contains a list of categories relevant to courses")
    items: Optional[List[Optional[CoursesElement]]] = Field(default=None, description=r"historical SERPs and related data found in the database")
