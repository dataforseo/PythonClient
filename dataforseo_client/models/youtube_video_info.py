...
class YoutubeVideoInfo(BaseModel):
    ...
    channel_id: Optional[StrictStr] = Field(default=None, description=r"*the ID of the channel where the video is published*")
    ...
    description: Optional[StrictStr] = Field(default=None, description=r"*description of the video*")
    views_count: Optional[StrictInt] = Field(default=None, description=r"*number of views of the video*")
    likes_count: Optional[StrictInt] = Field(default=None, description=r"*number of likes on the video*")
    comments_count: Optional[StrictInt] = Field(default=None, description=r"*number of comments on the video*")
    channel_subscribers_count: Optional[ChannelSubscribersCount] = Field(default=None, description=r"*number of subscribers of the channel*")
    ...
    keywords: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"*keywords relevant to the video*.             also known as 'YouTube tags'")
    category: Optional[StrictStr] = Field(default=None, description=r"*the category the video belongs to*")
    is_live: Optional[StrictBool] = Field(default=None, description=r"*indicates whether the video is on live*")
    is_embeddable: Optional[StrictBool] = Field(default=None, description=r"*indicates whether the video is embeddable*")
    ...
    subtitles: Optional[List[Optional[Subtitles]]] = Field(default=None, description=r"*array of elements describing properties of subtitles in the video*")
    streaming_quality: Optional[List[Optional[StreamingQualityElement]]] = Field(default=None, description=r"*array of elements that contain information about all possible streaming qualities of the video*")
