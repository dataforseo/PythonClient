...
class DataforseoLabsGoogleCategoriesForDomainLiveItem(BaseModel):
    ...
    metrics: Optional[Dict[str, Optional[DataforseoLabsMetricsInfo]]] = Field(default=None, description="ranking data relevant to the specified domain or subdomain")
