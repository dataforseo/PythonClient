...
class DataforseoTrendsinterestsInfo(BaseModel):
    ...
    values: Optional[List[DataforseoTrendsinterestsValuesInfo]] = Field(default=None, description="contains data on relative keyword popularity by country or region")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataforseoTrendsinterestsInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataforseoTrendsinterestsInfo from a dict"""
        if obj is None:
            return None
