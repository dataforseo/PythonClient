...
class SerpBaiduOrganicTaskPostRequestInfo(BaseModel):
    ...
    device: Optional[StrictStr] = Field(default=None, description=r"device type. optional field. return results for a specific device type. can take the values: desktop, mobile, tablet. default value: desktop")
