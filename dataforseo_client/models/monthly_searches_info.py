...
class MonthlySearchesInfo(BaseModel):
    ...
    month: Optional[StrictStr] = Field(default=None, description="month")
    search_volume: Optional[StrictStr] = Field(default=None, description="monthly average search volume rate")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MonthlySearchesInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MonthlySearchesInfo from a dict"""
        if obj is None:
            return None
