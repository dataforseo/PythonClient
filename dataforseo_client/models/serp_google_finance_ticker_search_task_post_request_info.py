...
class SerpGoogleFinanceTickerSearchTaskPostRequestInfo(BaseModel):
    """
    SerpGoogleFinanceTickerSearchTaskPostRequestInfo
    """ # noqa: E501
    keyword: Optional[StrictStr] = Field(default=None, description="company or financial instrument name. required field. in this field, you can enter the name of a company or financial instrument to search for relevant tickers;. you can specify up to 700 characters in the keyword field;. all %## will be decoded (plus character ‘+’ will be decoded to a space character). if you need to use the “%” character for your keyword, please specify it as “%25”;. if you need to use the “+” character for your keyword, please specify it as “%2B”;. learn more about rules and limitations of keyword and keywords fields in DataForSEO APIs in this Help Center article")
    ...
    category: Optional[StrictStr] = Field(default=None, description="category of financial instruments to search for. optional field. possible values: all, stock, index, mutual_fund, currency, futures. default value: all")
