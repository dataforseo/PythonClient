...
class BacklinksHistoryLiveResultInfo(BaseModel):
    ...
    items: Optional[List[Optional[BacklinksHistoryLiveItem]]] = Field(default=None, description="contains historical backlink data for the specified domain. the data is provided month-by-month;. the metrics are aggregated according to the backlinks the specified domain had on the first day of each given month")
