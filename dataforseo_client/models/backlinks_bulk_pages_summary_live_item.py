...
class BacklinksBulkPagesSummaryLiveItem(BaseModel):
    ...
    backlinks_spam_score: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="average spam score of the backlinks pointing to the page learn more about how the metric is calculated on this help center page")
    broken_backlinks: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="number of broken backlinks number of broken backlinks pointing to the page")
    ...
    referring_domains: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="indicates the number domains referring to the page")
    ...
    referring_pages: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="indicates the number of pages pointing to the relevant url")
