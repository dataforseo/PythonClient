...
class AiOptimizationChatGptLlmScraperTaskPostRequestInfo(BaseModel):
    """
    ...
    expand_citations: Optional[StrictBool] = Field(default=None, description=r"return expanded citation bar in HTML results. optional field. to enable this parameter, force_web_search must also be enabled;. when enabled, the HTML endpoint will return data from the expanded citation bar;. default value: false")
