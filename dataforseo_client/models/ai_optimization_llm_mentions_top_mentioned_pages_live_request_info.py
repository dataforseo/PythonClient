...
class AiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo(BaseModel):
    """
    AiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo
    """ # noqa: E501
    ...
    include_pages: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"*array of pages to include in the response*. optional field. if specified, only the listed pages will be returned in the `items` array. example:. `'include_pages': ['https://example.page/']`")
    exclude_pages: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"*array of pages to exclude from the response*. optional field. if specified, the listed pages will be omitted from the `items` array. example:. `'exclude_pages': ['https://example.page/']`")
