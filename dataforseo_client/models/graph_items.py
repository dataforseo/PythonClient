...
class GraphItems(BaseModel):
    ...
    value: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="point value on graph")
    volume: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="volume value on graph")
    __properties: ClassVar[List[str]] = ["timestamp", "value", "volume"]
