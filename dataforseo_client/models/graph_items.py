...
class GraphItems(BaseModel):
    ...
    value: Optional[StrictFloat] = Field(default=None, description="point value on graph")
    volume: Optional[StrictFloat] = Field(default=None, description="volume value on graph")
