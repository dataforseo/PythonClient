...
class QueriesListDataInfo(BaseModel):
    ...
    QueriesListDataInfo
    """ # noqa: E501
    top: Optional[List[Optional[QueriesListDataItemInfo]]] = Field(default=None, description="the most popular related topics. represents the list of the most popular related topics")
    rising: Optional[List[Optional[QueriesListDataItemInfo]]] = Field(default=None, description="emerging related topics. represents the list of related topics with the biggest increase in search frequency since the last time period")
