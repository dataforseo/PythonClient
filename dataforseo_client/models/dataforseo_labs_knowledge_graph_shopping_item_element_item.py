...
class DataforseoLabsKnowledgeGraphShoppingItemElementItem(BaseDataforseoLabsKnowledgeGraphElementItem):
    """
    ...
    items: Optional[List[Optional[KnowledgeGraphShoppingElement]]] = Field(default=None, description="additional items present in the element. if there are none, equals null")
