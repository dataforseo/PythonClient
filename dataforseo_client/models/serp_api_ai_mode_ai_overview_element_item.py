...
class SerpApiAiModeAiOverviewElementItem(BaseSerpApiAiModeAiOverviewElementItem):
    ...
    links: Optional[List[Optional[AiModeLinkElementInfo]]] = Field(default=None, description=r"*website links featured in the element*. if there are none, equals `null`")
