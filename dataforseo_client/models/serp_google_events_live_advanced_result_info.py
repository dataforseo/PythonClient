...
class SerpGoogleEventsLiveAdvancedResultInfo(BaseModel):
    ...
    se_results_count: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="total number of results in SERP in this case, the value will be 0 this search engine does not indicate the total number of results")
