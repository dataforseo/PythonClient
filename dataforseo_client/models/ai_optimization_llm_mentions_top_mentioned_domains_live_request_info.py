...
class AiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo(BaseModel):
    """
    ...
    include_domains: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"*array of domains to include in the response*. optional field. if specified, only the listed domains will be returned in the `items` array. example:. `'include_domains': ['en.wikipedia.org']`")
    exclude_domains: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"*array of domains to exclude from the response*. optional field. if specified, the listed domains will be omitted from the `items` array. example:. `'exclude_domains': ['en.wikipedia.org']`")
