...
class DataforseoLabsGoogleBulkKeywordDifficultyLiveResultInfo(BaseModel):
    ...
    items: Optional[List[Optional[DataforseoLabsBulkKeywordDifficultyLiveItem]]] = Field(default=None, description="contains keywords and related keyword difficulty scores")
