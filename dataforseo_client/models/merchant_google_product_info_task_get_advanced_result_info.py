...
from dataforseo_client.models.product_info_element import ProductInfoElement
...
class MerchantGoogleProductInfoTaskGetAdvancedResultInfo(BaseModel):
    ...
    items: Optional[List[Optional[ProductInfoElement]]] = Field(default=None, description="items on the product page. contains all product attributes and related data listed on the product page")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [ProductInfoElement.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
        })
