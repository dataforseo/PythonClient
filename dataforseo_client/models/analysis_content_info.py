...
class AnalysisContentInfo(BaseModel):
    ...
    AnalysisContentInfo
    """ # noqa: E501
    content_type: Optional[StrictStr] = Field(default=None, description=r"*type of content*. example:. `page_content`, `comment`")
    title: Optional[StrictStr] = Field(default=None, description=r"*title of the result*")
    main_title: Optional[StrictStr] = Field(default=None, description=r"*page title*")
    previous_title: Optional[StrictStr] = Field(default=None, description=r"*title of the previous content block*")
    level: Optional[StrictInt] = Field(default=None, description=r"*`title` heading level*. indicates h-tag level from `1` (top) to `6` (bottom)")
    author: Optional[StrictStr] = Field(default=None, description=r"*author of the content*")
    snippet: Optional[StrictStr] = Field(default=None, description=r"*content snippet*")
    snippet_length: Optional[StrictInt] = Field(default=None, description=r"*character length of the snippet*")
    ...
    highlighted_text: Optional[StrictStr] = Field(default=None, description=r"*highlighted text from the `snippet`*")
    language: Optional[StrictStr] = Field(default=None, description=r"*main language of the domain*. to obtain a full list of available languages, refer to the [Languages](/v3/content_analysis/languages/) endpoint")
    sentiment_connotations: Optional[Dict[str, Optional[StrictInt]]] = Field(default=None, description=r"*sentiment connotations*. contains sentiments (emotional reactions) related to the given citation and probability index per each sentiment. possible sentiment connotations: `anger`, `happiness`, `love`, `sadness`, `share`, `fun`")
    connotation_types: Optional[Dict[str, Optional[StrictInt]]] = Field(default=None, description=r"*connotation types*. contains types of sentiments (sentiment polarity) related to the given citation and probability index per each sentiment type. possible sentiment connotation types: `positive`, `negative`, `neutral`")
    text_category: Optional[List[Optional[StrictInt]]] = Field(default=None, description=r"*text category*. to obtain a full list of available categories, refer to the [Categories](/v3/content_analysis/categories/) endpoint")
