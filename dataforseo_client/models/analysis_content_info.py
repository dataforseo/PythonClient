...
class AnalysisContentInfo(BaseModel):
    ...
    language: Optional[StrictStr] = Field(default=None, description=r"main language of the domain. to obtain a full list of available languages, refer to the Languages endpoint")
    ...
    text_category: Optional[List[Optional[StrictInt]]] = Field(default=None, description=r"text category. to obtain a full list of available categories, refer to the Categories endpoint")
