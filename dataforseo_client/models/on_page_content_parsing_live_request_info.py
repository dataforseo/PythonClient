...
class OnPageContentParsingLiveRequestInfo(BaseModel):
    ...
    """ # noqa: E501
    url: Optional[StrictStr] = Field(default=None, description=r"*URL of the content to parse*. **required field**. URL of the page to parse. example:. `https://www.fujielectric.com/`")
    ...
    store_raw_html: Optional[StrictBool] = Field(default=None, description=r"*store HTML of a crawled page*. optional field. set to `true` if you want to get the HTML of the page using the [OnPage Raw HTML endpoint](/v3/on_page/raw_html/). default value: `false`")
    ...
    markdown_view: Optional[StrictBool] = Field(default=None, description=r"*return page content as markdown*. optional field. if set to `true`, the markdown-formatted content of the page will be returned in the `page_as_markdown` field of the response;. default value: `false`")
