...
class MapsSearch(BaseModel):
    ...
    rank_group: Optional[StrictInt] = Field(default=None, description=r"*position within a group of elements with identical `type` values*. positions of elements with different `type` values are omitted from the `rank_group`")
    ...
    total_photos: Optional[StrictStr] = Field(default=None, description=r"*total count of images featured in Google My Business profile*")
    ...
    work_hours: Optional[BusinessWorkHoursInfo] = Field(default=None, description=r"*open hours*. information about work hours of the local establishment")
    ...
    local_justifications: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"*Google local justifications*. snippets of text that “justify” why the business is showing up for search query")
