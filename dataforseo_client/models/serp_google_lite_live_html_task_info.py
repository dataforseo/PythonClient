...
from dataforseo_client.models.serp_google_lite_live_html_result_info import SerpGoogleLiteLiveHtmlResultInfo
from dataforseo_client.models.base_response_task_info import BaseResponseTaskInfo



class SerpGoogleLiteLiveHtmlTaskInfo(BaseModel):
    """
    SerpGoogleLiteLiveHtmlTaskInfo
    """ # noqa: E501
    ...
    result: Optional[List[Optional[SerpGoogleLiteLiveHtmlResultInfo]]] = Field(default=None, description=r"array of results")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "path": obj.get("path"),
            "data": obj.get("data"),
            "result": [SerpGoogleLiteLiveHtmlResultInfo.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None,
        })
