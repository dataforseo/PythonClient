...
class AppendixDataInfo(BaseModel):
    ...
    traffic_analytics: Optional[AppendixSerpDaysRatesDataInfo] = None
    total_reviews: Optional[Union[StrictFloat, StrictInt]] = None
    reviews: Optional[AppendixSerpDaysRatesDataInfo] = None
    total_social: Optional[Union[StrictFloat, StrictInt]] = None
    social: Optional[AppendixSerpDaysRatesDataInfo] = None
