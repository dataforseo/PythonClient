...
class ContentAnalysisCategoryTrendsLiveResultInfo(BaseModel):
    ...
    rank: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="rank of all URLs citing the keyword normalized sum of ranks of all URLs citing the target keyword for the given date")
    top_domains: Optional[List[TopDomainCountInfo]] = Field(default=None, description="top domains citing the target keyword contains objects with top domains citing the target category and citation count per each domain")
