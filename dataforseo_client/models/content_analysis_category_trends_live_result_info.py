...
class ContentAnalysisCategoryTrendsLiveResultInfo(BaseModel):
    ...
    top_domains: Optional[List[Optional[TopDomainInfo]]] = Field(default=None, description="top domains citing the target keyword. contains objects with top domains citing the target category and citation count per each domain")
