...
class DataforseoLabsBingBulkTrafficEstimationLiveResultInfo(BaseModel):
    ...
    items: Optional[List[Optional[DataforseoLabsBingBulkTrafficEstimationLiveItem]]] = Field(default=None, description="array of items with relevant traffic estimation data")
