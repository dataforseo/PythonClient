...
class AiOptimizationGeminiLlmScraperLiveAdvancedResultInfo(BaseModel):
    """
    ...
    items: Optional[List[Optional[BaseGeminiLlmScraperElementItem]]] = Field(default=None, description=r"elements of Gemini results")
