...
class SerpGoogleJobsTaskPostRequestInfo(BaseModel):
    ...
    employment_type: Optional[List[Optional[StrictStr]]] = Field(default=None, description="employment contract type. optional field. type of employment contract for which the search results will be returned;. possible values:. fulltime, partime, contractor, intern")
