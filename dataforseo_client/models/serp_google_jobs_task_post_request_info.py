...
class SerpGoogleJobsTaskPostRequestInfo(BaseModel):
    ...
    location_radius: Optional[StrictStr] = Field(default=None, description=r"location search radiusoptional fieldlocation search radius in kilometers;Note: for countries that use the imperial system of units, you will need to convert miles to kilometers by multiplying the value in miles by 1.609;if value is not specified, search is executed anywhere within the specified location;maximal value: 300minimal value: > 0")
    employment_type: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"employment contract typeoptional fieldtype of employment contract for which the search results will be returned;possible values:fulltime, partime, contractor, intern")
