...
class ItemsGoogleBusinessInfo(BaseModel):
    ...
    hotel_rating: Optional[StrictStr] = Field(default=None, description=r"*hotel class rating*. class ratings range between 1-5 stars, [learn more](https://support.google.com/business/answer/7660515?hl=en). if there is no hotel class rating information, the value will be `null`")
    ...
    popular_times: Optional[Any] = Field(default=None, description=r"*popular times*. information related to busy hours of the business entity")
