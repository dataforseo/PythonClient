...
class ProductInfoElement(BaseModel):
    ...
    product_id: Optional[StrictStr] = Field(default=None, description=r"*product_id received in a POST array*. ilearn more about the parameter in [this help center guide](https://dataforseo.com/help-center/product-id-google-shopping)")
