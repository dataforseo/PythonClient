...
class CommercialUnitsSerpElementItem(BaseSerpApiElementItem):
    """
    ...
    items: Optional[List[Optional[CommercialUnitsElement]]] = Field(default=None, description=r"contains arrays of elements available in the list")
