...
class BaseBusinessDataSerpElementItem(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[GoogleBusinessInfoBusinessDataSerpElementItem, GoogleBusinessPostBusinessDataSerpElementItem, GoogleReviewsSearchBusinessDataSerpElementItem, MapsSearchBusinessDataSerpElementItem, TripadvisorReviewSearchBusinessDataSerpElementItem, TripadvisorSearchOrganicBusinessDataSerpElementItem, TrustpilotReviewSearchBusinessDataSerpElementItem, TrustpilotSearchOrganicBusinessDataSerpElementItem, YelpReviewsSearchBusinessDataSerpElementItem, YelpSearchOrganicBusinessDataSerpElementItem, YelpSearchPaidBusinessDataSerpElementItem]]:
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[GoogleBusinessInfoBusinessDataSerpElementItem, GoogleBusinessPostBusinessDataSerpElementItem, GoogleReviewsSearchBusinessDataSerpElementItem, MapsSearchBusinessDataSerpElementItem, TripadvisorReviewSearchBusinessDataSerpElementItem, TripadvisorSearchOrganicBusinessDataSerpElementItem, TrustpilotReviewSearchBusinessDataSerpElementItem, TrustpilotSearchOrganicBusinessDataSerpElementItem, YelpReviewsSearchBusinessDataSerpElementItem, YelpSearchOrganicBusinessDataSerpElementItem, YelpSearchPaidBusinessDataSerpElementItem]]:
        ...
        if object_type ==  'google_business_info':
        ...
        if object_type ==  'google_business_post':
        ...
        if object_type ==  'google_reviews_search':
        ...
        if object_type ==  'tripadvisor_review_search':
        ...
        if object_type ==  'tripadvisor_search_organic':
        ...
        if object_type ==  'trustpilot_review_search':
        ...
        if object_type ==  'trustpilot_search_organic':
        ...
        if object_type ==  'yelp_reviews_search':
            return import_module("dataforseo_client.models.yelp_reviews_search_business_data_serp_element_item").YelpReviewsSearchBusinessDataSerpElementItem.from_dict(obj)
        if object_type ==  'yelp_search_organic':
            return import_module("dataforseo_client.models.yelp_search_organic_business_data_serp_element_item").YelpSearchOrganicBusinessDataSerpElementItem.from_dict(obj)
        if object_type ==  'yelp_search_paid':
            return import_module("dataforseo_client.models.yelp_search_paid_business_data_serp_element_item").YelpSearchPaidBusinessDataSerpElementItem.from_dict(obj)
