...
class DataforseoLabsGoogleKeywordsForSiteLiveRequestInfo(BaseModel):
    ...
    """ # noqa: E501
    target: Optional[StrictStr] = Field(default=None, description="target domain required field the domain name of the target website the domain should be specified without https:// or www.")
    ...
    __properties: ClassVar[List[str]] = ["target", "location_name", "location_code", "language_name", "language_code", "include_serp_info", "include_subdomains", "ignore_synonyms", "limit", "offset", "offset_token", "filters", "order_by", "tag"]
