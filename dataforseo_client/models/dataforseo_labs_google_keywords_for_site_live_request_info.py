...
class DataforseoLabsGoogleKeywordsForSiteLiveRequestInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["target", "location_name", "location_code", "language_name", "language_code", "include_serp_info", "include_subdomains", "include_clickstream_data", "limit", "offset", "offset_token", "filters", "order_by", "tag"]
