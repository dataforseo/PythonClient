...
class PeopleAlsoAskSerpElementItem(BaseSerpApiElementItem):
    """
    ...
    items: Optional[List[Optional[PeopleAlsoAskElement]]] = Field(default=None, description=r"contains arrays of elements available in the list")
