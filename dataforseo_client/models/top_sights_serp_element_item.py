...
class TopSightsSerpElementItem(BaseSerpApiElementItem):
    """
    ...
    items: Optional[List[Optional[TopSightsElement]]] = Field(default=None, description=r"contains arrays of elements available in the list")
