...
class OnPageLighthouseLiveJsonTaskInfo(BaseModel):
    ...
    result: Optional[List[Optional[Dict[str, Optional[Any]]]]] = Field(default=None, description=r"*results of Lighthouse audit*. this array will include data according to the parameters you specified when setting a task;. all fields and their descriptions are available in the official documentation [by this link.](https://github.com/GoogleChrome/lighthouse/blob/master/readme.md)")
