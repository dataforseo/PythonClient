...
class BacklinksDomainIntersection(BaseModel):
    ...
    backlinks_spam_score: Optional[StrictInt] = Field(default=None, description=r"*average spam score of the backlinks pointing to the `target`*. learn more about how the metric is calculated on [this help center page](https://dataforseo.com/help-center/what-is-spam-score-and-how-is-it-calculated)")
    broken_backlinks: Optional[StrictInt] = Field(default=None, description=r"*number of broken backlinks*")
    broken_pages: Optional[StrictInt] = Field(default=None, description=r"*number of broken pages*")
    referring_domains: Optional[StrictInt] = Field(default=None, description=r"*number of referring domains*")
    referring_domains_nofollow: Optional[StrictInt] = Field(default=None, description=r"*number of domains pointing at least one nofollow link to the corresponding target*")
    ...
    referring_ips: Optional[StrictInt] = Field(default=None, description=r"*number of referring IP addresses*")
    ...
    referring_links_types: Optional[Dict[str, Optional[StrictInt]]] = Field(default=None, description=r"*types of the referring links*. indicates the types of referring links and link count per each type. possible values:. `anchor`, `image`, `link`, `meta`, `canonical`, `alternate`, `redirect`")
    referring_links_attributes: Optional[Dict[str, Optional[StrictInt]]] = Field(default=None, description=r"*link attributes of the referring links*. indicates link attributes of the referring links and the link count per each attribute")
    ...
    referring_links_countries: Optional[Any] = Field(default=None, description=r"*ISO country codes of the referring links*. indicates ISO country codes of the domains where the referring links are located and the link count per each country")
