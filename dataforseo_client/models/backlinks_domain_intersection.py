...
class BacklinksDomainIntersection(BaseModel):
    ...
    referring_links_platform_types: Optional[Dict[str, Optional[StrictInt]]] = Field(default=None, description="types of referring platforms. indicates referring platform types and link count per each platform. possible values: cms, blogs, ecommerce, message-boards, wikis, news, organization")
    ...
    referring_links_countries: Optional[Any] = Field(default=None, description="ISO country codes of the referring links. indicates ISO country codes of the domains where the referring links are located and the link count per each country")
