...
class BacklinksDomainIntersection(BaseModel):
    ...
    backlinks: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="indicates the number of backlinks")
    ...
    backlinks_spam_score: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="average spam score of the backlinks pointing to the target learn more about how the metric is calculated on this help center page")
    broken_backlinks: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="number of broken backlinks")
    broken_pages: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="number of broken pages")
    referring_domains: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="number of referring domains")
    referring_domains_nofollow: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="number of domains pointing at least one nofollow link to the corresponding target")
    referring_main_domains: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="number of referring main domains")
    ...
    referring_ips: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="number of referring IP addresses")
    referring_subnets: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="number of referring subnetworks")
    referring_pages: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="indicates the number of pages pointing to the target")
    referring_pages_nofollow: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="number of referring pages pointing at least one nofollow link to the target")
    referring_links_tld: Optional[Dict[str, Optional[Union[StrictFloat, StrictInt]]]] = Field(default=None, description="top level domains of the referring links contains top-level domains and referring link count per each")
    referring_links_types: Optional[Dict[str, Optional[Union[StrictFloat, StrictInt]]]] = Field(default=None, description="types of the referring links indicates the types of referring links and link count per each type possible values: anchor, image, link, meta, canonical, alternate, redirect")
    referring_links_attributes: Optional[Dict[str, Optional[Union[StrictFloat, StrictInt]]]] = Field(default=None, description="link attributes of the referring links indicates link attributes of the referring links and the link count per each attribute")
    referring_links_platform_types: Optional[Dict[str, Optional[Union[StrictFloat, StrictInt]]]] = Field(default=None, description="types of referring platforms indicates referring platform types and link count per each platform possible values: cms, blogs, ecommerce, message-boards, wikis, news, organization")
    referring_links_semantic_locations: Optional[Dict[str, Optional[Union[StrictFloat, StrictInt]]]] = Field(default=None, description="semantic locations of the referring links indicates semantic elements in HTML where the referring links are located and the link count per each semantic location you can get the full list of semantic elements here")
    referring_links_countries: Optional[Dict[str, Any]] = Field(default=None, description="ISO country codes of the referring links indicates ISO country codes of the domains where the referring links are located and the link count per each country")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BacklinksDomainIntersection from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BacklinksDomainIntersection from a dict"""
        if obj is None:
            return None
