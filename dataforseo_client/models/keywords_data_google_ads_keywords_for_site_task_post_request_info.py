...
class KeywordsDataGoogleAdsKeywordsForSiteTaskPostRequestInfo(BaseModel):
    ...
    target_type: Optional[StrictStr] = Field(default=None, description=r"*search keywords for site or url*. optional field. possible values: `site`, `page`;. default value: `page`. if set to `site`, keywords will be provided for the entire site;. if set to `page`, keywords will be provided for the specified webpage")
