...
class BingImagesSerpElementItem(BaseBingSerpApiElementItem):
    """
    ...
    items: Optional[List[Optional[AiModeImagesElementInfo]]] = Field(default=None, description=r"additional items present in the element. if there are none, equals null")
