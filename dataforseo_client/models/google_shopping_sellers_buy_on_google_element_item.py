...
class GoogleShoppingSellersBuyOnGoogleElementItem(BaseMerchantGoogleShoppingSellersElementItem):
    """
    ...
    url: Optional[StrictStr] = Field(default=None, description=r"*Google Shopping URL forwarding to the product page on the seller’s website*. if you want to obtain a URL of the advertisement forwarding to the product page on the seller's website, please refer to the [Google Shopping Sellers Ad URL](/v3/merchant/google/sellers/ad_url/) endpoint")
    details: Optional[StrictStr] = Field(default=None, description=r"*details and special offers*. if there are no details, the value will be `null`")
    base_price: Optional[StrictFloat] = Field(default=None, description=r"*product price without tax and shipping*")
    tax: Optional[StrictFloat] = Field(default=None, description=r"*the amount of tax*. tax is specified as the actual amount of money, not as the percentage")
    shipping_price: Optional[StrictFloat] = Field(default=None, description=r"*product shipping price*")
