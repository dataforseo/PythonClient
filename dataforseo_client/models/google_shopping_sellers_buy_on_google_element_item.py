...
class GoogleShoppingSellersBuyOnGoogleElementItem(BaseMerchantGoogleShoppingSellersElementItem):
    ...
    url: Optional[StrictStr] = Field(default=None, description=r"Google Shopping URL forwarding to the product page on the seller’s website. if you want to obtain a URL of the advertisement forwarding to the product page on the seller’s website, please refer to the Google Shopping Sellers Ad URL endpoint")
