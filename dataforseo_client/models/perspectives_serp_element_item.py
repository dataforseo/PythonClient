...
class PerspectivesSerpElementItem(BaseSerpApiElementItem):
    """
    ...
    items: Optional[List[Optional[PerspectivesElement]]] = Field(default=None, description=r"contains arrays of elements available in the list")
