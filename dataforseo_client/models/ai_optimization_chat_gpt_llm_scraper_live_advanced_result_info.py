...
class AiOptimizationChatGptLlmScraperLiveAdvancedResultInfo(BaseModel):
    """
    ...
    item_types: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"types of search results. contains types of search results (items) found in SERP.. possible item types:. chat_gpt_text, chat_gpt_table, chat_gpt_navigation_list, chat_gpt_images, chat_gpt_local_businesses, chat_gpt_products")
    items_count: Optional[StrictInt] = Field(default=None, description=r"the number of results returned in the items array")
    items: Optional[List[Optional[BaseChatGptLlmScraperElementItem]]] = Field(default=None, description=r"elements of ChatGPT results")
