...
class DomainAnalyticsTechnologiesAggregationTechnologiesLiveRequestInfo(BaseModel):
    ...
    technology: Optional[StrictStr] = Field(default=None, description=r"target technology. required field if you don’t specify group, keyword or category. at least one field (group, category, keyword, technology) must be set. you can find the full list of technologies on this page. example:. 'Salesforce'")
