...
class DomainAnalyticsTechnologiesAggregationTechnologiesLiveRequestInfo(BaseModel):
    ...
    """ # noqa: E501
    group: Optional[StrictStr] = Field(default=None, description="id of the target technology group required field if you don’t specify technology or category at least one field (group, category, technology) must be set you can find the full list of technology group ids on this page example: \"marketing\"")
    category: Optional[StrictStr] = Field(default=None, description="id of the target technology category required field if you don’t specify group or technology at least one field (group, category, technology) must be set you can find the full list of technology category ids on this page example: \"crm\"")
    technology: Optional[StrictStr] = Field(default=None, description="target technology required field if you don’t specify group or category at least one field (group, category, technology) must be set you can find the full list of technologies on this page example: \"Salesforce\"")
