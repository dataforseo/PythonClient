...
class AiOptimizationChatGptLlmResponsesTasksReadyResultInfo(BaseModel):
    """
    ...
    se: Optional[StrictStr] = Field(default=None, description="LLM model specified when setting the task")
