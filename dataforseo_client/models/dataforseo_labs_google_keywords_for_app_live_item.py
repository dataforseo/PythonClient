...
class DataforseoLabsGoogleKeywordsForAppLiveItem(BaseModel):
    ...
    ranked_serp_element: Optional[GooglePlayRankedSerpElementInfo] = Field(default=None, description="contains data on the domain’s SERP element found for the returned keyword")
