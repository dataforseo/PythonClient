...
class BingVideoSerpElementItem(BaseBingSerpApiElementItem):
    """
    ...
    items: Optional[List[Optional[VideoElement]]] = Field(default=None, description=r"additional items present in the element. if there are none, equals null")
