...
class AiModeReferences(BaseModel):
    """
    AiModeReferences
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="type of element")
    rank_group: Optional[Union[StrictFloat, StrictInt]] = None
    rank_absolute: Optional[Union[StrictFloat, StrictInt]] = None
    ...
    __properties: ClassVar[List[str]] = ["type", "rank_group", "rank_absolute", "position", "source", "domain", "url", "title", "text"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AiModeReferences from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AiModeReferences from a dict"""
        if obj is None:
            return None
