...
class AiOptimizationLlmMentionsTopMentionedBrandCategoriesLiteLiveRequestInfo(BaseModel):
    """
    AiOptimizationLlmMentionsTopMentionedBrandCategoriesLiteLiveRequestInfo
    """ # noqa: E501
    ...
    platform: Optional[StrictStr] = Field(default=None, description=r"*target platform*. optional field. possible values:. `chat_gpt`, `google`. default value: `google`. **Note:** data specific to brand entities is available for `chat_gpt` only;. **Note #2:**`chat_gpt` data is available for the `United States` and `English` only")
    ...
    include_brand_categories: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"*array of brand categories to include in the response*. optional field. if specified, only the listed brand categories will be returned in the `items` array. example:. `['company','insurance']`")
    exclude_brand_categories: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"*array of brand categories to exclude from the response*. optional field. if specified, the listed brand categories will be omitted from the `items` array. example:. `['company','insurance']`")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        _dict['include_brand_categories'] = self.include_brand_categories
        _dict['exclude_brand_categories'] = self.exclude_brand_categories
        _dict['tag'] = self.tag
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "include_brand_categories": obj.get("include_brand_categories"),
            "exclude_brand_categories": obj.get("exclude_brand_categories"),
            "tag": obj.get("tag"),
        })
