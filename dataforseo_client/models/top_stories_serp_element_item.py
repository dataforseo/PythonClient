...
class TopStoriesSerpElementItem(BaseSerpApiElementItem):
    """
    ...
    items: Optional[List[Optional[TopStoriesElement]]] = Field(default=None, description=r"contains arrays of elements available in the list")
