...
class KeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo(BaseModel):
    ...
    sort_by: Optional[StrictStr] = Field(default=None, description=r"results sorting parameters. optional field. Use these parameters to sort the results by relevance, average_cpc, cost, or clicks in the descending order. default value: relevance")
