...
class KeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo(BaseModel):
    ...
    bid: Optional[StrictFloat] = Field(default=None, description="the maximum custom bid. required field. the collected data will be based on this value. it stands for the price you are willing to pay for an ad; the higher value you specify here, the higher values you will get in the returned metrics. learn more in this help center article")
