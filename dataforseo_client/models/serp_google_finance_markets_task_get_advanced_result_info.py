...
class SerpGoogleFinanceMarketsTaskGetAdvancedResultInfo(BaseModel):
    ...
    items: Optional[List[BaseGoogleFinanceSerpElementItem]] = Field(default=None, description="market indexes related to the market trends element possible type of items: google_finance_asset_pair_element, google_finance_market_instrument_element, google_finance_market_index_element")
