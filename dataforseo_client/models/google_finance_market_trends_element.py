...
class GoogleFinanceMarketTrendsElement(BaseModel):
    ...
    quote: Optional[GoogleFinanceAssetPairElement] = None
    news: Optional[List[GoogleFinanceNewsElement]] = Field(default=None, description="array of items array contains the following type of items: google_finance_news_element")
    __properties: ClassVar[List[str]] = ["type", "quote", "news"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if news (nullable) is None
        # and model_fields_set contains the field
        if self.news is None and "news" in self.model_fields_set:
            _dict['news'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "quote": GoogleFinanceAssetPairElement.from_dict(obj["quote"]) if obj.get("quote") is not None else None,
