...
class AiOptimizationLlmMentionsTopMentionedBrandsLiveItem(BaseModel):
    """
    AiOptimizationLlmMentionsTopMentionedBrandsLiveItem
    """ # noqa: E501
    brand: Optional[StrictStr] = Field(default=None, description=r"brand name. name of the brand found in LLM mentions for the specified target")
