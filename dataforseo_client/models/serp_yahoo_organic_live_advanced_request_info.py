...
class SerpYahooOrganicLiveAdvancedRequestInfo(BaseModel):
    ...
    depth: Optional[StrictInt] = Field(default=None, description=r"*parsing depth*. optional field. number of results in SERP. default value: `6`. max value: `200`. **Your account will be billed per each SERP;** . Each Yahoo SERP can contain fewer than 10 results, so setting depth above the default value may result in additional charges [](https://dataforseo.com/help-center/how-many-results-scraped);. The cost can be calculated on the [Pricing](https://dataforseo.com/pricing/serp/yahoo-serp-api) page.")
    ...
    search_param: Optional[StrictStr] = Field(default=None, description=r"*additional parameters of the search query*. optional field. [get the list of available parameters and additional details here](https://dataforseo.com/help-center/yahoo-search-engine-parameters-and-how-to-use-them)")
