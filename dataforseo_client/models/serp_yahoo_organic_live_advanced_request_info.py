...
class SerpYahooOrganicLiveAdvancedRequestInfo(BaseModel):
    ...
    depth: Optional[StrictInt] = Field(default=None, description=r"parsing depth. optional field. number of results in SERP. default value: 6. max value: 200. Your account will be billed per each SERP;. Each Yahoo SERP can contain fewer than 10 results, so setting depth above the default value may result in additional charges ;. The cost can be calculated on the Pricing page.")
