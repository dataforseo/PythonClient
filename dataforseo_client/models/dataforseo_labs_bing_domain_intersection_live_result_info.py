...
class DataforseoLabsBingDomainIntersectionLiveResultInfo(BaseModel):
    ...
    target_1: Optional[StrictStr] = Field(default=None, description="target specified in a POST array")
    target_2: Optional[StrictStr] = Field(default=None, description="target specified in a POST array")
