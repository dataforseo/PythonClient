...
class GoogleExtendedReviewsSearch(BaseModel):
    ...
    xpath: Optional[StrictStr] = Field(default=None, description=r"*the [XPath](https://en.wikipedia.org/wiki/XPath) of the review*")
    ...
    profile_url: Optional[StrictStr] = Field(default=None, description=r"*URL of the reviewer's profile*")
    review_url: Optional[StrictStr] = Field(default=None, description=r"*the URL of the review*")
    profile_image_url: Optional[StrictStr] = Field(default=None, description=r"*URL of the reviewer's profile image*")
    owner_answer: Optional[StrictStr] = Field(default=None, description=r"*text of the owner's response*. the owner's response to the review")
    original_owner_answer: Optional[StrictStr] = Field(default=None, description=r"*original text of the owner's response*. the original response to the review, no auto-translate applied")
    owner_time_ago: Optional[StrictStr] = Field(default=None, description=r"*publication time*. indicates the time (in the 'time ago' format) when the owner submitted the response to the review")
    owner_timestamp: Optional[StrictStr] = Field(default=None, description=r"*date and time of the owner's reply to the review*. in the UTC format: “yyyy-mm-dd hh-mm-ss +00:00”. example:. `2019-11-15 12:57:46 +00:00`")
    review_id: Optional[StrictStr] = Field(default=None, description=r"*the unique identifier of a review on Google*. example:. `ChZDSUhNMG9nS0VJQ0FnSUMxbHFyMFlnEAE`")
    images: Optional[List[Optional[AiModeImagesElementInfo]]] = Field(default=None, description=r"*images submitted by the reviewer*")
    review_highlights: Optional[List[Optional[ReviewHighlights]]] = Field(default=None, description=r"*review highlights*. contains highlighted review criteria and assessments")
    source: Optional[Source] = Field(default=None, description=r"*source of the review*. contains information about the source where the review was posted")
