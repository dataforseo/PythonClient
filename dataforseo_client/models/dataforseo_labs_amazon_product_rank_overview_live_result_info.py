...
class DataforseoLabsAmazonProductRankOverviewLiveResultInfo(BaseModel):
    ...
    items: Optional[List[Optional[DataforseoLabsAmazonProductRankOverviewLiveItem]]] = Field(default=None, description="contains detected Amazon product competitors and related data")
