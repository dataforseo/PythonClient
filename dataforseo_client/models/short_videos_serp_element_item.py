...
class ShortVideosSerpElementItem(BaseSerpApiElementItem):
    """
    ...
    items: Optional[List[Optional[ShortVideosElement]]] = Field(default=None, description=r"contains arrays of elements available in the list")
