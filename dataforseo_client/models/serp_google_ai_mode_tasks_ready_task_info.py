...
class SerpGoogleAiModeTasksReadyTaskInfo(BaseModel):
    ...
    result: Optional[List[SerpGoogleAiModeTasksReadyResultInfo]] = Field(default=None, description="array of results")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SerpGoogleAiModeTasksReadyTaskInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SerpGoogleAiModeTasksReadyTaskInfo from a dict"""
        if obj is None:
            return None
