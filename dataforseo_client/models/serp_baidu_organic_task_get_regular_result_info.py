...
class SerpBaiduOrganicTaskGetRegularResultInfo(BaseModel):
    ...
    item_types: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"*types of search results found in SERP*. contains types of all search results (`items`) found in the returned SERP. possible item types:. `organic`, `paid`")
    ...
    items: Optional[List[Optional[BaseSerpApiElementItem]]] = Field(default=None, description=r"*elements of search results found in SERP*")
