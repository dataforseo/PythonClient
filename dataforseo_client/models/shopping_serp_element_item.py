...
class ShoppingSerpElementItem(BaseSerpApiElementItem):
    """
    ...
    items: Optional[List[Optional[ShoppingElement]]] = Field(default=None, description=r"contains arrays of elements available in the list")
