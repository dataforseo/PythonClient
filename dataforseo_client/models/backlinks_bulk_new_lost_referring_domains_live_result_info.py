...
class BacklinksBulkNewLostReferringDomainsLiveResultInfo(BaseModel):
    ...
    items: Optional[List[Optional[BacklinksBulkNewLostReferringDomainsLiveItem]]] = Field(default=None, description="contains relevant backlinks and referring domains data")
