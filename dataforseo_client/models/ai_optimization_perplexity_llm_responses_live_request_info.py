...
class AiOptimizationPerplexityLlmResponsesLiveRequestInfo(BaseModel):
    ...
    max_output_tokens: Optional[StrictInt] = Field(default=None, description=r"maximum number of tokens in the AI response. optional field. minimum value: 1. maximum value: 2048. default value: 2048")
    temperature: Optional[StrictFloat] = Field(default=None, description=r"randomness of the AI response. optional field. higher values make output more diverse. lower values make output more focused. minimum value: 0. maximum value: 1.9. default value: 0.77")
    ...
    web_search_country_iso_code: Optional[StrictStr] = Field(default=None, description=r"country code for web search localization. optional field. specify the country  ISO code to get localized web search results. Note: available only for Perplexity Sonar models. example: US")
