...
class OnPageUncrawlableResourcesItem(BaseModel):
    ...
    reason: Optional[StrictStr] = Field(default=None, description=r"reason the resource is uncrawlablecan take the following values: content_type_inconsistency")
    status_code: Optional[StrictInt] = Field(default=None, description=r"HTTP response code returned by the uncrawlable resourcepossible values: 200")
    fetch_time: Optional[StrictStr] = Field(default=None, description=r"date and time when the resource was fetchedin the UTC format: “yyyy-mm-dd hh-mm-ss +00:00”example:2026-03-09 18:20:32 +00:00")
