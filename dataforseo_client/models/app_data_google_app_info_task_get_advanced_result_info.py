...
from dataforseo_client.models.google_play_info_organic import GooglePlayInfoOrganic
...
class AppDataGoogleAppInfoTaskGetAdvancedResultInfo(BaseModel):
    ...
    items: Optional[List[Optional[GooglePlayInfoOrganic]]] = Field(default=None, description=r"*found app info*")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [GooglePlayInfoOrganic.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
        })
