...
class DataLabsHotelsPackSerpElementItem(BaseDataforseoLabsApiElementItem):
    """
    ...
    items: Optional[List[Optional[HotelsPackElement]]] = Field(default=None, description="elements of search results found in SERP")
