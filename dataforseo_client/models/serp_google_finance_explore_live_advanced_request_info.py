...
class SerpGoogleFinanceExploreLiveAdvancedRequestInfo(BaseModel):
    ...
    news_type: Optional[StrictStr] = Field(default=None, description=r"financial news filtersoptional fieldpossible values: top_stories, local_market, world_marketsdefault value: top_storiesNote: if you specify local_market or world_markets, the charge per task will be multiplied by 2")
