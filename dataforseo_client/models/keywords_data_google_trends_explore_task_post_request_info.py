...
class KeywordsDataGoogleTrendsExploreTaskPostRequestInfo(BaseModel):
    ...
    item_types: Optional[List[StrictStr]] = Field(default=None, description="types of items returned optional field to speed up the execution of the request, specify one item at a time; possible values: \"item_types\": [ \"google_trends_graph\", \"google_trends_map\", \"google_trends_topics_list\", \"google_trends_queries_list\" ] default value: \"item_types\": [ \"google_trends_graph\" ]")
