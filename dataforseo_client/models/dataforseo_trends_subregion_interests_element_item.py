...
class DataforseoTrendsSubregionInterestsElementItem(BaseKeywordDataDataforseoTrendsItem):
    """
    ...
    interests: Optional[List[Optional[DataforseoTrendsinterestsInfo]]] = Field(default=None, description="subregional keyword popuarity data for each specified term")
    interests_comparison: Optional[InterestsComparison] = Field(default=None, description="comparison of data on subregional keyword popularity for the specified parameters. if you specified a single keyword, the value will be null")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if self.interests:
            for _item in self.interests:
                if _item:
                    interests_items.append(_item.to_dict())
            _dict['interests'] = interests_items
        _dict['interests_comparison'] = self.interests_comparison.to_dict() if self.interests_comparison else None
        return _dict
