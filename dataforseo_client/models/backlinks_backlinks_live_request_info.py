...
class BacklinksBacklinksLiveRequestInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["target", "mode", "custom_mode", "field", "value", "filters", "order_by", "offset", "search_after_token", "limit", "backlinks_status_type", "include_subdomains", "include_indirect_links", "exclude_internal_backlinks", "rank_scale", "tag"]
