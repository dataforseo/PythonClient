...
class AiModeAiOverviewReference(BaseModel):
    """
    AiModeAiOverviewReference
    """ # noqa: E501
    ...
    url: Optional[StrictStr] = Field(default=None, description="link URL")
    ...
    __properties: ClassVar[List[str]] = ["type", "position", "source", "domain", "url", "title", "text"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AiModeAiOverviewReference from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AiModeAiOverviewReference from a dict"""
        if obj is None:
            return None
