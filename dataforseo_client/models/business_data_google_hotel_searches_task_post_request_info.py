...
class BusinessDataGoogleHotelSearchesTaskPostRequestInfo(BaseModel):
    ...
    depth: Optional[StrictInt] = Field(default=None, description=r"parsing depth. optional field. number of results in Google Hotels. default value: 18 organic results. max value: 140. Note: your account will be billed per each 18 organic results regardless of paid listings in the response;. thus, setting a depth above 18 may result in additional charges if Google Hotels return more than 18 results;. if the specified depth is higher than the number of results in the response, the difference will be refunded automatically to your account balance")
    check_in: Optional[StrictStr] = Field(default=None, description=r"check-in date. optional field. if you don’t specify this field, tomorrow’s date will be used by default;. date format: 'yyyy-mm-dd'. example:. '2019-01-15'. Note: the value cannot precede the today’s date")
    check_out: Optional[StrictStr] = Field(default=None, description=r"check-out date. optional field. if you don’t specify this field, our system will apply the date of two days from now by default;. date format: 'yyyy-mm-dd'. example:. '2019-01-15'. Note: the value cannot be less than or equal to check_in;. the range between check_in and check_out values cannot exceed 30 days")
    currency: Optional[StrictStr] = Field(default=None, description=r"currency. optional field. example:. 'USD'")
    adults: Optional[StrictInt] = Field(default=None, description=r"number of adults. optional field. if you don’t specify this field, the default value of 2 will be applied;. note that you can specify up to 6 persons including both adults and children. example:. 1")
    children: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"number and age of children. optional field. if you don’t specify this field, no children will be included in the search;. age of child can be from 0 to 17;. note that you can specify up to 6 persons including both adults and children. set the following value if you want to include one 14-year-old child:. [14]. set the following value if you want to include one 13-year-old child and one 8-year-old child:. [13,8]")
    stars: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"hotel stars. optional field. set this field to [5] if you want to get the list of 5-star hotels only. example:. [3,4,5]")
    min_rating: Optional[StrictFloat] = Field(default=None, description=r"minimum rating. optional field. you can use this field to specify guest rating higher than a certain value. example:. 2.5")
    sort_by: Optional[StrictStr] = Field(default=None, description=r"results sorting parameters. optional field. you can use this field to sort the results. possible types of sorting:. relevance – sort by most relevant. lowest_price – sort by the lowest price. highest_rating – sort by highest rating. most_reviewed – sort by most reviewed. default value: relevance")
    min_price: Optional[StrictInt] = Field(default=None, description=r"minimum price per night. optional field. the currency of this value depends on the currency field. example:. 100")
    max_price: Optional[StrictInt] = Field(default=None, description=r"maximum price per night. optional field. the currency of this value depends on the currency field. example:. 600")
    free_cancellation: Optional[StrictBool] = Field(default=None, description=r"hotels with a free cancellation. optional field. set this field to true if you want to get the list of hotels with free cancellation of reservations. default value: false")
    is_vacation_rentals: Optional[StrictBool] = Field(default=None, description=r"search for vacation rentals. optional field. set this field to true if you want to get the list of vacation rentals instead of hotels. default value: false")
    amenities: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"hotel amenities. optional field. you can use this field to specify different hotel amenities. example:.   [.             'free_parking',.             'pets_allowed'.         ]. . possible values:. 'air_conditioning',. 'all_inclusive_available',. 'bar',. 'free_breakfast',. 'fitness_center',. 'kid_friendly',. 'free_parking',. 'pets_allowed',. 'pool',. 'restaurant',. 'room_service',. 'spa',. 'free_wifi',. 'parking',. 'indoor_pool',. 'outdoor_pool',. 'wheelchair_accessible',. 'beach_access'")
