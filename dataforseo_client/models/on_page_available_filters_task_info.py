...
class OnPageAvailableFiltersTaskInfo(BaseModel):
    ...
    result: Optional[List[Optional[OnPageAvailableFiltersResultInfo]]] = Field(default=None, description=r"*array of results*. contains the full list of available parameters that can be used for data filtration. the parameters are grouped by the endpoint they can be used with")
