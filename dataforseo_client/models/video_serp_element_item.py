...
class VideoSerpElementItem(BaseSerpApiElementItem):
    """
    ...
    items: Optional[List[Optional[VideoElement]]] = Field(default=None, description=r"contains arrays of elements available in the list")
