...
class DataforseoLabsGoogleRelatedKeywordsLiveItem(BaseModel):
    ...
    related_keywords: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"list of related keywordsrepresents the list of search queries which are related to the keyword returned in the array above")
