...
class AppDataAppleAppReviewsTaskGetAdvancedResultInfo(BaseModel):
    ...
    reviews_count: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="the total number of reviews in this case, the value will be null as App Store does not indicate the total number of app reviews")
