...
class BusinessDataYelpSearchTaskGetResultInfo(BaseModel):
    ...
    items: Optional[List[BaseBusinessDataSerpElementItem]] = Field(default=None, description="Yelp search listing results you can get more results by using the depth parameter when setting a task")
