...
class DataforseoLabsSerpCompetitorsLiveItem(BaseModel):
    ...
    median_position: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="the median position of the domain for the specified keywords the median of the values in the keywords_positions array")
    rating: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="the margin between the greatest possible and actual keyword positions represents the relative visibility rate of the domain in SERP for the specified keywords calculated as sum(100-keywords_positions)")
    ...
    keywords_count: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="the number of specified keywords the domain has positions for in SERPs")
    ...
    relevant_serp_items: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="the number of SERP elements relevant to the domain represents the number of search results in SERP relevant to the domain for the specified keywords")
