...
class AmazonProductInfo(BaseModel):
    ...
    rank_absolute: Optional[StrictInt] = Field(default=None, description=r"*absolute rank*. absolute position among all the elements in the response array")
    ...
    details: Optional[StrictStr] = Field(default=None, description=r"*product specs and other details*")
    image_url: Optional[StrictStr] = Field(default=None, description=r"*the URL of the product image*")
    author: Optional[StrictStr] = Field(default=None, description=r"*product brand name*")
    data_asin: Optional[StrictStr] = Field(default=None, description=r"*ASIN of the product received in a POST array*")
    parent_asin: Optional[StrictStr] = Field(default=None, description=r"*[parent ASIN](https://sellercentral.amazon.com/gp/help/external/help.html?itemID=8831&language=en-US&ref=mpbc_200779220_cont_8831&) of the product*")
    product_asins: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"*ASINs of all found product modifications*")
    price_from: Optional[StrictFloat] = Field(default=None, description=r"*the lower limit of the product price range*. example:. `49.98`")
    price_to: Optional[StrictFloat] = Field(default=None, description=r"*the upper limit of the product price range*. example:. `384.99`")
    percentage_discount: Optional[StrictStr] = Field(default=None, description=r"*value of the percentage discount*")
    ...
    is_available: Optional[StrictBool] = Field(default=None, description=r"*indicates whether the product is [available for ordering](https://www.amazon.com/gp/help/customer/display.html?nodeId=201910280)*. if the value is `true`, the product can be ordered")
