...
from dataforseo_client.models.ai_optimization_chat_gpt_llm_scraper_task_get_html_result_info import AiOptimizationChatGptLlmScraperTaskGetHtmlResultInfo
from dataforseo_client.models.base_response_task_info import BaseResponseTaskInfo



class AiOptimizationChatGptLlmScraperTaskGetHtmlTaskInfo(BaseModel):
    """
    ...
    result: Optional[List[Optional[AiOptimizationChatGptLlmScraperTaskGetHtmlResultInfo]]] = Field(default=None, description=r"array of results")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "path": obj.get("path"),
            "data": obj.get("data"),
            "result": [AiOptimizationChatGptLlmScraperTaskGetHtmlResultInfo.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None,
        })
