...
class VisualStoriesSerpElementItem(BaseSerpApiElementItem):
    """
    ...
    items: Optional[List[Optional[AmazonLabelElement]]] = Field(default=None, description=r"contains arrays of specific images")
