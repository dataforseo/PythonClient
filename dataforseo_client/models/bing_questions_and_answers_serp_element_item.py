...
class BingQuestionsAndAnswersSerpElementItem(BaseBingSerpApiElementItem):
    """
    ...
    items: Optional[List[Optional[QuestionsAndAnswersElement]]] = Field(default=None, description=r"additional items present in the element. if there are none, equals null")
