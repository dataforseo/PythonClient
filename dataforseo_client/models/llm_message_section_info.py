...
class LlmMessageSectionInfo(BaseModel):
    ...
    text: Optional[StrictStr] = Field(default=None, description=r"AI-generated text content")
    annotations: Optional[List[Optional[AnnotationInfo]]] = Field(default=None, description=r"array of references used to generate the responseequals null if the web_search parameter is not set to trueNote: annotations may return empty even when web_search is true, as the AI will attempt to retrieve web information but may not find relevant results")
