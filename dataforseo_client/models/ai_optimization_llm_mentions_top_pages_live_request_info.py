...
class AiOptimizationLlmMentionsTopPagesLiveRequestInfo(BaseModel):
    """
    ...
    search_scope: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"target keyword search scope. optional field. possible values:. any, question, answer. default value: any")
    ...
    items_list_limit: Optional[StrictInt] = Field(default=None, description=r"maximum number of results in the items array. optional field. you can use this parameter to limit the number of data objects you receive in the items array. minimum value: 1. maximum value: 10. default value: 5")
