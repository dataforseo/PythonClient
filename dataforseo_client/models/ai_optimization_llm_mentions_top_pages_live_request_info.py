...
class AiOptimizationLlmMentionsTopPagesLiveRequestInfo(BaseModel):
    ...
    domain: Optional[StrictStr] = Field(default=None, description=r"target domain. required field if you don’t specify keyword. you can specify up to 63 characters in the domain field;. a domain should be specified without https:// and www.")
    ...
    platform: Optional[StrictStr] = Field(default=None, description=r"target platform. optional field. possible values:. chat_gpt, google. default value: google. Note: the data returned depends on the selected platform. Note #2:chat_gpt data is available for the United States and English only")
