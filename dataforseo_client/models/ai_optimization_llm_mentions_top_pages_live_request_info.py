...
class AiOptimizationLlmMentionsTopPagesLiveRequestInfo(BaseModel):
    ...
    links_scope: Optional[StrictStr] = Field(default=None, description=r"links source scopeoptional fieldthis parameter specifies which links will be used to extract pages and aggregation datapossible values: sources, search_resultsdefault value: sources")
