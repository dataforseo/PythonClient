...
class ChatGptGoogleShoppingProduct(BaseModel):
    ...
    catalog_id: Optional[StrictStr] = Field(default=None, description=r"*Google Shopping catalog identifier of the product*. can be used as a `product_id` in [Google Shopping API endpoints](https://docs.dataforseo.com/v3/merchant/google/overview/)")
    gpcid: Optional[StrictStr] = Field(default=None, description=r"*Google product cluster identifier*. can be used as a `gid` in [Google Shopping API endpoints](https://docs.dataforseo.com/v3/merchant/google/overview/)")
    headline_offer_docid: Optional[StrictStr] = Field(default=None, description=r"*document identifier of the main offer in the headline*. can be used as a `data_docid` in [Google Shopping API endpoints](https://docs.dataforseo.com/v3/merchant/google/overview/)")
