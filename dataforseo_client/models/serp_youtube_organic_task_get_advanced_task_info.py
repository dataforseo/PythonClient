...
from dataforseo_client.models.serp_youtube_organic_task_get_advanced_result_info import SerpYoutubeOrganicTaskGetAdvancedResultInfo
from dataforseo_client.models.base_response_task_info import BaseResponseTaskInfo



class SerpYoutubeOrganicTaskGetAdvancedTaskInfo(BaseModel):
    """
    ...
    result: Optional[List[Optional[SerpYoutubeOrganicTaskGetAdvancedResultInfo]]] = Field(default=None, description=r"array of results")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "path": obj.get("path"),
            "data": obj.get("data"),
            "result": [SerpYoutubeOrganicTaskGetAdvancedResultInfo.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None,
        })
