...
class ClickstreamKeywordInfo(BaseModel):
    ...
    gender_distribution: Optional[Dict[str, Optional[StrictInt]]] = Field(default=None, description=r"*distribution of estimated clickstream-based metrics by gender*. learn more about how the metric is calculated in this [help center article](https://dataforseo.com/help-center/what-are-clickstream-based-metrics-and-how-do-we-calculate-them)")
    age_distribution: Optional[Dict[str, Optional[StrictInt]]] = Field(default=None, description=r"*distribution of clickstream-based metrics by age*. learn more about how the metric is calculated in this [help center article](https://dataforseo.com/help-center/what-are-clickstream-based-metrics-and-how-do-we-calculate-them)")
