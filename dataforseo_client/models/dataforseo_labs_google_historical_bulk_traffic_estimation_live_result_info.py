...
class DataforseoLabsGoogleHistoricalBulkTrafficEstimationLiveResultInfo(BaseModel):
    ...
    items: Optional[List[Optional[DataforseoLabsGoogleHistoricalBulkTrafficEstimationLiveItem]]] = Field(default=None, description="array of items with relevant traffic estimation data")
