...
class MerchantAmazonProductsLiveAdvancedResultInfo(BaseModel):
    """
    ...
    check_url: Optional[StrictStr] = Field(default=None, description=r"direct URL to Amazon resultsyou can use it to make sure that we provided accurate results")
    ...
    spell: Optional[SpellInfo] = Field(default=None, description=r"autocorrection of the search engineif the search engine provided results for a keyword that was corrected, we will specify the keyword corrected by the search engine and the type of autocorrection")
    item_types: Optional[List[Optional[StrictStr]]] = Field(default=None, description=r"types of search results found in Amazon SERPcontains types of all search results (items) found in the returned SERPpossible item types:amazon_serp, amazon_paid, editorial_recommendations, top_rated_from_our_brands, related_searches")
    se_results_count: Optional[StrictInt] = Field(default=None, description=r"search engine results count")
    categories: Optional[Any] = Field(default=None, description=r"amazon product departments and subcategories")
    items_count: Optional[StrictInt] = Field(default=None, description=r"the number of results returned in the items array")
    items: Optional[List[Optional[BaseMerchantAmazonElementItem]]] = Field(default=None, description=r"Amazon product items within the editorial_recommendations element")
