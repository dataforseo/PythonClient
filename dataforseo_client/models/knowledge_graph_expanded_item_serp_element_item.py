...
class KnowledgeGraphExpandedItemSerpElementItem(BaseSerpApiElementItem):
    """
    ...
    expanded_element: Optional[List[Optional[KnowledgeGraphExpandedElement]]] = Field(default=None, description=r"expanded element")
