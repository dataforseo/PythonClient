...
class DomainAnalyticsTechnologiesDomainsByLiveItem(BaseModel):
    ...
    country_iso_code: Optional[StrictStr] = Field(default=None, description=r"*domain ISO code*. ISO code of the country that target domain is determined to belong to")
    language_code: Optional[StrictStr] = Field(default=None, description=r"*domain language*. code of the language that target domain is determined to be associated with")
    content_language_code: Optional[StrictStr] = Field(default=None, description=r"*content language*. code of the language that content on the target domain is written with")
    ...
    technologies: Optional[TechnologiesInfo] = Field(default=None, description=r"*technologies used by target domain*. contains objects with the names of technologies used on the website;. to get a full list of technologies and their structure, refer to the [technologies endpoint](/v3/domain_analytics/technologies/technologies/)")
