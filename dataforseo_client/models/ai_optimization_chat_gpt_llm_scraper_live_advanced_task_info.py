...
from dataforseo_client.models.ai_optimization_chat_gpt_llm_scraper_live_advanced_result_info import AiOptimizationChatGptLlmScraperLiveAdvancedResultInfo
from dataforseo_client.models.base_response_task_info import BaseResponseTaskInfo



class AiOptimizationChatGptLlmScraperLiveAdvancedTaskInfo(BaseModel):
    """
    ...
    result: Optional[List[Optional[AiOptimizationChatGptLlmScraperLiveAdvancedResultInfo]]] = Field(default=None, description=r"array of results")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "path": obj.get("path"),
            "data": obj.get("data"),
            "result": [AiOptimizationChatGptLlmScraperLiveAdvancedResultInfo.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None,
        })
