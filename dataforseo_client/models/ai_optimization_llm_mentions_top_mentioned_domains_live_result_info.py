...
from dataforseo_client.models.ai_optimization_llm_mentions_top_mentioned_domains_live_item import AiOptimizationLlmMentionsTopMentionedDomainsLiveItem



class AiOptimizationLlmMentionsTopMentionedDomainsLiveResultInfo(BaseModel):
    """
    ...
    items: Optional[List[Optional[AiOptimizationLlmMentionsTopMentionedDomainsLiveItem]]] = Field(default=None, description=r"individual domain results. array containing detailed mention metrics for each of the found top domains")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [AiOptimizationLlmMentionsTopMentionedDomainsLiveItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
        })
