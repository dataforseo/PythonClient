...
class GoogleTrendsGoogleTrendsGraphElementItem(BaseKeywordDataGoogleTrendsItem):
    """
    ...
    data: Optional[List[Optional[TrendsGraphDataInfo]]] = Field(default=None, description="Google Trends data for the specified parameters")
    averages: Optional[List[Optional[StrictFloat]]] = Field(default=None, description="keyword popularity values averaged over the whole time range")
