...
class ShopsListMerchantSerpElementItem(BaseMerchantSerpElementItem):
    ...
    base_price: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="product price without tax and shipping")
    ...
    price_multiplier: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="monthly price multiplier indicates the number of months covered by the monthly payment for the product")
