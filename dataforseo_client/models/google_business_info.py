...
class GoogleBusinessInfo(BaseModel):
    ...
    cid: Optional[StrictStr] = Field(default=None, description=r"*google-defined client id*. unique id of a local establishment;. can be used with [Google Reviews API](/v3/reviews/google/overview/?php) to get a full list of reviews. learn more about the identifier in [this help center article](https://dataforseo.com/help-center/what-is-cid-place-id-feature-id)")
    ...
    hotel_rating: Optional[StrictFloat] = Field(default=None, description=r"*hotel class rating*. class ratings range between 1-5 stars, [learn more](https://support.google.com/business/answer/7660515?hl=en). if there is no hotel class rating information, the value will be `null`")
