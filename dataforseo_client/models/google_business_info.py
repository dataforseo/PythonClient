...
class GoogleBusinessInfo(BaseModel):
    ...
    questions_and_answers_count: Optional[StrictInt] = Field(default=None, description="")
    ...
    directory: Optional[BusinessDirectoryInfo] = Field(default=None, description="items of the directory. includes information about businesses that are located within the target business establishment and have the same address")
