...
class AppendixApi:
    ...
    def _webhook_resend_serialize(
        self,
        list_optional_appendix_webhook_resend_request_info,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        _collection_formats: Dict[str, str] = {
            'List[Optional[AppendixWebhookResendRequestInfo]]': '',
        }
        ...
        if list_optional_appendix_webhook_resend_request_info is not None:
            _body_params = list_optional_appendix_webhook_resend_request_info
