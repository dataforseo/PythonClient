...
------------ | ------------- | ------------- | -------------
**keywords** | **List[str]** | keywords required field The maximum number of keywords you can specify: 200 The maximum number of characters for each keyword: 100 the specified keywords will be converted to lowercase, data will be provided in a separate array | [optional] 
...
keywords_data_bing_search_volume_task_post_request_info_instance = KeywordsDataBingSearchVolumeTaskPostRequestInfo.from_json(json)
# print the JSON string representation of the object
print KeywordsDataBingSearchVolumeTaskPostRequestInfo.to_json()

# convert the object into a dict
keywords_data_bing_search_volume_task_post_request_info_dict = keywords_data_bing_search_volume_task_post_request_info_instance.to_dict()
# create an instance of KeywordsDataBingSearchVolumeTaskPostRequestInfo from a dict
keywords_data_bing_search_volume_task_post_request_info_form_dict = keywords_data_bing_search_volume_task_post_request_info.from_dict(keywords_data_bing_search_volume_task_post_request_info_dict)
```
