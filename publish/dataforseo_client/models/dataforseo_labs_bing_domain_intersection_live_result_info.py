...
class DataforseoLabsBingDomainIntersectionLiveResultInfo(BaseModel):
    ...
    items: Optional[List[DataforseoLabsBingDomainIntersectionLiveItem]] = Field(default=None, description="contains keywords, relevant SERP elements and related data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [DataforseoLabsBingDomainIntersectionLiveItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
