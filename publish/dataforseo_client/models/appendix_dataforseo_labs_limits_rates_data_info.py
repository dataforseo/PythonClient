...
class AppendixDataforseoLabsLimitsRatesDataInfo(BaseModel):
    ...
    product_competitors: Optional[AppendixFunctionInfo] = None
    product_keyword_intersections: Optional[AppendixFunctionInfo] = None
    product_rank_overview: Optional[AppendixFunctionInfo] = None
    ranked_keywords: Optional[AppendixFunctionInfo] = None
    serp_competitors: Optional[AppendixFunctionInfo] = None
    subdomains: Optional[AppendixFunctionInfo] = None
    relevant_pages: Optional[AppendixFunctionInfo] = None
    competitors_domain: Optional[AppendixFunctionInfo] = None
    related_keywords: Optional[AppendixFunctionInfo] = None
    domain_rank_overview: Optional[AppendixFunctionInfo] = None
    domain_intersection: Optional[AppendixFunctionInfo] = None
    page_intersection: Optional[AppendixFunctionInfo] = None
    bulk_traffic_estimation: Optional[AppendixFunctionInfo] = None
    bulk_keyword_difficulty: Optional[AppendixFunctionInfo] = None
    bulk_search_volume: Optional[AppendixFunctionInfo] = None
    keywords_for_site: Optional[AppendixFunctionInfo] = None
    keyword_suggestions: Optional[AppendixFunctionInfo] = None
    keyword_ideas: Optional[AppendixFunctionInfo] = None
    historical_search_volume: Optional[AppendixFunctionInfo] = None
    categories_for_domain: Optional[AppendixFunctionInfo] = None
    domain_metrics_by_categories: Optional[AppendixFunctionInfo] = None
    top_searches: Optional[AppendixFunctionInfo] = None
    domain_whois_overview: Optional[AppendixFunctionInfo] = None
    historical_rank_overview: Optional[AppendixFunctionInfo] = None
    keywords_for_categories: Optional[AppendixFunctionInfo] = None
    historical_serps: Optional[AppendixFunctionInfo] = None
    app_competitors: Optional[AppendixFunctionInfo] = None
    keywords_for_app: Optional[AppendixFunctionInfo] = None
    app_intersection: Optional[AppendixFunctionInfo] = None
    bulk_app_metrics: Optional[AppendixFunctionInfo] = None
    search_intent: Optional[AppendixFunctionInfo] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "product_competitors": AppendixFunctionInfo.from_dict(obj["product_competitors"]) if obj.get("product_competitors") is not None else None,
            "product_keyword_intersections": AppendixFunctionInfo.from_dict(obj["product_keyword_intersections"]) if obj.get("product_keyword_intersections") is not None else None,
            "product_rank_overview": AppendixFunctionInfo.from_dict(obj["product_rank_overview"]) if obj.get("product_rank_overview") is not None else None,
            "ranked_keywords": AppendixFunctionInfo.from_dict(obj["ranked_keywords"]) if obj.get("ranked_keywords") is not None else None,
            "serp_competitors": AppendixFunctionInfo.from_dict(obj["serp_competitors"]) if obj.get("serp_competitors") is not None else None,
            "subdomains": AppendixFunctionInfo.from_dict(obj["subdomains"]) if obj.get("subdomains") is not None else None,
            "relevant_pages": AppendixFunctionInfo.from_dict(obj["relevant_pages"]) if obj.get("relevant_pages") is not None else None,
            "competitors_domain": AppendixFunctionInfo.from_dict(obj["competitors_domain"]) if obj.get("competitors_domain") is not None else None,
            "related_keywords": AppendixFunctionInfo.from_dict(obj["related_keywords"]) if obj.get("related_keywords") is not None else None,
            "domain_rank_overview": AppendixFunctionInfo.from_dict(obj["domain_rank_overview"]) if obj.get("domain_rank_overview") is not None else None,
            ...
            "bulk_traffic_estimation": AppendixFunctionInfo.from_dict(obj["bulk_traffic_estimation"]) if obj.get("bulk_traffic_estimation") is not None else None,
            "bulk_keyword_difficulty": AppendixFunctionInfo.from_dict(obj["bulk_keyword_difficulty"]) if obj.get("bulk_keyword_difficulty") is not None else None,
            "bulk_search_volume": AppendixFunctionInfo.from_dict(obj["bulk_search_volume"]) if obj.get("bulk_search_volume") is not None else None,
            ...
            "keyword_suggestions": AppendixFunctionInfo.from_dict(obj["keyword_suggestions"]) if obj.get("keyword_suggestions") is not None else None,
            "keyword_ideas": AppendixFunctionInfo.from_dict(obj["keyword_ideas"]) if obj.get("keyword_ideas") is not None else None,
            "historical_search_volume": AppendixFunctionInfo.from_dict(obj["historical_search_volume"]) if obj.get("historical_search_volume") is not None else None,
            "categories_for_domain": AppendixFunctionInfo.from_dict(obj["categories_for_domain"]) if obj.get("categories_for_domain") is not None else None,
            "domain_metrics_by_categories": AppendixFunctionInfo.from_dict(obj["domain_metrics_by_categories"]) if obj.get("domain_metrics_by_categories") is not None else None,
            "top_searches": AppendixFunctionInfo.from_dict(obj["top_searches"]) if obj.get("top_searches") is not None else None,
            "domain_whois_overview": AppendixFunctionInfo.from_dict(obj["domain_whois_overview"]) if obj.get("domain_whois_overview") is not None else None,
            "historical_rank_overview": AppendixFunctionInfo.from_dict(obj["historical_rank_overview"]) if obj.get("historical_rank_overview") is not None else None,
            "keywords_for_categories": AppendixFunctionInfo.from_dict(obj["keywords_for_categories"]) if obj.get("keywords_for_categories") is not None else None,
            "historical_serps": AppendixFunctionInfo.from_dict(obj["historical_serps"]) if obj.get("historical_serps") is not None else None,
            "app_competitors": AppendixFunctionInfo.from_dict(obj["app_competitors"]) if obj.get("app_competitors") is not None else None,
            "keywords_for_app": AppendixFunctionInfo.from_dict(obj["keywords_for_app"]) if obj.get("keywords_for_app") is not None else None,
            "app_intersection": AppendixFunctionInfo.from_dict(obj["app_intersection"]) if obj.get("app_intersection") is not None else None,
            "bulk_app_metrics": AppendixFunctionInfo.from_dict(obj["bulk_app_metrics"]) if obj.get("bulk_app_metrics") is not None else None,
            "search_intent": AppendixFunctionInfo.from_dict(obj["search_intent"]) if obj.get("search_intent") is not None else None
        })
        return _obj
