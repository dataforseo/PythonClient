...
class BusinessDataYelpReviewsTaskPostRequestInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["alias", "keyword", "priority", "location_name", "location_code", "language_name", "language_code", "depth", "sort_by", "tag", "postback_url", "pingback_url"]
