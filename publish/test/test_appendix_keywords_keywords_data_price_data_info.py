...
class TestAppendixKeywordsKeywordsDataPriceDataInfo(unittest.TestCase):
    """AppendixKeywordsKeywordsDataPriceDataInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppendixKeywordsKeywordsDataPriceDataInfo:
        """Test AppendixKeywordsKeywordsDataPriceDataInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppendixKeywordsKeywordsDataPriceDataInfo`
        """
        model = AppendixKeywordsKeywordsDataPriceDataInfo()
        if include_optional:
            return AppendixKeywordsKeywordsDataPriceDataInfo(
    ...
    def testAppendixKeywordsKeywordsDataPriceDataInfo(self):
        """Test AppendixKeywordsKeywordsDataPriceDataInfo"""
