...
class TestKeywordDataKeywordDataInfo(unittest.TestCase):
    """KeywordDataKeywordDataInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> KeywordDataKeywordDataInfo:
        """Test KeywordDataKeywordDataInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `KeywordDataKeywordDataInfo`
        """
        model = KeywordDataKeywordDataInfo()
        if include_optional:
            return KeywordDataKeywordDataInfo(
                se_type = '',
                keyword = '',
                location_code = 56,
                language_code = '',
    ...
    def testKeywordDataKeywordDataInfo(self):
        """Test KeywordDataKeywordDataInfo"""
