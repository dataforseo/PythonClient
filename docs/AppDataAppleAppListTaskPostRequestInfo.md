...
app_data_apple_app_list_task_post_request_info_from_dict = AppDataAppleAppListTaskPostRequestInfo.from_dict(app_data_apple_app_list_task_post_request_info_dict)
```
