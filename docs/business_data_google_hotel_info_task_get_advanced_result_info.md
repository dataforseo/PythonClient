...
|------------ | ------------- | ------------- | -------------|
**hotel_identifier** | **StrictStr** | <em>unique hotel identifier</em><br>this field will contain the <code>hotel_identifier</code> parameter;<br>example:<br><code>CgoI-KWyzenM_MV3EAE</code> |[optional]|
