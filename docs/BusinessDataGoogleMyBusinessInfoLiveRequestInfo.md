...
business_data_google_my_business_info_live_request_info_instance = BusinessDataGoogleMyBusinessInfoLiveRequestInfo.from_json(json)
# print the JSON string representation of the object
print(BusinessDataGoogleMyBusinessInfoLiveRequestInfo.to_json())

# convert the object into a dict
business_data_google_my_business_info_live_request_info_dict = business_data_google_my_business_info_live_request_info_instance.to_dict()
# create an instance of BusinessDataGoogleMyBusinessInfoLiveRequestInfo from a dict
business_data_google_my_business_info_live_request_info_from_dict = BusinessDataGoogleMyBusinessInfoLiveRequestInfo.from_dict(business_data_google_my_business_info_live_request_info_dict)
```
