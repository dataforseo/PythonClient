...
**browser_screen_scale_factor** | **StrictFloat** | browser scale factor<br>optional field<br>can be specified in the following range: 0.5-3<br>default value: 1 |[optional]|
