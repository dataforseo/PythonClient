...
dataforseo_labs_bing_ranked_keywords_live_request_info_from_dict = DataforseoLabsBingRankedKeywordsLiveRequestInfo.from_dict(dataforseo_labs_bing_ranked_keywords_live_request_info_dict)
```
