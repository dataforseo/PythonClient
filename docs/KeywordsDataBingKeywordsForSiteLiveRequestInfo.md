...
keywords_data_bing_keywords_for_site_live_request_info_from_dict = KeywordsDataBingKeywordsForSiteLiveRequestInfo.from_dict(keywords_data_bing_keywords_for_site_live_request_info_dict)
```
