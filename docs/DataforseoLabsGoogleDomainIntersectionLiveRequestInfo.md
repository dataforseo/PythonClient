...
dataforseo_labs_google_domain_intersection_live_request_info_from_dict = DataforseoLabsGoogleDomainIntersectionLiveRequestInfo.from_dict(dataforseo_labs_google_domain_intersection_live_request_info_dict)
```
