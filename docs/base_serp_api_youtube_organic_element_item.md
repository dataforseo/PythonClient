...
**block_rank** | **StrictInt** | <em>block rank in SERP</em><br>            position among all the blocks in SERP |[optional]|
**block_name** | **StrictStr** | <em>name of the block in SERP</em><br>            example:<br>            <code>'People also watched'</code><br> |[optional]|
**channel_id** | **StrictStr** | <em>ID of the channel</em> |[optional]|
**url** | **StrictStr** | <em>URL of the channel</em> |[optional]|