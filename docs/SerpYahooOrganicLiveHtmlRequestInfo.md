...
serp_yahoo_organic_live_html_request_info_instance = SerpYahooOrganicLiveHtmlRequestInfo.from_json(json)
# print the JSON string representation of the object
print(SerpYahooOrganicLiveHtmlRequestInfo.to_json())

# convert the object into a dict
serp_yahoo_organic_live_html_request_info_dict = serp_yahoo_organic_live_html_request_info_instance.to_dict()
# create an instance of SerpYahooOrganicLiveHtmlRequestInfo from a dict
serp_yahoo_organic_live_html_request_info_from_dict = SerpYahooOrganicLiveHtmlRequestInfo.from_dict(serp_yahoo_organic_live_html_request_info_dict)
```
