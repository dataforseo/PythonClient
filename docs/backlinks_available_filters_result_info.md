...
**backlinks** | **Dict[str, Optional[StrictStr]]** | filters available for the backlinks endpoint: |[optional]|
...
**page_intersection** | **Dict[str, Optional[StrictStr]]** | filters available for the page intersection endpoint: |[optional]|
