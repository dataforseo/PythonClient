...
serp_google_news_task_post_request_info_instance = SerpGoogleNewsTaskPostRequestInfo.from_json(json)
# print the JSON string representation of the object
print(SerpGoogleNewsTaskPostRequestInfo.to_json())

# convert the object into a dict
serp_google_news_task_post_request_info_dict = serp_google_news_task_post_request_info_instance.to_dict()
# create an instance of SerpGoogleNewsTaskPostRequestInfo from a dict
serp_google_news_task_post_request_info_from_dict = SerpGoogleNewsTaskPostRequestInfo.from_dict(serp_google_news_task_post_request_info_dict)
```
