...
dataforseo_labs_google_top_searches_live_request_info_form_dict = dataforseo_labs_google_top_searches_live_request_info.from_dict(dataforseo_labs_google_top_searches_live_request_info_dict)
```
