...
**video_id** | **StrictStr** | ID of the video |[optional]|
...
**badges** | **List[Optional[StrictStr]]** | video badges<br>example:<br>New, CC, 4K |[optional]|
**is_live** | **StrictBool** | indicates whether the video is a live broadcast |[optional]|
**is_shorts** | **StrictBool** | indicates whether the video is shorts |[optional]|
**is_movie** | **StrictBool** | indicates whether the video is a movie |[optional]|
