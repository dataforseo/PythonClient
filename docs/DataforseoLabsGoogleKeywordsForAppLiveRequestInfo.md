...
dataforseo_labs_google_keywords_for_app_live_request_info_from_dict = DataforseoLabsGoogleKeywordsForAppLiveRequestInfo.from_dict(dataforseo_labs_google_keywords_for_app_live_request_info_dict)
```
