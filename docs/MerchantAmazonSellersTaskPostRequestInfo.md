...
merchant_amazon_sellers_task_post_request_info_from_dict = MerchantAmazonSellersTaskPostRequestInfo.from_dict(merchant_amazon_sellers_task_post_request_info_dict)
```
