...
**se_type** | **StrictStr** | <em>type of search engine</em><br>can take the following values: <code>organic</code> |[optional]|
...
**endpoint_advanced** | **StrictStr** | <em>URL for collecting the results of the Amazon Products Advanced task</em> |[optional]|
**endpoint_html** | **StrictStr** | <em>URL for collecting the results of the Amazon Products HTML task</em> |[optional]|