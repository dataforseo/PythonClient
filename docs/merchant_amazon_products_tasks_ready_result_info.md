...
**se_type** | **StrictStr** | type of search engine<br>can take the following values: organic |[optional]|
...
**endpoint_advanced** | **StrictStr** | URL for collecting the results of the Amazon Products Advanced task |[optional]|
**endpoint_html** | **StrictStr** | URL for collecting the results of the Amazon Products HTML task |[optional]|