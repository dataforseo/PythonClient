...
**country_iso_code** | **StrictStr** | <em>domain ISO code</em><br>ISO code of the country that the target domain is determined to belong to |[optional]|
**language_code** | **StrictStr** | <em>domain language</em><br>code of the language that the target domain is determined to be associated with |[optional]|
**content_language_code** | **StrictStr** | <em>content language</em><br>code of the language that content on the target domain is written in |[optional]|
