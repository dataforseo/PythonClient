...
keywords_data_google_ads_keywords_for_site_live_request_info_from_dict = KeywordsDataGoogleAdsKeywordsForSiteLiveRequestInfo.from_dict(keywords_data_google_ads_keywords_for_site_live_request_info_dict)
```
