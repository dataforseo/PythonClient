...
**geo_id** | **StrictStr** | <em>google trends location identifier</em><br>you can use this field for matching obtained results with the <code>location_code</code> parameter specified in the request |[optional]|