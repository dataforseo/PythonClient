...
keywords_data_bing_keywords_for_keywords_live_task_info_from_dict = KeywordsDataBingKeywordsForKeywordsLiveTaskInfo.from_dict(keywords_data_bing_keywords_for_keywords_live_task_info_dict)
```
