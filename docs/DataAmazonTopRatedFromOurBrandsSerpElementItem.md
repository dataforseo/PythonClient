...
data_amazon_top_rated_from_our_brands_serp_element_item_from_dict = DataAmazonTopRatedFromOurBrandsSerpElementItem.from_dict(data_amazon_top_rated_from_our_brands_serp_element_item_dict)
```
