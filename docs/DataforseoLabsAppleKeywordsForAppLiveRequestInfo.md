...
dataforseo_labs_apple_keywords_for_app_live_request_info_form_dict = dataforseo_labs_apple_keywords_for_app_live_request_info.from_dict(dataforseo_labs_apple_keywords_for_app_live_request_info_dict)
```
