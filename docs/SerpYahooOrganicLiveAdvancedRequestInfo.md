...
serp_yahoo_organic_live_advanced_request_info_instance = SerpYahooOrganicLiveAdvancedRequestInfo.from_json(json)
# print the JSON string representation of the object
print(SerpYahooOrganicLiveAdvancedRequestInfo.to_json())

# convert the object into a dict
serp_yahoo_organic_live_advanced_request_info_dict = serp_yahoo_organic_live_advanced_request_info_instance.to_dict()
# create an instance of SerpYahooOrganicLiveAdvancedRequestInfo from a dict
serp_yahoo_organic_live_advanced_request_info_from_dict = SerpYahooOrganicLiveAdvancedRequestInfo.from_dict(serp_yahoo_organic_live_advanced_request_info_dict)
```
