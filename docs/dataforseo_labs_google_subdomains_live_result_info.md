...
**target** | **StrictStr** | <em>domain in a POST array</em> |[optional]|
...
**items** | **List[Optional[DataforseoLabsGoogleSubdomainsLiveItem]]** | <em>contains subdomains and related data</em> |[optional]|