...
**broken_backlinks** | **StrictInt** | <em>number of broken backlinks</em><br>number of broken backlinks pointing to the <code>page</code> |[optional]|
...
**referring_pages** | **StrictInt** | <em>indicates the number of pages pointing to the <code>page</code></em> |[optional]|
