...
backlinks_bulk_new_lost_backlinks_live_response_info_from_dict = BacklinksBulkNewLostBacklinksLiveResponseInfo.from_dict(backlinks_bulk_new_lost_backlinks_live_response_info_dict)
```
