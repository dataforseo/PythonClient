...
dataforseo_labs_google_keywords_for_categories_live_request_info_form_dict = dataforseo_labs_google_keywords_for_categories_live_request_info.from_dict(dataforseo_labs_google_keywords_for_categories_live_request_info_dict)
```
