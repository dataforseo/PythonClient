...
**categories** | **List[Optional[StrictInt]]** | <em>categories in a POST array</em> |[optional]|
...
**items** | **List[Optional[DataforseoLabsGoogleDomainMetricsByCategoriesLiveItem]]** | <em>contains historical ranking and traffic data</em> |[optional]|