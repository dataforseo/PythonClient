...
**categories** | **List[Optional[StrictFloat]]** | categories in a POST array |[optional]|
...
**items** | **List[Optional[DataforseoLabsGoogleDomainMetricsByCategoriesLiveItem]]** | contains historical ranking and traffic data |[optional]|