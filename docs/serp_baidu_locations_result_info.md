...
**location_type** | **StrictStr** | <em>location type</em><br>only <code>City</code> is supported for all countries except China (where <code>Country</code> is also supported) |[optional]|