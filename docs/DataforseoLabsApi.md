# dataforseo_client.DataforseoLabsApi
...
[**google_app_competitors_live**](DataforseoLabsApi.md#google_app_competitors_live) | **POST** /v3/dataforseo_labs/google/app_competitors/live | 
...
> DataforseoLabsGoogleBulkKeywordDifficultyLiveResponseInfo google_bulk_keyword_difficulty_live(dataforseo_labs_google_bulk_keyword_difficulty_live_request_info=dataforseo_labs_google_bulk_keyword_difficulty_live_request_info)
...
with dataforseo_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = dataforseo_client.DataforseoLabsApi(api_client)
    dataforseo_labs_google_bulk_keyword_difficulty_live_request_info = [dataforseo_client.DataforseoLabsGoogleBulkKeywordDifficultyLiveRequestInfo()] # List[DataforseoLabsGoogleBulkKeywordDifficultyLiveRequestInfo] |  (optional)

    try:
        api_response = api_instance.google_bulk_keyword_difficulty_live(dataforseo_labs_google_bulk_keyword_difficulty_live_request_info=dataforseo_labs_google_bulk_keyword_difficulty_live_request_info)
        print("The response of DataforseoLabsApi->google_bulk_keyword_difficulty_live:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DataforseoLabsApi->google_bulk_keyword_difficulty_live: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **dataforseo_labs_google_bulk_keyword_difficulty_live_request_info** | [**List[DataforseoLabsGoogleBulkKeywordDifficultyLiveRequestInfo]**](DataforseoLabsGoogleBulkKeywordDifficultyLiveRequestInfo.md)|  | [optional] 
...
> DataforseoLabsGoogleBulkTrafficEstimationLiveResponseInfo google_bulk_traffic_estimation_live(dataforseo_labs_google_bulk_traffic_estimation_live_request_info=dataforseo_labs_google_bulk_traffic_estimation_live_request_info)
...
with dataforseo_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = dataforseo_client.DataforseoLabsApi(api_client)
    dataforseo_labs_google_bulk_traffic_estimation_live_request_info = [dataforseo_client.DataforseoLabsGoogleBulkTrafficEstimationLiveRequestInfo()] # List[DataforseoLabsGoogleBulkTrafficEstimationLiveRequestInfo] |  (optional)

    try:
        api_response = api_instance.google_bulk_traffic_estimation_live(dataforseo_labs_google_bulk_traffic_estimation_live_request_info=dataforseo_labs_google_bulk_traffic_estimation_live_request_info)
        print("The response of DataforseoLabsApi->google_bulk_traffic_estimation_live:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DataforseoLabsApi->google_bulk_traffic_estimation_live: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **dataforseo_labs_google_bulk_traffic_estimation_live_request_info** | [**List[DataforseoLabsGoogleBulkTrafficEstimationLiveRequestInfo]**](DataforseoLabsGoogleBulkTrafficEstimationLiveRequestInfo.md)|  | [optional] 
...
> DataforseoLabsGoogleCategoriesForDomainLiveResponseInfo google_categories_for_domain_live(dataforseo_labs_google_categories_for_domain_live_request_info=dataforseo_labs_google_categories_for_domain_live_request_info)
...
with dataforseo_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = dataforseo_client.DataforseoLabsApi(api_client)
    dataforseo_labs_google_categories_for_domain_live_request_info = [dataforseo_client.DataforseoLabsGoogleCategoriesForDomainLiveRequestInfo()] # List[DataforseoLabsGoogleCategoriesForDomainLiveRequestInfo] |  (optional)

    try:
        api_response = api_instance.google_categories_for_domain_live(dataforseo_labs_google_categories_for_domain_live_request_info=dataforseo_labs_google_categories_for_domain_live_request_info)
        print("The response of DataforseoLabsApi->google_categories_for_domain_live:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DataforseoLabsApi->google_categories_for_domain_live: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **dataforseo_labs_google_categories_for_domain_live_request_info** | [**List[DataforseoLabsGoogleCategoriesForDomainLiveRequestInfo]**](DataforseoLabsGoogleCategoriesForDomainLiveRequestInfo.md)|  | [optional] 
...
> DataforseoLabsGoogleCompetitorsDomainLiveResponseInfo google_competitors_domain_live(dataforseo_labs_google_competitors_domain_live_request_info=dataforseo_labs_google_competitors_domain_live_request_info)
...
with dataforseo_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = dataforseo_client.DataforseoLabsApi(api_client)
    dataforseo_labs_google_competitors_domain_live_request_info = [dataforseo_client.DataforseoLabsGoogleCompetitorsDomainLiveRequestInfo()] # List[DataforseoLabsGoogleCompetitorsDomainLiveRequestInfo] |  (optional)

    try:
        api_response = api_instance.google_competitors_domain_live(dataforseo_labs_google_competitors_domain_live_request_info=dataforseo_labs_google_competitors_domain_live_request_info)
        print("The response of DataforseoLabsApi->google_competitors_domain_live:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DataforseoLabsApi->google_competitors_domain_live: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **dataforseo_labs_google_competitors_domain_live_request_info** | [**List[DataforseoLabsGoogleCompetitorsDomainLiveRequestInfo]**](DataforseoLabsGoogleCompetitorsDomainLiveRequestInfo.md)|  | [optional] 
...
> DataforseoLabsGoogleDomainIntersectionLiveResponseInfo google_domain_intersection_live(dataforseo_labs_google_domain_intersection_live_request_info=dataforseo_labs_google_domain_intersection_live_request_info)
...
with dataforseo_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = dataforseo_client.DataforseoLabsApi(api_client)
    dataforseo_labs_google_domain_intersection_live_request_info = [dataforseo_client.DataforseoLabsGoogleDomainIntersectionLiveRequestInfo()] # List[DataforseoLabsGoogleDomainIntersectionLiveRequestInfo] |  (optional)

    try:
        api_response = api_instance.google_domain_intersection_live(dataforseo_labs_google_domain_intersection_live_request_info=dataforseo_labs_google_domain_intersection_live_request_info)
        print("The response of DataforseoLabsApi->google_domain_intersection_live:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DataforseoLabsApi->google_domain_intersection_live: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **dataforseo_labs_google_domain_intersection_live_request_info** | [**List[DataforseoLabsGoogleDomainIntersectionLiveRequestInfo]**](DataforseoLabsGoogleDomainIntersectionLiveRequestInfo.md)|  | [optional] 
...
> DataforseoLabsGoogleDomainMetricsByCategoriesLiveResponseInfo google_domain_metrics_by_categories_live(dataforseo_labs_google_domain_metrics_by_categories_live_request_info=dataforseo_labs_google_domain_metrics_by_categories_live_request_info)
...
with dataforseo_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = dataforseo_client.DataforseoLabsApi(api_client)
    dataforseo_labs_google_domain_metrics_by_categories_live_request_info = [dataforseo_client.DataforseoLabsGoogleDomainMetricsByCategoriesLiveRequestInfo()] # List[DataforseoLabsGoogleDomainMetricsByCategoriesLiveRequestInfo] |  (optional)

    try:
        api_response = api_instance.google_domain_metrics_by_categories_live(dataforseo_labs_google_domain_metrics_by_categories_live_request_info=dataforseo_labs_google_domain_metrics_by_categories_live_request_info)
        print("The response of DataforseoLabsApi->google_domain_metrics_by_categories_live:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DataforseoLabsApi->google_domain_metrics_by_categories_live: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **dataforseo_labs_google_domain_metrics_by_categories_live_request_info** | [**List[DataforseoLabsGoogleDomainMetricsByCategoriesLiveRequestInfo]**](DataforseoLabsGoogleDomainMetricsByCategoriesLiveRequestInfo.md)|  | [optional] 
...
> DataforseoLabsGoogleDomainRankOverviewLiveResponseInfo google_domain_rank_overview_live(dataforseo_labs_google_domain_rank_overview_live_request_info=dataforseo_labs_google_domain_rank_overview_live_request_info)
...
with dataforseo_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = dataforseo_client.DataforseoLabsApi(api_client)
    dataforseo_labs_google_domain_rank_overview_live_request_info = [dataforseo_client.DataforseoLabsGoogleDomainRankOverviewLiveRequestInfo()] # List[DataforseoLabsGoogleDomainRankOverviewLiveRequestInfo] |  (optional)

    try:
        api_response = api_instance.google_domain_rank_overview_live(dataforseo_labs_google_domain_rank_overview_live_request_info=dataforseo_labs_google_domain_rank_overview_live_request_info)
        print("The response of DataforseoLabsApi->google_domain_rank_overview_live:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DataforseoLabsApi->google_domain_rank_overview_live: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **dataforseo_labs_google_domain_rank_overview_live_request_info** | [**List[DataforseoLabsGoogleDomainRankOverviewLiveRequestInfo]**](DataforseoLabsGoogleDomainRankOverviewLiveRequestInfo.md)|  | [optional] 
...
> DataforseoLabsGoogleDomainWhoisOverviewLiveResponseInfo google_domain_whois_overview_live(dataforseo_labs_google_domain_whois_overview_live_request_info=dataforseo_labs_google_domain_whois_overview_live_request_info)
...
with dataforseo_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = dataforseo_client.DataforseoLabsApi(api_client)
    dataforseo_labs_google_domain_whois_overview_live_request_info = [dataforseo_client.DataforseoLabsGoogleDomainWhoisOverviewLiveRequestInfo()] # List[DataforseoLabsGoogleDomainWhoisOverviewLiveRequestInfo] |  (optional)

    try:
        api_response = api_instance.google_domain_whois_overview_live(dataforseo_labs_google_domain_whois_overview_live_request_info=dataforseo_labs_google_domain_whois_overview_live_request_info)
        print("The response of DataforseoLabsApi->google_domain_whois_overview_live:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DataforseoLabsApi->google_domain_whois_overview_live: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **dataforseo_labs_google_domain_whois_overview_live_request_info** | [**List[DataforseoLabsGoogleDomainWhoisOverviewLiveRequestInfo]**](DataforseoLabsGoogleDomainWhoisOverviewLiveRequestInfo.md)|  | [optional] 
...
> DataforseoLabsGoogleHistoricalBulkTrafficEstimationLiveResponseInfo google_historical_bulk_traffic_estimation_live(dataforseo_labs_google_historical_bulk_traffic_estimation_live_request_info=dataforseo_labs_google_historical_bulk_traffic_estimation_live_request_info)
...
with dataforseo_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = dataforseo_client.DataforseoLabsApi(api_client)
    dataforseo_labs_google_historical_bulk_traffic_estimation_live_request_info = [dataforseo_client.DataforseoLabsGoogleHistoricalBulkTrafficEstimationLiveRequestInfo()] # List[DataforseoLabsGoogleHistoricalBulkTrafficEstimationLiveRequestInfo] |  (optional)

    try:
        api_response = api_instance.google_historical_bulk_traffic_estimation_live(dataforseo_labs_google_historical_bulk_traffic_estimation_live_request_info=dataforseo_labs_google_historical_bulk_traffic_estimation_live_request_info)
        print("The response of DataforseoLabsApi->google_historical_bulk_traffic_estimation_live:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DataforseoLabsApi->google_historical_bulk_traffic_estimation_live: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **dataforseo_labs_google_historical_bulk_traffic_estimation_live_request_info** | [**List[DataforseoLabsGoogleHistoricalBulkTrafficEstimationLiveRequestInfo]**](DataforseoLabsGoogleHistoricalBulkTrafficEstimationLiveRequestInfo.md)|  | [optional] 
...
with dataforseo_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = dataforseo_client.DataforseoLabsApi(api_client)
    dataforseo_labs_google_historical_rank_overview_live_request_info = [dataforseo_client.DataforseoLabsGoogleHistoricalRankOverviewLiveRequestInfo()] # List[DataforseoLabsGoogleHistoricalRankOverviewLiveRequestInfo] |  (optional)

    try:
        api_response = api_instance.google_historical_rank_overview_live(dataforseo_labs_google_historical_rank_overview_live_request_info=dataforseo_labs_google_historical_rank_overview_live_request_info)
        print("The response of DataforseoLabsApi->google_historical_rank_overview_live:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DataforseoLabsApi->google_historical_rank_overview_live: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **dataforseo_labs_google_historical_rank_overview_live_request_info** | [**List[DataforseoLabsGoogleHistoricalRankOverviewLiveRequestInfo]**](DataforseoLabsGoogleHistoricalRankOverviewLiveRequestInfo.md)|  | [optional] 
...
> DataforseoLabsGoogleHistoricalSerpsLiveResponseInfo google_historical_serps_live(dataforseo_labs_google_historical_serps_live_request_info=dataforseo_labs_google_historical_serps_live_request_info)
...
with dataforseo_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = dataforseo_client.DataforseoLabsApi(api_client)
    dataforseo_labs_google_historical_serps_live_request_info = [dataforseo_client.DataforseoLabsGoogleHistoricalSerpsLiveRequestInfo()] # List[DataforseoLabsGoogleHistoricalSerpsLiveRequestInfo] |  (optional)

    try:
        api_response = api_instance.google_historical_serps_live(dataforseo_labs_google_historical_serps_live_request_info=dataforseo_labs_google_historical_serps_live_request_info)
        print("The response of DataforseoLabsApi->google_historical_serps_live:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DataforseoLabsApi->google_historical_serps_live: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **dataforseo_labs_google_historical_serps_live_request_info** | [**List[DataforseoLabsGoogleHistoricalSerpsLiveRequestInfo]**](DataforseoLabsGoogleHistoricalSerpsLiveRequestInfo.md)|  | [optional] 
...
> DataforseoLabsGoogleKeywordIdeasLiveResponseInfo google_keyword_ideas_live(dataforseo_labs_google_keyword_ideas_live_request_info=dataforseo_labs_google_keyword_ideas_live_request_info)
...
with dataforseo_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = dataforseo_client.DataforseoLabsApi(api_client)
    dataforseo_labs_google_keyword_ideas_live_request_info = [dataforseo_client.DataforseoLabsGoogleKeywordIdeasLiveRequestInfo()] # List[DataforseoLabsGoogleKeywordIdeasLiveRequestInfo] |  (optional)

    try:
        api_response = api_instance.google_keyword_ideas_live(dataforseo_labs_google_keyword_ideas_live_request_info=dataforseo_labs_google_keyword_ideas_live_request_info)
        print("The response of DataforseoLabsApi->google_keyword_ideas_live:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DataforseoLabsApi->google_keyword_ideas_live: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **dataforseo_labs_google_keyword_ideas_live_request_info** | [**List[DataforseoLabsGoogleKeywordIdeasLiveRequestInfo]**](DataforseoLabsGoogleKeywordIdeasLiveRequestInfo.md)|  | [optional] 
...
> DataforseoLabsGoogleKeywordSuggestionsLiveResponseInfo google_keyword_suggestions_live(dataforseo_labs_google_keyword_suggestions_live_request_info=dataforseo_labs_google_keyword_suggestions_live_request_info)
...
with dataforseo_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = dataforseo_client.DataforseoLabsApi(api_client)
    dataforseo_labs_google_keyword_suggestions_live_request_info = [dataforseo_client.DataforseoLabsGoogleKeywordSuggestionsLiveRequestInfo()] # List[DataforseoLabsGoogleKeywordSuggestionsLiveRequestInfo] |  (optional)

    try:
        api_response = api_instance.google_keyword_suggestions_live(dataforseo_labs_google_keyword_suggestions_live_request_info=dataforseo_labs_google_keyword_suggestions_live_request_info)
        print("The response of DataforseoLabsApi->google_keyword_suggestions_live:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DataforseoLabsApi->google_keyword_suggestions_live: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **dataforseo_labs_google_keyword_suggestions_live_request_info** | [**List[DataforseoLabsGoogleKeywordSuggestionsLiveRequestInfo]**](DataforseoLabsGoogleKeywordSuggestionsLiveRequestInfo.md)|  | [optional] 
...
> DataforseoLabsGoogleKeywordsForAppLiveResponseInfo google_keywords_for_app_live(dataforseo_labs_google_keywords_for_app_live_request_info=dataforseo_labs_google_keywords_for_app_live_request_info)
...
with dataforseo_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = dataforseo_client.DataforseoLabsApi(api_client)
    dataforseo_labs_google_keywords_for_app_live_request_info = [dataforseo_client.DataforseoLabsGoogleKeywordsForAppLiveRequestInfo()] # List[DataforseoLabsGoogleKeywordsForAppLiveRequestInfo] |  (optional)

    try:
        api_response = api_instance.google_keywords_for_app_live(dataforseo_labs_google_keywords_for_app_live_request_info=dataforseo_labs_google_keywords_for_app_live_request_info)
        print("The response of DataforseoLabsApi->google_keywords_for_app_live:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DataforseoLabsApi->google_keywords_for_app_live: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **dataforseo_labs_google_keywords_for_app_live_request_info** | [**List[DataforseoLabsGoogleKeywordsForAppLiveRequestInfo]**](DataforseoLabsGoogleKeywordsForAppLiveRequestInfo.md)|  | [optional] 
...
> DataforseoLabsGoogleKeywordsForCategoriesLiveResponseInfo google_keywords_for_categories_live(dataforseo_labs_google_keywords_for_categories_live_request_info=dataforseo_labs_google_keywords_for_categories_live_request_info)
...
with dataforseo_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = dataforseo_client.DataforseoLabsApi(api_client)
    dataforseo_labs_google_keywords_for_categories_live_request_info = [dataforseo_client.DataforseoLabsGoogleKeywordsForCategoriesLiveRequestInfo()] # List[DataforseoLabsGoogleKeywordsForCategoriesLiveRequestInfo] |  (optional)

    try:
        api_response = api_instance.google_keywords_for_categories_live(dataforseo_labs_google_keywords_for_categories_live_request_info=dataforseo_labs_google_keywords_for_categories_live_request_info)
        print("The response of DataforseoLabsApi->google_keywords_for_categories_live:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DataforseoLabsApi->google_keywords_for_categories_live: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **dataforseo_labs_google_keywords_for_categories_live_request_info** | [**List[DataforseoLabsGoogleKeywordsForCategoriesLiveRequestInfo]**](DataforseoLabsGoogleKeywordsForCategoriesLiveRequestInfo.md)|  | [optional] 
...
> DataforseoLabsGoogleKeywordsForSiteLiveResponseInfo google_keywords_for_site_live(dataforseo_labs_google_keywords_for_site_live_request_info=dataforseo_labs_google_keywords_for_site_live_request_info)
...
with dataforseo_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = dataforseo_client.DataforseoLabsApi(api_client)
    dataforseo_labs_google_keywords_for_site_live_request_info = [dataforseo_client.DataforseoLabsGoogleKeywordsForSiteLiveRequestInfo()] # List[DataforseoLabsGoogleKeywordsForSiteLiveRequestInfo] |  (optional)

    try:
        api_response = api_instance.google_keywords_for_site_live(dataforseo_labs_google_keywords_for_site_live_request_info=dataforseo_labs_google_keywords_for_site_live_request_info)
        print("The response of DataforseoLabsApi->google_keywords_for_site_live:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DataforseoLabsApi->google_keywords_for_site_live: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **dataforseo_labs_google_keywords_for_site_live_request_info** | [**List[DataforseoLabsGoogleKeywordsForSiteLiveRequestInfo]**](DataforseoLabsGoogleKeywordsForSiteLiveRequestInfo.md)|  | [optional] 
...
> DataforseoLabsGooglePageIntersectionLiveResponseInfo google_page_intersection_live(dataforseo_labs_google_page_intersection_live_request_info=dataforseo_labs_google_page_intersection_live_request_info)
...
with dataforseo_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = dataforseo_client.DataforseoLabsApi(api_client)
    dataforseo_labs_google_page_intersection_live_request_info = [dataforseo_client.DataforseoLabsGooglePageIntersectionLiveRequestInfo()] # List[DataforseoLabsGooglePageIntersectionLiveRequestInfo] |  (optional)

    try:
        api_response = api_instance.google_page_intersection_live(dataforseo_labs_google_page_intersection_live_request_info=dataforseo_labs_google_page_intersection_live_request_info)
        print("The response of DataforseoLabsApi->google_page_intersection_live:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DataforseoLabsApi->google_page_intersection_live: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **dataforseo_labs_google_page_intersection_live_request_info** | [**List[DataforseoLabsGooglePageIntersectionLiveRequestInfo]**](DataforseoLabsGooglePageIntersectionLiveRequestInfo.md)|  | [optional] 
...
> DataforseoLabsGoogleRankedKeywordsLiveResponseInfo google_ranked_keywords_live(dataforseo_labs_google_ranked_keywords_live_request_info=dataforseo_labs_google_ranked_keywords_live_request_info)
...
with dataforseo_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = dataforseo_client.DataforseoLabsApi(api_client)
    dataforseo_labs_google_ranked_keywords_live_request_info = [dataforseo_client.DataforseoLabsGoogleRankedKeywordsLiveRequestInfo()] # List[DataforseoLabsGoogleRankedKeywordsLiveRequestInfo] |  (optional)

    try:
        api_response = api_instance.google_ranked_keywords_live(dataforseo_labs_google_ranked_keywords_live_request_info=dataforseo_labs_google_ranked_keywords_live_request_info)
        print("The response of DataforseoLabsApi->google_ranked_keywords_live:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DataforseoLabsApi->google_ranked_keywords_live: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **dataforseo_labs_google_ranked_keywords_live_request_info** | [**List[DataforseoLabsGoogleRankedKeywordsLiveRequestInfo]**](DataforseoLabsGoogleRankedKeywordsLiveRequestInfo.md)|  | [optional] 
...
> DataforseoLabsGoogleRelatedKeywordsLiveResponseInfo google_related_keywords_live(dataforseo_labs_google_related_keywords_live_request_info=dataforseo_labs_google_related_keywords_live_request_info)
...
with dataforseo_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = dataforseo_client.DataforseoLabsApi(api_client)
    dataforseo_labs_google_related_keywords_live_request_info = [dataforseo_client.DataforseoLabsGoogleRelatedKeywordsLiveRequestInfo()] # List[DataforseoLabsGoogleRelatedKeywordsLiveRequestInfo] |  (optional)

    try:
        api_response = api_instance.google_related_keywords_live(dataforseo_labs_google_related_keywords_live_request_info=dataforseo_labs_google_related_keywords_live_request_info)
        print("The response of DataforseoLabsApi->google_related_keywords_live:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DataforseoLabsApi->google_related_keywords_live: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **dataforseo_labs_google_related_keywords_live_request_info** | [**List[DataforseoLabsGoogleRelatedKeywordsLiveRequestInfo]**](DataforseoLabsGoogleRelatedKeywordsLiveRequestInfo.md)|  | [optional] 
...
> DataforseoLabsGoogleRelevantPagesLiveResponseInfo google_relevant_pages_live(dataforseo_labs_google_relevant_pages_live_request_info=dataforseo_labs_google_relevant_pages_live_request_info)
...
with dataforseo_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = dataforseo_client.DataforseoLabsApi(api_client)
    dataforseo_labs_google_relevant_pages_live_request_info = [dataforseo_client.DataforseoLabsGoogleRelevantPagesLiveRequestInfo()] # List[DataforseoLabsGoogleRelevantPagesLiveRequestInfo] |  (optional)

    try:
        api_response = api_instance.google_relevant_pages_live(dataforseo_labs_google_relevant_pages_live_request_info=dataforseo_labs_google_relevant_pages_live_request_info)
        print("The response of DataforseoLabsApi->google_relevant_pages_live:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DataforseoLabsApi->google_relevant_pages_live: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **dataforseo_labs_google_relevant_pages_live_request_info** | [**List[DataforseoLabsGoogleRelevantPagesLiveRequestInfo]**](DataforseoLabsGoogleRelevantPagesLiveRequestInfo.md)|  | [optional] 
...
> DataforseoLabsGoogleSearchIntentLiveResponseInfo google_search_intent_live(dataforseo_labs_google_search_intent_live_request_info=dataforseo_labs_google_search_intent_live_request_info)
...
with dataforseo_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = dataforseo_client.DataforseoLabsApi(api_client)
    dataforseo_labs_google_search_intent_live_request_info = [dataforseo_client.DataforseoLabsGoogleSearchIntentLiveRequestInfo()] # List[DataforseoLabsGoogleSearchIntentLiveRequestInfo] |  (optional)

    try:
        api_response = api_instance.google_search_intent_live(dataforseo_labs_google_search_intent_live_request_info=dataforseo_labs_google_search_intent_live_request_info)
        print("The response of DataforseoLabsApi->google_search_intent_live:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DataforseoLabsApi->google_search_intent_live: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **dataforseo_labs_google_search_intent_live_request_info** | [**List[DataforseoLabsGoogleSearchIntentLiveRequestInfo]**](DataforseoLabsGoogleSearchIntentLiveRequestInfo.md)|  | [optional] 
...
> DataforseoLabsGoogleSerpCompetitorsLiveResponseInfo google_serp_competitors_live(dataforseo_labs_google_serp_competitors_live_request_info=dataforseo_labs_google_serp_competitors_live_request_info)
...
with dataforseo_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = dataforseo_client.DataforseoLabsApi(api_client)
    dataforseo_labs_google_serp_competitors_live_request_info = [dataforseo_client.DataforseoLabsGoogleSerpCompetitorsLiveRequestInfo()] # List[DataforseoLabsGoogleSerpCompetitorsLiveRequestInfo] |  (optional)

    try:
        api_response = api_instance.google_serp_competitors_live(dataforseo_labs_google_serp_competitors_live_request_info=dataforseo_labs_google_serp_competitors_live_request_info)
        print("The response of DataforseoLabsApi->google_serp_competitors_live:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DataforseoLabsApi->google_serp_competitors_live: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **dataforseo_labs_google_serp_competitors_live_request_info** | [**List[DataforseoLabsGoogleSerpCompetitorsLiveRequestInfo]**](DataforseoLabsGoogleSerpCompetitorsLiveRequestInfo.md)|  | [optional] 
...
> DataforseoLabsGoogleSubdomainsLiveResponseInfo google_subdomains_live(dataforseo_labs_google_subdomains_live_request_info=dataforseo_labs_google_subdomains_live_request_info)
...
with dataforseo_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = dataforseo_client.DataforseoLabsApi(api_client)
    dataforseo_labs_google_subdomains_live_request_info = [dataforseo_client.DataforseoLabsGoogleSubdomainsLiveRequestInfo()] # List[DataforseoLabsGoogleSubdomainsLiveRequestInfo] |  (optional)

    try:
        api_response = api_instance.google_subdomains_live(dataforseo_labs_google_subdomains_live_request_info=dataforseo_labs_google_subdomains_live_request_info)
        print("The response of DataforseoLabsApi->google_subdomains_live:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DataforseoLabsApi->google_subdomains_live: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **dataforseo_labs_google_subdomains_live_request_info** | [**List[DataforseoLabsGoogleSubdomainsLiveRequestInfo]**](DataforseoLabsGoogleSubdomainsLiveRequestInfo.md)|  | [optional] 
...
> DataforseoLabsGoogleTopSearchesLiveResponseInfo google_top_searches_live(dataforseo_labs_google_top_searches_live_request_info=dataforseo_labs_google_top_searches_live_request_info)
...
with dataforseo_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = dataforseo_client.DataforseoLabsApi(api_client)
    dataforseo_labs_google_top_searches_live_request_info = [dataforseo_client.DataforseoLabsGoogleTopSearchesLiveRequestInfo()] # List[DataforseoLabsGoogleTopSearchesLiveRequestInfo] |  (optional)

    try:
        api_response = api_instance.google_top_searches_live(dataforseo_labs_google_top_searches_live_request_info=dataforseo_labs_google_top_searches_live_request_info)
        print("The response of DataforseoLabsApi->google_top_searches_live:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DataforseoLabsApi->google_top_searches_live: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **dataforseo_labs_google_top_searches_live_request_info** | [**List[DataforseoLabsGoogleTopSearchesLiveRequestInfo]**](DataforseoLabsGoogleTopSearchesLiveRequestInfo.md)|  | [optional] 
