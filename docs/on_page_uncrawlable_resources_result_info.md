...
**total_items_count** | **StrictInt** | total number of uncrawlable resources found<br> total number of uncrawlable resources found during the crawl of the target domain |[optional]|
