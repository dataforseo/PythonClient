...
dataforseo_labs_google_app_intersection_live_task_info_from_dict = DataforseoLabsGoogleAppIntersectionLiveTaskInfo.from_dict(dataforseo_labs_google_app_intersection_live_task_info_dict)
```
