...
json = "{}"
# create an instance of DataforseoLabsGoogleKeywordOverviewLiveRequestInfo from a JSON string
dataforseo_labs_google_keyword_overview_live_request_info_instance = DataforseoLabsGoogleKeywordOverviewLiveRequestInfo.from_json(json)
# print the JSON string representation of the object
print(DataforseoLabsGoogleKeywordOverviewLiveRequestInfo.to_json())

# convert the object into a dict
dataforseo_labs_google_keyword_overview_live_request_info_dict = dataforseo_labs_google_keyword_overview_live_request_info_instance.to_dict()
# create an instance of DataforseoLabsGoogleKeywordOverviewLiveRequestInfo from a dict
dataforseo_labs_google_keyword_overview_live_request_info_from_dict = DataforseoLabsGoogleKeywordOverviewLiveRequestInfo.from_dict(dataforseo_labs_google_keyword_overview_live_request_info_dict)
```
