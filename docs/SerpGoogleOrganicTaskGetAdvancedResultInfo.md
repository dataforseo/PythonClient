...
serp_google_organic_task_get_advanced_result_info_from_dict = SerpGoogleOrganicTaskGetAdvancedResultInfo.from_dict(serp_google_organic_task_get_advanced_result_info_dict)
```
