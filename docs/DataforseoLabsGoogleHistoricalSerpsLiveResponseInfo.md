...
dataforseo_labs_google_historical_serps_live_response_info_from_dict = DataforseoLabsGoogleHistoricalSerpsLiveResponseInfo.from_dict(dataforseo_labs_google_historical_serps_live_response_info_dict)
```
