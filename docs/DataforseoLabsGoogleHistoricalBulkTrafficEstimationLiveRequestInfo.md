...
dataforseo_labs_google_historical_bulk_traffic_estimation_live_request_info_from_dict = DataforseoLabsGoogleHistoricalBulkTrafficEstimationLiveRequestInfo.from_dict(dataforseo_labs_google_historical_bulk_traffic_estimation_live_request_info_dict)
```
