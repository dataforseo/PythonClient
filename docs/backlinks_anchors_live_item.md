...
**backlinks_spam_score** | **StrictInt** | average spam score of all backlinks with this anchor<br>learn more about how the metric is calculated on this help center page |[optional]|
...
**referring_pages** | **StrictInt** | indicates the number of pages pointing to target with this anchor |[optional]|
**referring_pages_nofollow** | **StrictInt** | number of referring pages pointing at least one nofollow link to the target with this anchor |[optional]|
