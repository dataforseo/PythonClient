...
------------ | ------------- | ------------- | -------------
**target** | **str** | domain, subdomain or webpage to get anchors for required field a domain or a subdomain should be specified without https:// and www. a page should be specified with absolute URL (including http:// or https://) | [optional] 
...
backlinks_anchors_live_request_info_instance = BacklinksAnchorsLiveRequestInfo.from_json(json)
# print the JSON string representation of the object
print BacklinksAnchorsLiveRequestInfo.to_json()

# convert the object into a dict
backlinks_anchors_live_request_info_dict = backlinks_anchors_live_request_info_instance.to_dict()
# create an instance of BacklinksAnchorsLiveRequestInfo from a dict
backlinks_anchors_live_request_info_form_dict = backlinks_anchors_live_request_info.from_dict(backlinks_anchors_live_request_info_dict)
```
