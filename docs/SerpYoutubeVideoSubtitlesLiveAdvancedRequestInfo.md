...
serp_youtube_video_subtitles_live_advanced_request_info_from_dict = SerpYoutubeVideoSubtitlesLiveAdvancedRequestInfo.from_dict(serp_youtube_video_subtitles_live_advanced_request_info_dict)
```
