...
content_generation_generate_text_live_task_info_from_dict = ContentGenerationGenerateTextLiveTaskInfo.from_dict(content_generation_generate_text_live_task_info_dict)
```
