...
serp_google_dataset_search_task_get_advanced_response_info_from_dict = SerpGoogleDatasetSearchTaskGetAdvancedResponseInfo.from_dict(serp_google_dataset_search_task_get_advanced_response_info_dict)
```
