...
keywords_data_dataforseo_trends_subregion_interests_live_request_info_from_dict = KeywordsDataDataforseoTrendsSubregionInterestsLiveRequestInfo.from_dict(keywords_data_dataforseo_trends_subregion_interests_live_request_info_dict)
```
