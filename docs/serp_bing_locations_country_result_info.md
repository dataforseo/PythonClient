...
**location_type** | **StrictStr** | <em>location type</em><br>indicates the geographic classification of the location<br>example:<br>`'location_type': 'Country'`, or `'location_type': 'State'` |[optional]|