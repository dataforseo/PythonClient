...
dataforseo_labs_google_app_competitors_live_request_info_from_dict = DataforseoLabsGoogleAppCompetitorsLiveRequestInfo.from_dict(dataforseo_labs_google_app_competitors_live_request_info_dict)
```
