...
serp_google_local_finder_live_advanced_request_info_from_dict = SerpGoogleLocalFinderLiveAdvancedRequestInfo.from_dict(serp_google_local_finder_live_advanced_request_info_dict)
```
