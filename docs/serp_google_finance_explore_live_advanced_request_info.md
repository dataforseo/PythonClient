...
**device** | **StrictStr** | device type<br>optional field<br>return results for a specific device type<br>possible value: desktop |[optional]|
...
**news_type** | **StrictStr** | financial news filters<br>optional field<br>possible values: top_stories, local_market, world_markets<br>default value: top_stories<br>Note: if you specify local_market or world_markets, the charge per task will be multiplied by 2 |[optional]|