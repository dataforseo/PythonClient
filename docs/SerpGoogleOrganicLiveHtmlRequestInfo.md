...
**expand_ai_overview** | **bool** | expand ai overview optional field set to true to expand the ai_overview item; default value: false | [optional] 
...
serp_google_organic_live_html_request_info_instance = SerpGoogleOrganicLiveHtmlRequestInfo.from_json(json)
# print the JSON string representation of the object
print(SerpGoogleOrganicLiveHtmlRequestInfo.to_json())

# convert the object into a dict
serp_google_organic_live_html_request_info_dict = serp_google_organic_live_html_request_info_instance.to_dict()
# create an instance of SerpGoogleOrganicLiveHtmlRequestInfo from a dict
serp_google_organic_live_html_request_info_from_dict = SerpGoogleOrganicLiveHtmlRequestInfo.from_dict(serp_google_organic_live_html_request_info_dict)
```
