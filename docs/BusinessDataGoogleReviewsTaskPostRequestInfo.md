...
business_data_google_reviews_task_post_request_info_from_dict = BusinessDataGoogleReviewsTaskPostRequestInfo.from_dict(business_data_google_reviews_task_post_request_info_dict)
```
