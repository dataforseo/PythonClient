...
**ranked_serp_element** | **GooglePlayRankedSerpElementInfo** | <em>contains data on the domain's SERP element found for the returned <code>keyword</code></em> |[optional]|