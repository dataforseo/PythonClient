...
**items** | **List[Optional[KnowledgeGraphHotelsBookingElement]]** | popular keywords relevant to the initial search query<br>if there are none, equals null |[optional]|