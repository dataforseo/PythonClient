...
keywords_data_bing_keywords_for_site_task_post_request_info_from_dict = KeywordsDataBingKeywordsForSiteTaskPostRequestInfo.from_dict(keywords_data_bing_keywords_for_site_task_post_request_info_dict)
```
