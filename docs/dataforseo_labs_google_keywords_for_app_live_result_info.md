...
**items** | **List[Optional[DataforseoLabsGoogleKeywordsForAppLiveItem]]** | contains data related to the ranking keywords for the app specified in the app_id field |[optional]|