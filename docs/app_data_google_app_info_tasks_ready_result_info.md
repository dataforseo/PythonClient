...
**endpoint_advanced** | **StrictStr** | URL for collecting the results of the Google App Info task |[optional]|
**endpoint_html** | **StrictStr** | URL for collecting the results of the Google App Info HTML task<br>if HTML tasks are not supported in the specified endpoint, the value will be null |[optional]|