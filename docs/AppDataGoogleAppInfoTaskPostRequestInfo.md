...
app_data_google_app_info_task_post_request_info_form_dict = app_data_google_app_info_task_post_request_info.from_dict(app_data_google_app_info_task_post_request_info_dict)
```
