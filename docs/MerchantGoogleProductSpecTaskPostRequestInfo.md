...
merchant_google_product_spec_task_post_request_info_from_dict = MerchantGoogleProductSpecTaskPostRequestInfo.from_dict(merchant_google_product_spec_task_post_request_info_dict)
```
