...
app_data_apple_app_info_task_post_request_info_from_dict = AppDataAppleAppInfoTaskPostRequestInfo.from_dict(app_data_apple_app_info_task_post_request_info_dict)
```
