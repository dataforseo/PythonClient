...
business_data_tripadvisor_reviews_task_post_request_info_from_dict = BusinessDataTripadvisorReviewsTaskPostRequestInfo.from_dict(business_data_tripadvisor_reviews_task_post_request_info_dict)
```
