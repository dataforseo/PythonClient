...
**item_types** | **List[Optional[StrictStr]]** | <em>types of search results in SERP</em><br>contains types of search results (<code>items</code>) found in SERP.<br>possible item types:<br><code>images</code>, <code>local_pack</code>, <code>map</code>, <code>organic</code>, <code>paid</code>, <code>related_searches</code>, <code>video</code> |[optional]|
