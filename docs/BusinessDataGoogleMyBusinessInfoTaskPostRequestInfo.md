...
business_data_google_my_business_info_task_post_request_info_instance = BusinessDataGoogleMyBusinessInfoTaskPostRequestInfo.from_json(json)
# print the JSON string representation of the object
print(BusinessDataGoogleMyBusinessInfoTaskPostRequestInfo.to_json())

# convert the object into a dict
business_data_google_my_business_info_task_post_request_info_dict = business_data_google_my_business_info_task_post_request_info_instance.to_dict()
# create an instance of BusinessDataGoogleMyBusinessInfoTaskPostRequestInfo from a dict
business_data_google_my_business_info_task_post_request_info_from_dict = BusinessDataGoogleMyBusinessInfoTaskPostRequestInfo.from_dict(business_data_google_my_business_info_task_post_request_info_dict)
```
