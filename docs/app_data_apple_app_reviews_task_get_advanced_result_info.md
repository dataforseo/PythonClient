...
**reviews_count** | **StrictInt** | <em>the total number of reviews</em><br>in this case, the value will be <code>null</code> as App Store does not indicate the total number of app reviews |[optional]|
...
**items** | **List[Optional[AppStoreReviewsSearch]]** | <em>found reviews</em> |[optional]|