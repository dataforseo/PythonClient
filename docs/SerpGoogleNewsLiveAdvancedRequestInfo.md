...
serp_google_news_live_advanced_request_info_instance = SerpGoogleNewsLiveAdvancedRequestInfo.from_json(json)
# print the JSON string representation of the object
print(SerpGoogleNewsLiveAdvancedRequestInfo.to_json())

# convert the object into a dict
serp_google_news_live_advanced_request_info_dict = serp_google_news_live_advanced_request_info_instance.to_dict()
# create an instance of SerpGoogleNewsLiveAdvancedRequestInfo from a dict
serp_google_news_live_advanced_request_info_from_dict = SerpGoogleNewsLiveAdvancedRequestInfo.from_dict(serp_google_news_live_advanced_request_info_dict)
```
