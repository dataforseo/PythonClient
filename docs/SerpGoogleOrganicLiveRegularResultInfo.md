...
serp_google_organic_live_regular_result_info_from_dict = SerpGoogleOrganicLiveRegularResultInfo.from_dict(serp_google_organic_live_regular_result_info_dict)
```
