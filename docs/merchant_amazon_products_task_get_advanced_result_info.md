...
**categories** | **List[Optional[StrictStr]]** | <em>amazon product departments and subcategories</em> |[optional]|
**items_count** | **StrictInt** | <em>the number of results returned in the <strong><code>items</code></strong> array</em> |[optional]|
**items** | **List[Optional[BaseMerchantAmazonElementItem]]** | <em>Amazon product items within the <code>editorial_recommendations</code> element</em> |[optional]|