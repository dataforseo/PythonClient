...
**endpoint_advanced** | **StrictStr** | URL for collecting the results of the Amazon ASIN Advanced task |[optional]|
**endpoint_html** | **StrictStr** | URL for collecting the results of the Amazon ASIN HTML task |[optional]|