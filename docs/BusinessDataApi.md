...
with dataforseo_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = dataforseo_client.BusinessDataApi(api_client)
    id = '21cc6b8f-15aa-46c1-a574-e25f456a3351' # str | task identifier unique task identifier in our system in the UUID format you will be able to use it within 7 days to request the results of the task at any time
...
with dataforseo_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.yelp_reviews_task_get(id)
        print("The response of BusinessDataApi->yelp_reviews_task_get:\n")
        pprint(api_response)
    except Exception as e:
...
with dataforseo_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = dataforseo_client.BusinessDataApi(api_client)
    business_data_yelp_reviews_task_post_request_info = [dataforseo_client.BusinessDataYelpReviewsTaskPostRequestInfo()] # List[BusinessDataYelpReviewsTaskPostRequestInfo] |  (optional)

    try:
        api_response = api_instance.yelp_reviews_task_post(business_data_yelp_reviews_task_post_request_info=business_data_yelp_reviews_task_post_request_info)
        print("The response of BusinessDataApi->yelp_reviews_task_post:\n")
        pprint(api_response)
    except Exception as e:
...
with dataforseo_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.yelp_reviews_tasks_ready()
        print("The response of BusinessDataApi->yelp_reviews_tasks_ready:\n")
        pprint(api_response)
    except Exception as e:
...
with dataforseo_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.yelp_search_task_get(id)
        print("The response of BusinessDataApi->yelp_search_task_get:\n")
        pprint(api_response)
    except Exception as e:
...
with dataforseo_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = dataforseo_client.BusinessDataApi(api_client)
    business_data_yelp_search_task_post_request_info = [dataforseo_client.BusinessDataYelpSearchTaskPostRequestInfo()] # List[BusinessDataYelpSearchTaskPostRequestInfo] |  (optional)

    try:
        api_response = api_instance.yelp_search_task_post(business_data_yelp_search_task_post_request_info=business_data_yelp_search_task_post_request_info)
        print("The response of BusinessDataApi->yelp_search_task_post:\n")
        pprint(api_response)
    except Exception as e:
...
with dataforseo_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.yelp_search_tasks_ready()
        print("The response of BusinessDataApi->yelp_search_tasks_ready:\n")
        pprint(api_response)
    except Exception as e:
