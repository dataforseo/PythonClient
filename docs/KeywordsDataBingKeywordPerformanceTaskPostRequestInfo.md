...
keywords_data_bing_keyword_performance_task_post_request_info_from_dict = KeywordsDataBingKeywordPerformanceTaskPostRequestInfo.from_dict(keywords_data_bing_keyword_performance_task_post_request_info_dict)
```
