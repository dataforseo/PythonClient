...
**item_types** | **List[Optional[StrictStr]]** | <em>types of search results in SERP</em><br>contains types of search results (<code>items</code>) found in SERP.<br>possible item types:<br><code>google_jobs_item</code> |[optional]|
...
**items** | **List[Optional[GoogleJobsItem]]** | <em>items of the element</em> |[optional]|