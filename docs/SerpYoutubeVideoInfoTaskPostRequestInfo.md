...
serp_youtube_video_info_task_post_request_info_from_dict = SerpYoutubeVideoInfoTaskPostRequestInfo.from_dict(serp_youtube_video_info_task_post_request_info_dict)
```
