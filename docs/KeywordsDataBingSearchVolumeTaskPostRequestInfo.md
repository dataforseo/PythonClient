...
keywords_data_bing_search_volume_task_post_request_info_from_dict = KeywordsDataBingSearchVolumeTaskPostRequestInfo.from_dict(keywords_data_bing_search_volume_task_post_request_info_dict)
```
