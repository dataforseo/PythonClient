...
**target** | **StrictStr** | <em>target domain or subdomain in a POST array</em> |[optional]|
...
**items** | **List[Optional[DataforseoLabsGoogleCategoriesForDomainLiveItem]]** | <em>contains relevant categories and related ranking data</em> |[optional]|