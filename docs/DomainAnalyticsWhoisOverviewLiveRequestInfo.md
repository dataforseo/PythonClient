...
domain_analytics_whois_overview_live_request_info_from_dict = DomainAnalyticsWhoisOverviewLiveRequestInfo.from_dict(domain_analytics_whois_overview_live_request_info_dict)
```
