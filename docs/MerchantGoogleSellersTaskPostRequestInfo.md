...
merchant_google_sellers_task_post_request_info_form_dict = merchant_google_sellers_task_post_request_info.from_dict(merchant_google_sellers_task_post_request_info_dict)
```
