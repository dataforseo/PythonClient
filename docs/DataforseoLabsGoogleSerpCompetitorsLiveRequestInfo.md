...
dataforseo_labs_google_serp_competitors_live_request_info_from_dict = DataforseoLabsGoogleSerpCompetitorsLiveRequestInfo.from_dict(dataforseo_labs_google_serp_competitors_live_request_info_dict)
```
