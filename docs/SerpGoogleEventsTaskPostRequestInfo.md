...
serp_google_events_task_post_request_info_form_dict = serp_google_events_task_post_request_info.from_dict(serp_google_events_task_post_request_info_dict)
```
