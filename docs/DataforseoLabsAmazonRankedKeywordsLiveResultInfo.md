...
dataforseo_labs_amazon_ranked_keywords_live_result_info_from_dict = DataforseoLabsAmazonRankedKeywordsLiveResultInfo.from_dict(dataforseo_labs_amazon_ranked_keywords_live_result_info_dict)
```
