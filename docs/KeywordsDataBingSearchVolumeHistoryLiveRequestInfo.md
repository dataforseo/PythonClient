...
keywords_data_bing_search_volume_history_live_request_info_from_dict = KeywordsDataBingSearchVolumeHistoryLiveRequestInfo.from_dict(keywords_data_bing_search_volume_history_live_request_info_dict)
```
