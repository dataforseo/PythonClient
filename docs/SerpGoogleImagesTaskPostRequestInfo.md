...
serp_google_images_task_post_request_info_instance = SerpGoogleImagesTaskPostRequestInfo.from_json(json)
# print the JSON string representation of the object
print(SerpGoogleImagesTaskPostRequestInfo.to_json())

# convert the object into a dict
serp_google_images_task_post_request_info_dict = serp_google_images_task_post_request_info_instance.to_dict()
# create an instance of SerpGoogleImagesTaskPostRequestInfo from a dict
serp_google_images_task_post_request_info_from_dict = SerpGoogleImagesTaskPostRequestInfo.from_dict(serp_google_images_task_post_request_info_dict)
```
