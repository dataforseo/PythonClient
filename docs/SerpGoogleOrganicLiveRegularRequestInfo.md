...
serp_google_organic_live_regular_request_info_form_dict = serp_google_organic_live_regular_request_info.from_dict(serp_google_organic_live_regular_request_info_dict)
```
