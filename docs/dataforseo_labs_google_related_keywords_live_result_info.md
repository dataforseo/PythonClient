...
**seed_keyword_data** | **KeywordDataInfo** | <em>keyword data for the seed keyword</em><br>fields in the array are identical to that of <code>keyword_data</code> |[optional]|
...
**items** | **List[Optional[DataforseoLabsGoogleRelatedKeywordsLiveItem]]** | <em>contains keywords and related data</em> |[optional]|