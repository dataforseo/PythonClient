...
**endpoint_advanced** | **StrictStr** | URL for collecting the results of Amazon Sellers Advanced task |[optional]|
**endpoint_html** | **StrictStr** | URL for collecting the results of Amazon Sellers HTML task |[optional]|