...
serp_yahoo_organic_task_post_request_info_instance = SerpYahooOrganicTaskPostRequestInfo.from_json(json)
# print the JSON string representation of the object
print(SerpYahooOrganicTaskPostRequestInfo.to_json())

# convert the object into a dict
serp_yahoo_organic_task_post_request_info_dict = serp_yahoo_organic_task_post_request_info_instance.to_dict()
# create an instance of SerpYahooOrganicTaskPostRequestInfo from a dict
serp_yahoo_organic_task_post_request_info_from_dict = SerpYahooOrganicTaskPostRequestInfo.from_dict(serp_yahoo_organic_task_post_request_info_dict)
```
