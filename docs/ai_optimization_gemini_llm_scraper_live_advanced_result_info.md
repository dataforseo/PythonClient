...
**item_types** | **List[Optional[StrictStr]]** | types of search resultscontains types of search results (items) found in SERP.possible item types:gemini_text, gemini_table, gemini_images |[optional]|
