...
merchant_amazon_products_task_post_task_info_from_dict = MerchantAmazonProductsTaskPostTaskInfo.from_dict(merchant_amazon_products_task_post_task_info_dict)
```
