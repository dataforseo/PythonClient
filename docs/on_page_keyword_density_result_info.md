...
**total_items_count** | **StrictInt** | <em>total number of relevant items</em><br>total number of keywords on the specified website or web page matching the set <code>keyword_length</code> and <code>filters</code> |[optional]|
**items_count** | **StrictInt** | <em>number of items in the results array</em> |[optional]|
**items** | **List[Optional[OnPageKeywordDensityItem]]** | <em>items array</em> |[optional]|