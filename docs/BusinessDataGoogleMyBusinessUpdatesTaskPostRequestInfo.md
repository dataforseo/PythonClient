...
business_data_google_my_business_updates_task_post_request_info_from_dict = BusinessDataGoogleMyBusinessUpdatesTaskPostRequestInfo.from_dict(business_data_google_my_business_updates_task_post_request_info_dict)
```
