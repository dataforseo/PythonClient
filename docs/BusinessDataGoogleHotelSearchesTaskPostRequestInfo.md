...
business_data_google_hotel_searches_task_post_request_info_from_dict = BusinessDataGoogleHotelSearchesTaskPostRequestInfo.from_dict(business_data_google_hotel_searches_task_post_request_info_dict)
```
