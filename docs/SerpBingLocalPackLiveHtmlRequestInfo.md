...
serp_bing_local_pack_live_html_request_info_instance = SerpBingLocalPackLiveHtmlRequestInfo.from_json(json)
# print the JSON string representation of the object
print(SerpBingLocalPackLiveHtmlRequestInfo.to_json())

# convert the object into a dict
serp_bing_local_pack_live_html_request_info_dict = serp_bing_local_pack_live_html_request_info_instance.to_dict()
# create an instance of SerpBingLocalPackLiveHtmlRequestInfo from a dict
serp_bing_local_pack_live_html_request_info_from_dict = SerpBingLocalPackLiveHtmlRequestInfo.from_dict(serp_bing_local_pack_live_html_request_info_dict)
```
