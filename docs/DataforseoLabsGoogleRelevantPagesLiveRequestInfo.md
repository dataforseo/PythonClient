...
dataforseo_labs_google_relevant_pages_live_request_info_from_dict = DataforseoLabsGoogleRelevantPagesLiveRequestInfo.from_dict(dataforseo_labs_google_relevant_pages_live_request_info_dict)
```
