...
domain_analytics_technologies_technologies_summary_live_request_info_from_dict = DomainAnalyticsTechnologiesTechnologiesSummaryLiveRequestInfo.from_dict(domain_analytics_technologies_technologies_summary_live_request_info_dict)
```
