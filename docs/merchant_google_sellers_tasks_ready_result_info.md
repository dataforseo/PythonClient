...
**endpoint_advanced** | **StrictStr** | <em>URL for collecting the results of Google Shopping Sellers Advanced task</em> |[optional]|
**endpoint_html** | **StrictStr** | <em>URL for collecting the results of Google Shopping Sellers HTML task</em> |[optional]|