...
**offset** | **StrictInt** | offset in the results array of the returned mentions data<br>offset specified in the reqest |[optional]|
...
**items** | **List[Optional[AiOptimizationLlmMentionsTopMentionedDomainsLiteLiveItem]]** | contains relevant mentions data |[optional]|