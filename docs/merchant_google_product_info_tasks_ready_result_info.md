...
**endpoint_html** | **StrictStr** | URL for collecting the results of the Google Shopping Product Specifications HTML task<br>note: HTML is not available for this endpoint, the value will be null |[optional]|