...
dataforseo_labs_google_keyword_suggestions_live_request_info_from_dict = DataforseoLabsGoogleKeywordSuggestionsLiveRequestInfo.from_dict(dataforseo_labs_google_keyword_suggestions_live_request_info_dict)
```
