...
serp_bing_organic_live_html_request_info_instance = SerpBingOrganicLiveHtmlRequestInfo.from_json(json)
# print the JSON string representation of the object
print(SerpBingOrganicLiveHtmlRequestInfo.to_json())

# convert the object into a dict
serp_bing_organic_live_html_request_info_dict = serp_bing_organic_live_html_request_info_instance.to_dict()
# create an instance of SerpBingOrganicLiveHtmlRequestInfo from a dict
serp_bing_organic_live_html_request_info_from_dict = SerpBingOrganicLiveHtmlRequestInfo.from_dict(serp_bing_organic_live_html_request_info_dict)
```
