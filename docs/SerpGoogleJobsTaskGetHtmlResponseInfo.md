...
serp_google_jobs_task_get_html_response_info_from_dict = SerpGoogleJobsTaskGetHtmlResponseInfo.from_dict(serp_google_jobs_task_get_html_response_info_dict)
```
