...
app_data_google_app_searches_task_post_request_info_instance = AppDataGoogleAppSearchesTaskPostRequestInfo.from_json(json)
# print the JSON string representation of the object
print(AppDataGoogleAppSearchesTaskPostRequestInfo.to_json())

# convert the object into a dict
app_data_google_app_searches_task_post_request_info_dict = app_data_google_app_searches_task_post_request_info_instance.to_dict()
# create an instance of AppDataGoogleAppSearchesTaskPostRequestInfo from a dict
app_data_google_app_searches_task_post_request_info_from_dict = AppDataGoogleAppSearchesTaskPostRequestInfo.from_dict(app_data_google_app_searches_task_post_request_info_dict)
```
